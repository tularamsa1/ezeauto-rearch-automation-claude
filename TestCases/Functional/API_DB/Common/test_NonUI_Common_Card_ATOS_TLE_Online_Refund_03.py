...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_196():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMV_WITH_PIN_DEBIT_VISA
        Sub Feature Description:API that performs EMV with pin Online Refund txn having DEBIT VISA card via ATOS_TLE
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_182():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMV_WITH_PIN_DEBIT_RUPAY
        Sub Feature Description:API that performs EMV with pin Online Refund txn having DEBIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        182: TC182
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_210():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMV_WITH_PIN_CREDIT_VISA
        Sub Feature Description:API that performs EMV with pin Online Refund txn having CREDIT VISA card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        210: TC210
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_224():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMV_WITH_PIN_CREDIT_MASTER
        Sub Feature Description:API that performs EMV with pin Online Refund txn having CREDIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        224: TC224
