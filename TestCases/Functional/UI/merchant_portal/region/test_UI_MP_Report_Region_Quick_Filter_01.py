...
def test_mp_700_702_020():
    """
    Sub Feature Code: UI_MP_Report_for_Daily_txn_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Daily quick Filter when logging in as Regional Head
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and username NOT IN ('"+country_username+"') order by created_time asc limit 1;"
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_702_021():
    """
    Sub Feature Code: UI_MP_Report_for_Monthly_txn_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Monthly quick Filter when logging in as Regional Head
    TC naming code description:
    700: Merchant Portal
    702: Region
    021: TC021
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_702_022():
    """
    Sub Feature Code: UI_MP_Report_for_Weekly_txn_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using weekly quick Filter when logging in as Regional Head
    TC naming code description:
    700: Merchant Portal
    702: Region
    022: TC022
