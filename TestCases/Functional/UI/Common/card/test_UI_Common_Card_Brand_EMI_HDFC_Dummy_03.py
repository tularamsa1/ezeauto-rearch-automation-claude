...
def test_common_100_115_07_021():
    """
        Sub Feature Code: UI_Common_Card_Brand_EMI_Cashback_by_Band_Percentage_Success_Txn_For_An_Org_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090_For_6_Months_Tenure
        Sub Feature Description: Performing the brand EMI cashback by brand percentage success transaction for an org via HDFC Dummy PG using EMV VISA Debit card with pin for 6 months tenure (bin: 428090)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 021: TC021
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_023():
    """
        Sub Feature Code: UI_Common_Card_Brand_EMI_Cashback_by_Band_Percentage_Success_Txn_For_An_Org_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090_For_9_Months_Tenure
        Sub Feature Description: Performing the brand EMI cashback by brand percentage success transaction for an org via HDFC Dummy PG using EMV VISA Debit card with pin for 9 months tenure (bin: 428090)
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_025():
    """
        Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Merchant_Fixed_Success_Txn_For_An_Org_HDFC_Dummy_EMV_VISA_CreditCard_With_Pin_417666_For_3_Months_Tenure
        Sub Feature Description: Performing the brand EMI payback by merchant fixed success transaction for an org via HDFC Dummy PG using EMV VISA Credit card with pin for 3 months tenure (bin: 417666)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 025: TC025
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_027():
    """
        Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Merchant_Fixed_Success_Txn_For_An_Org_HDFC_Dummy_EMV_VISA_CreditCard_With_Pin_417666_For_6_Months_Tenure
        Sub Feature Description: Performing the brand EMI payback by merchant fixed success transaction for an org via HDFC Dummy PG using EMV VISA Credit card with pin for 6 months tenure (bin: 417666)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 027: TC027
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_029():
    """
        Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Merchant_Fixed_Success_Txn_For_An_Org_HDFC_Dummy_EMV_VISA_CreditCard_With_Pin_417666_For_9_Months_Tenure
        Sub Feature Description: Performing the brand EMI payback by merchant fixed success transaction for an org via HDFC Dummy PG using EMV VISA Credit card with pin for 9 months tenure (bin: 417666)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 029: TC029
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
