...
def test_common_x990_100_101_001():
    """
    Sub Feature Code: UI_Common_PM_UPI_Success_Via_Pure_UPI_Callback_HDFC
    Sub Feature Description: Verification of a successful pure upi txn via HDFC using callback in X990
    TC naming code description: x990:device_name, 100: Payment Method, 101: UPI, 001: TC001
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_x990_100_102_001():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_BQR_Callback_Success_HDFC
    Sub Feature Description: Verification of a BQR Callback Success transaction via HDFC in X990
    TC naming code description: x990:device_name,100: Payment Method, 102: BQR, 001: TC01
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        try:
            ...
            logger.debug(
                f"Fetching Txn_id,Auth code,RRN from data base : Txn_id : {txn_id},"f" Auth code : {auth_code}, RRN : {rrn}")
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_x990_100_102_002():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_BQR_Callback_Failed_HDFC
    Sub Feature Description: Verification of a failed BQR Callback via HDFC in X990
    TC naming code description: x990: device_name, 100: Payment Method, 102: BQR, 002: TC002
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_x990_100_102_003():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_BQR_Callback_Expired_HDFC
    Sub Feature Description: Verification of a BQR Callback Expired transaction via HDFC in X990
    TC naming code description: x990:device_name, 100: Payment Method, 102: BQR, 003: TC003
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
