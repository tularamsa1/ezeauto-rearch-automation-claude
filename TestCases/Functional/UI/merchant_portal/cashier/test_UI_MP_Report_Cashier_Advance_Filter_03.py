...
def test_mp_700_709_051():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_VISACardBrand_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter VISACardBrand when logged in as Cashier
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_card_brand='" + card_brand_search_value + "' and username ='" + login_username + "' order by created_time asc limit 1;"
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_709_052():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_MASTERCardBrand_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter MASTERCardBrand when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    052: TC052
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_709_053():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_RUPAYCardBrand_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter RUPAYCardBrand when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    053: TC053
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_709_054():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_ALL_CardBrand_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for ALL CardBrand when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    054: TC054
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_709_055():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_Cash_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode Cash when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    055: TC055
