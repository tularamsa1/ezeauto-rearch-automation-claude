...
def test_common_100_115_212():
    """
    Sub Feature Code: UI_Common_Card_Sale_FDC_EMV_MASTER_DebitCard_Without_Pin_222360
    Sub Feature Description: Performing the EMV sale transaction via FDC PG using MASTER Debit card having
    16 digit PAN length without pin (bin:222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 212: TC212
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_213():
    """
    Sub Feature Code: UI_Common_Card_Sale_FDC_EMV_RUPAY_DebitCard_Without_Pin_608326
    Sub Feature Description: Performing the EMV sale transaction via FDC PG using RUPAY Debit card having
    16 digit PAN length without pin (bin:608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 213: TC213
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_214():
    """
    Sub Feature Code: UI_Common_Card_Sale_FDC_EMV_VISA_DebitCard_With_Pin_428090
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 214: TC214
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_215():
    """
    Sub Feature Code: UI_Common_Card_Sale_FDC_EMV_RUPAY_DebitCard_With_Pin_608326
    Sub Feature Description: Performing the EMV sale transaction via FDC PG using RUPAY Debit card having
    16 digit PAN length with pin (bin:608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 215: TC215
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_216():
    """
    Sub Feature Code: UI_Common_Card_Sale_FDC_EMV_VISA_CreditCard_Without_Pin_417666
    Sub Feature Description: Performing the EMV sale transaction via FDC PG using VISA Credit card having
    16 digit PAN length without pin (bin:417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 216: TC216
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
