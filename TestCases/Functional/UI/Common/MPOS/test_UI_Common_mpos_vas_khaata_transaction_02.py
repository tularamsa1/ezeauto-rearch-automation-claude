...
def test_mpos_600_601_024():
    ...
    try:
        ...
        try:
            ...
            time.sleep(2)
            khaata_page.click_on_recent_transaction()
            description_to_edit = "Edited Description"
            khaata_page.perform_edit_entry_description(description_to_edit)
            khaata_page.click_save_for_edited_transaction()
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                # --------------------------------------------------------------------------------------------
                expected_app_values = {"edited_description": description_to_edit}
