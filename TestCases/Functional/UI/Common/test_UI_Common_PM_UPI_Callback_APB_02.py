...
def test_common_100_101_082():
    """
    Sub Feature Code: UI_Common_PM_UPI_2_Success_Callback_After_QR_Expiry_AutoRefund_Enabled_APB
    Sub Feature Description: Performing two pure upi success callback via APB after expiry the qr when autorefund is enabled
    TC naming code description: 100: Payment Method, 101: UPI, 082: TC082
    """
    try:
...
def test_common_100_101_083():
    """
    Sub Feature Code: UI_Common_PM_UPI_2_Success_Callback_After_QR_Expiry_AutoRefund_Disabled_APB
    Sub Feature Description: Performing two pure upi success callback via APB after expiry the qr when autorefund is disabled
    TC naming code description: 100: Payment Method, 101: UPI, 083: TC083
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_common_100_101_085():
    """
    Sub Feature Code: UI_Common_PM_UPI_2_Failed_Callback_After_QR_Expiry_AutoRefund_Enabled_APB
    Sub Feature Description: Performing two pure upi failed callback via APB after expiry the qr when autorefund is enabled
    TC naming code description: 100: Payment Method, 101: UPI, 085: TC085
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_common_100_101_086():
    """
    Sub Feature Code: UI_Common_PM_UPI_2_Failed_Callback_After_QR_Expiry_AutoRefund_Disabled_APB
    Sub Feature Description: Performing two pure upi failed callback via APB after expiry the qr when autorefund is disabled
    TC naming code description: 100: Payment Method, 101: UPI, 086: TC086
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
