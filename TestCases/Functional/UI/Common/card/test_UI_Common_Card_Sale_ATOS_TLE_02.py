...
def test_common_100_115_104():
    """
    Sub Feature Code: UI_Common_Card_Sale_ATOS_TLE_EMVCTLS_RUPAY_DebitCard_Without_Pin_608326
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 104: TC104
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_105():
    """
    Sub Feature Code: UI_Common_Card_Sale_ATOS_TLE_EMVCTLS_MASTER_CreditCard_With_Pin_541333
    Sub Feature Description: Performing the EMVCTLS sale transaction via ATOS_TLE PG using MASTER Credit card having
    16 digit PAN length with pin (bin:541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 105: TC105
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_106():
    """
    Sub Feature Code: UI_Common_Card_Sale_ATOS_TLE_EMVCTLS_VISA_CreditCard_Without_Pin_417666
    Sub Feature Description: Performing the EMVCTLS sale transaction via ATOS_TLE PG using VISA Credit card having
    16 digit PAN length without pin (bin:417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 106: TC106
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_107():
    """
    Sub Feature Code: UI_Common_Card_Sale_ATOS_TLE_EMVCTLS_MASTER_CreditCard_Without_Pin_541333
    Sub Feature Description: Performing the EMVCTLS sale transaction via ATOS_TLE PG using MASTER Credit card having
    16 digit PAN length without pin (bin:541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 107: TC107
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_147():
    """
    Sub Feature Code: UI_Common_Card_Sale_ATOS_TLE_EMV_VISA_DebitCard_Without_Pin_476173
    Sub Feature Description: Performing the EMV sale transaction via ATOS_TLE PG using VISA Debit card having
    16 digit PAN length without pin (bin:476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 147: TC147
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
