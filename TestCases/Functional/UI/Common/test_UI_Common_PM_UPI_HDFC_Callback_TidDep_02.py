...
def test_common_100_101_102():
    """
    Sub Feature Code: UI_Common_PM_UPI_success_callback_after_qr_expiry_AutoRefund_Enabled_HDFC_TID_Dep
    Sub Feature Description: Performing a pure upi success callback via HDFC Tid Dep after qr expiry when autorefund is enabled.
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                actual_app_values = {
                    ...
                    "new_pmt_status": new_app_payment_status.split(':')[1],
                    "new_txn_amt": str(new_app_amount).split(' ')[1],
                    ...
                    "new_auth_code": new_app_auth_code,
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "new_pmt_state": "REFUND_PENDING", "new_rrn": str(rrn),
                    "new_settle_status": "SETTLED",
                    "new_acquirer_code": "HDFC",
                    "new_issuer_code": "HDFC",
                    "new_txn_type": new_txn_type, "new_mid": mid, "new_tid": tid,
                    "new_org_code": new_org_code_txn,
                    "new_auth_code": new_auth_code,
                    "new_date": new_txn_date,
                    "new_order_id": order_id,
                    "new_device_serial": str(device_serial)
                }
                ...
                actual_api_values = {
                    ...
                    "new_txn_amt": new_txn_amount_api, "new_pmt_mode": new_txn_payment_mode_api,
                    "new_pmt_state": new_txn_state_api, "new_rrn": str(new_txn_rrn_api),
                    "new_settle_status": new_txn_settlement_status_api,
                    "new_acquirer_code": new_txn_acquirer_code_api,
                    "new_issuer_code": new_txn_issuer_code_api,
                    "new_txn_type": new_txn_type_api, "new_mid": new_txn_mid_api, "new_tid": new_txn_tid_api,
                    "new_org_code": new_txn_orgCode_api,
                    "new_auth_code": new_txn_auth_code_api,
                    "new_order_id": new_txn_order_id_api,
                    "new_date": date_time_converter.from_api_to_datetime_format(new_txn_date_api),
                    "new_device_serial": str(new_txn_device_serial_api)
                }
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    "order_id": order_id,
                    "device_serial": str(device_serial),
                    "new_txn_pmt_status": "REFUND_PENDING",
                    "new_txn_pmt_state": "REFUND_PENDING",
                    "new_txn_pmt_mode": "UPI",
                    "new_txn_txn_amt": amount,
                    "new_txn_upi_txn_status": "REFUND_PENDING",
                    "new_txn_settle_status": "SETTLED",
                    "new_txn_acquirer_code": "HDFC",
                    "new_txn_bank_code": "HDFC",
                    "new_txn_payment_gateway": "HDFC",
                    "new_txn_upi_txn_type": "PAY_QR",
                    "new_txn_upi_bank_code": "HDFC",
                    "new_txn_upi_mc_id": upi_mc_id,
                    "new_txn_mid": mid,
                    "new_txn_tid": tid,
                    "new_txn_order_id": order_id,
                    "new_txn_device_serial": str(device_serial)
                }
                ...
                actual_db_values = {
                    ...
                    "new_txn_pmt_status": new_txn_status_db,
                    "new_txn_pmt_state": new_txn_state_db,
                    "new_txn_pmt_mode": new_txn_payment_mode_db,
                    "new_txn_txn_amt": new_txn_amount_db,
                    "new_txn_upi_txn_status": new_txn_upi_status_db,
                    "new_txn_settle_status": new_txn_settlement_status_db,
                    "new_txn_acquirer_code": new_txn_acquirer_code_db,
                    "new_txn_bank_code": new_txn_bank_code_db,
                    "new_txn_payment_gateway": new_txn_payment_gateway_db,
                    "new_txn_upi_txn_type": new_txn_upi_txn_type_db,
                    "new_txn_upi_bank_code": new_txn_upi_bank_code_db,
                    "new_txn_upi_mc_id": new_txn_upi_mc_id_db,
                    "new_txn_mid": new_txn_mid_db,
                    "new_txn_tid": new_txn_tid_db,
                    "new_txn_order_id": new_txn_order_id_db,
                    "new_txn_device_serial": str(new_txn_device_serial_db)
                }
...
def test_common_100_101_104():
    """
    Sub Feature Code: UI_Common_PM_2_Pure_UPI_success_callback_after_qr_expiry_TID_Dep_HDFC_AutoRefund_Disabled
    Sub Feature Description: Performing two pure upi success callback via TID Dep HDFC after expiry the qr when autorefund is disabled
    TC naming code description:
    100: Payment Method
    101: UPI
    104: TC104
...
def test_common_100_101_105():
    """
    Sub Feature Code: UI_Common_PM_2_Pure_UPI_success_callback_after_qr_expiry_TID_Dep_HDFC_AutoRefund_Enabled
    Sub Feature Description: Performing two pure upi success callback via TID Dep HDFC after expiry the qr when autorefund is enabled
    TC naming code description:
    100: Payment Method
    101: UPI
    104: TC104
...
def test_common_100_101_106():
    ...
    Sub Feature Description: Performing two pure upi failed callback via TID Dep HDFC after expiry the qr when autorefund is disabled
    TC naming code description:
    100: Payment Method
    101: UPI
    106: TC106
...
def test_common_100_101_107():
    """
    Sub Feature Code: UI_Common_PM_2_Pure_UPI_failed_callback_after_qr_expiry_TID_Dep_HDFC_AutoRefund_Enabled
    Sub Feature Description: Performing two pure upi failed callback via TID Dep HDFC after expiry the qr when autorefund is enabled
    TC naming code description:
    100: Payment Method
    101: UPI
    107: TC107
