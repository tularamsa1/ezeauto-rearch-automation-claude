...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_037():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Sale_EMVCTLS_DEBIT_VISA
        Sub Feature Description: API that performs EMVCTLS Sale txn using DEBIT VISA card via HDFC
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_038():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Sale_EMVCTLS_DEBIT_MASTER
        Sub Feature Description: API that performs EMVCTLS Sale txn using DEBIT MASTER card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        038: TC038
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_039():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Sale_EMVCTLS_DEBIT_RUPAY
        Sub Feature Description: API that performs EMVCTLS Sale txn using DEBIT RUPAY card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        039: TC039
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_040():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Sale_EMVCTLS_CREDIT_VISA
        Sub Feature Description: API that performs EMVCTLS Sale txn using CREDIT VISA card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        040: TC040
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_041():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Sale_EMVCTLS_CREDIT_MASTER
        Sub Feature Description: API that performs EMVCTLS Sale txn using CREDIT MASTER card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        041: TC041
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_042():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Sale_EMVCTLS_CREDIT_RUPAY
        Sub Feature Description: API that performs EMVCTLS Sale txn using CREDIT RUPAY card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        042: TC042
