...
from PageFactory.ReArch.rearch_native_locators import HomeScreen
...
@pytest.mark.appVal
def test_common_rearch_0034():
    """
    Sub Feature Code: UI_ReArch_Home_Verify_RelaunchApp_HDFC
    Sub Feature Description:
        Launch ReArch app, handle login if required, navigate to Settings,
        scroll down and click Relaunch App, then verify the app relaunches
        by checking that the "Collect Payment" text is present.
    ...
    NL Source Steps:
      ...
      Test Steps:
        ...
        2. click on settings
        3. scroll down and click on Relaunch App
        4. wait and verify "Collect Payment" text is present
    ...
    try:
        ...
        try:
            ...
            # Step 3: Scroll down and click Relaunch App
        ...
        if ConfigReader.read_config("Validations", "app_validation") == "True":
            ...
            try:
                # Step 4: Wait and verify "Collect Payment" text is present after relaunch
                home_page.wait_for_initial_home_screen()
