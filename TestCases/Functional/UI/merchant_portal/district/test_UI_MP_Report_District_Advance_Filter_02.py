...
def test_mp_700_704_046():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_rr_number_as_District_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter rr number when logging in as District Head
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and rr_number='" + rr_number_api + "' and username NOT IN ('" + country_username + "', '" + region_username + "', '" + state_username + "') order by created_time asc limit 1;"
            ...
            db_hierarchy = "|".join(db_hierarchy_original.split("|")[3:])
            ...
            db_hierarchy_last = "|".join(db_hierarchy_original_last.split("|")[3:])
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_704_047():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_username_as_District_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter username when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    047: TC047
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and username='" + txn_username + "' and username NOT IN ('" + country_username + "', '" + region_username + "', '" + state_username + "') order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_704_048():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_DebitCardType_as_District_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter DebitCardType when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    048: TC048
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_card_type='DEBIT' and username NOT IN ('" + country_username + "', '" + region_username + "', '" + state_username + "') order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_704_049():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_CreditCardType_as_District_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter CreditCardType when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    049: TC049
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_card_type='CREDIT' and username NOT IN ('" + country_username + "', '" + region_username + "', '" + state_username + "') order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_704_050():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_ALL_CardType_as_District_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter ALL CardType when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    050: TC050
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_card_type in ('DEBIT','CREDIT','UNKNOWN','PREPAID','FPAYDEFAULT') and username NOT IN ('" + country_username + "', '" + region_username + "', '" + state_username + "') order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
