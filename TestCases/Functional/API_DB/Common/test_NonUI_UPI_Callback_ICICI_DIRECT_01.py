...
def test_d102_101_004():
    ...
    TC naming code description:
    100-> Payment Method, 101-> UPI, 004->TC004
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_d102_101_009():
    ...
    TC naming code description: d102: Payment Method, 101: UPI, 009: TC009
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_d102_101_010():
    ...
    TC naming code description: d102: Payment Method, 101: UPI, 010: TC010
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_d102_101_011():
    ...
    ICICI_Direct pg when auto refund is disabled
    TC naming code description: d102:- Payment Method, 101:- UPI, 011:- TC011
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
