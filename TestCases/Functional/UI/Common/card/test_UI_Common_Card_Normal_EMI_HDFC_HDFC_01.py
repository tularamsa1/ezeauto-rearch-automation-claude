...
def test_common_100_115_05_106():
    """
        Sub Feature Code: UI_Common_Card_Normal_EMI_Instant_Subvention_Payback_By_Merchant_Percentage_Success
        _Txn_For_An_Org_HDFC_HDFC_EMV_VISA_CreditCard_With_Pin_417666_3_Months_Tenure
        Sub Feature Description: Performing the Normal EMI instant subvention payback by merchant percentage success
        transaction for an org via HDFC HDFC PG using EMV VISA Credit card with pin for 3 months tenure (bin: 417666)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 106: TC106
    """
    try:
        ...
        try:
            ...
            query = (f"select * from subvention_plan where org_code='{org_code}' and card_type= 'CREDIT'"
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "subvention_amount": round(float(cal_instant_amt), 2),
                ...
                api_original_txn_amt = response['amountOriginal']
        ...
        if (ConfigReader.read_config("Validations", "charge_slip_validation")) == "True":
            ...
            try:
                ...
                expected_charge_slip_values = {
                    ...
                    "Total Instant EMI Discount Amount": "Rs." + "{:.2f}".format(cal_instant_amt),
                    ...
                    "BASE AMOUNT:": "Rs." + "{:,.2f}".format(normal_inst_amt),
                    "pin_verified_section_text": "PIN VERIFIED OK",
                    "unnamed_section_text": "L3TEST/CARD0010 I agree to pay as per the card issuer agreement."
                }
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_05_107():
    """
        Sub Feature Code: UI_Common_Card_Normal_EMI_Instant_Subvention_Payback_By_Merchant_Percentage_Success
        _Txn_For_An_Org_HDFC_HDFC_EMV_VISA_CreditCard_With_Pin_417666_6_Months_Tenure
        Sub Feature Description: Performing the Normal EMI instant subvention payback by merchant percentage success
        transaction for an org via HDFC HDFC PG using EMV VISA Credit card with pin for 6 months tenure (bin: 417666)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 107: TC107
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_05_108():
    """
        Sub Feature Code: UI_Common_Card_Normal_EMI_Instant_Subvention_Payback_By_Merchant_Percentage_Success
        _Txn_For_An_Org_HDFC_HDFC_EMV_VISA_CreditCard_With_Pin_417666_9_Months_Tenure
        Sub Feature Description: Performing the Normal EMI instant subvention payback by merchant percentage success
        transaction for an org via HDFC HDFC PG using EMV VISA Credit card with pin for 9 months tenure (bin: 417666)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 108: TC108
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_05_109():
    """
        Sub Feature Code: UI_Common_Card_Normal_EMI_Instant_Subvention_Payback_By_Merchant_Percentage_Success
        _Txn_For_An_Org_HDFC_HDFC_EMV_VISA_CreditCard_With_Pin_417666_12_Months_Tenure
        Sub Feature Description: Performing the Normal EMI instant subvention payback by merchant percentage success
        transaction for an org via HDFC HDFC PG using EMV VISA Credit card with pin for 12 months tenure (bin: 417666)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 109: TC109
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_05_110():
    """
        Sub Feature Code: UI_Common_Card_Normal_EMI_Instant_Subvention_Payback_By_Merchant_Percentage_Success
        ...
        TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 110: TC110
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
