...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_102_282():
    """
    Sub feature code: TID_Dep_UI_SA_BQRV4_UPI_QR_Generation_Success_AXIS_ATOS
    Sub feature Description: TID Dep - Verifying a success BQRV4_UPI QR Generation via AXIS_ATOS
    TC naming code description: 100: Payment Method, 102: BQRV4, 282: TC282
    """
    try:
        ...
        query = "select * from upi_merchant_config where org_code ='" + str(
            org_code) + "' AND status = 'ACTIVE' AND bank_code = 'AXIS'"
