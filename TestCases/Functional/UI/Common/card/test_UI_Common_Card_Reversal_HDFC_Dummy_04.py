...
@pytest.mark.appVal
def test_common_100_115_170():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMV_VISA_CreditCard_With_Pin_417666
    Sub Feature Description:  Performing the EMV Reversal transaction via HDFC Dummy PG using VISA Credit card having
    16 digit PAN length with pin  (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 170: TC170
    """
    try:
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_171():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMV_MASTER_CreditCard_With_Pin_541333
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 171: TC171
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_172():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMV_VISA_CreditCard_Without_Pin_417666
    Sub Feature Description: Performing the EMV Reversal transaction via HDFC Dummy PG using VISA Credit card having
    16 digit PAN length without pin (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 172: TC172
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
