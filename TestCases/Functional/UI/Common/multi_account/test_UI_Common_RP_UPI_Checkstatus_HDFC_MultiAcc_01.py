...
def test_common_100_111_005():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_Success_Via_CheckStatus_HDFC_MultiAcc
    Sub Feature Description: MultiAccount - Verification of a Remote Pay successful upi txn via HDFC using check status
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_111_006():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_Failed_Via_CheckStatus_HDFC_MultiAcc
    Sub Feature Description: MultiAccount - Verification of a Remote Pay failed UPI txn via HDFC using check status
    TC naming code description:
    100: Payment Method
    111: MultiAcc_RemotePay
    006: TC_006
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_111_013():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_Success_Via_CheckStatus_with_second_label_HDFC_MultiAcc
    Sub Feature Description: MultiAccount - Verification of a Remote Pay successful upi txn via HDFC using check status second account (ex:acc2 label)
    TC naming code description:
    100: Payment Method
    111: MultiAcc_RemotePay
    013: TC_013
