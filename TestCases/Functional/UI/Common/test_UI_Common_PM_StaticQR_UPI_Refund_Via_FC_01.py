...
def test_common_100_107_008():
    """
    Sub Feature Code: UI_Common_PM_StaticQR_UPI_Full_Refund_Via_API_FC
    Sub Feature Description: Performing a upi full refund using api for FC
    TC naming code description: 100: Payment Method, 107: UPI STATIC QR, 008: TC008
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "charge_slip_validation")) == "True":
            ...
            try:
                ...
                expected_values = {
                    'PAID BY:': 'UPI', 'BASE AMOUNT:': "Rs." + str(amount) + ".00",
...
@pytest.mark.chargeSlipVal
@pytest.mark.portalVal
def test_common_100_107_009():
    """
    Sub Feature Code: UI_Common_PM_StaticQR_UPI_Refund_Posted_Via_API_FC
    Sub Feature Description: Performing a upi refund posted using api for FC
    TC naming code description: 100: Payment Method, 107: UPI STATIC QR, 009: TC009
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.chargeSlipVal
@pytest.mark.portalVal
def test_common_100_107_010():
    """
    Sub Feature Code: UI_Common_PM_StaticQR_UPI_Refund_Failed_Via_API_FC
    Sub Feature Description: Performing a upi refund failed using api for FC
    TC naming code description: 100: Payment Method, 107: UPI STATIC QR, 010: TC010
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.chargeSlipVal
@pytest.mark.portalVal
def test_common_100_107_011():
    """
    Sub Feature Code: UI_Common_PM_StaticQR_UPI_Partial_Refund_Via_FC
    Sub Feature Description: Performing a upi partial refund using api for FC
    TC naming code description: 100: Payment Method, 107: UPI STATIC QR, 011: TC011
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.chargeSlipVal
@pytest.mark.portalVal
def test_common_100_107_012():
    """
    Sub Feature Code: UI_Common_PM_StaticQR_UPI_Refund_With_Decimal_Via_FC
    Sub Feature Description: Verification of a upi refund with decimal value using api for FC
    TC naming code description: 100: Payment Method, 107: UPI STATIC QR, 008: TC008
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
