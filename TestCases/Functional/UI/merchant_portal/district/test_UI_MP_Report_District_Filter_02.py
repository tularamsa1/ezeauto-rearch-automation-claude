...
def test_mp_700_704_028():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Authorised_as_District_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Authorised when logging in as District Head
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_704_029():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Failed_as_District_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Failed when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    029: TC029
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_704_030():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Pending_as_District_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Pending when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    030: TC030
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_704_031():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Authorised_refunded_as_District_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Authorised_refunded when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    031: TC031
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_704_032():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_refunded_as_District_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status refunded when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    032: TC032
