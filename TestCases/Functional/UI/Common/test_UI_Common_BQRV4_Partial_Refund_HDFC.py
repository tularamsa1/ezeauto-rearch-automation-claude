...
def test_common_100_102_054():
    """
    Sub Feature Code: UI_Common_BQRV4_UPI_Partial_Refund_Via_API_HDFC
    Sub Feature Description: Verification of a BQRV4 Partial Refund transaction through API via HDFC
    TC naming code description: 100: Payment Method, 102: BQR, 054: TC054
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "portal_validation")) == "True":
            ...
            try:
                ...
                expected_portal_values = {
                    ...
                    "pmt_state_2": "REFUNDED",
                    "pmt_type_2": "UPI",
                    "txn_amt_2": f"{str(amount_new_2)}.00",
        ...
        if (ConfigReader.read_config("Validations", "charge_slip_validation")) == "True":
            ...
            try:
                txn_date, txn_time = date_time_converter.to_chargeslip_format(modified_date_new_2)
                expected_charge_slip_values = {
                    'PAID BY:': 'UPI', 'merchant_ref_no': 'Ref # ' + str(order_id), 'RRN': str(rrn_new_2),
                    'BASE AMOUNT:': "Rs." + str(amount_new_2)+ ".00", 'date': txn_date,
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_102_055():
    """
    :Description: Verification of a BQRV4 Partial Refund transaction via HDFC
    :Subfeature code: UI_Common_BQRV4_PartialRefund_via_HDFC_055
    :TC naming code description:100->Payment Method, 102->BQR, 055-> TC055
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        try:
            ...
            homePagePortal.perform_refund_of_txn(amount_new_2)
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_102_132():
    """
    Sub Feature Code:  UI_Common_BQRV4_UPI_Partial_Refund_Decimal_Amount_HDFC
    Sub Feature Description: Verification of a BQRV4 UPI Partial Refund transaction where refund amount will be in decimals via HDFC pg
    TC naming code description: 100: Payment Method, 102: BQR, 132: TC132
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        if (ConfigReader.read_config("Validations", "charge_slip_validation")) == "True":
            ...
            try:
                ...
                expected_charge_slip_values = {
                    'PAID BY:': 'UPI', 'merchant_ref_no': 'Ref # ' + str(order_id), 'RRN': str(rrn_new_2),
                    'BASE AMOUNT:': "Rs." + str(amount_new_2), 'date': txn_date,
                    'time': txn_time, 'AUTH CODE': auth_code_new_2
                }
                receipt_validator.perform_charge_slip_validations(txn_id_new_2,
                                                                  {"username": app_username, "password": app_password},
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_102_133():
    """
    Sub Feature Code: UI_Common_BQRV4_UPI_Two_Times_Successful_Partial_Refund_Via_API_HDFC
    Sub Feature Description: Verification of a BQRV4 UPI two times Successful Partial Refund via HDFC
    TC naming code description: 100: Payment Method, 102: BQR, 133: TC133
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                expected_app_values = {
                    ...
                    "txn_amt_3": "{:.2f}".format(amount_new_3),
                    ...
                    "order_id_3": order_id,
                    "payment_msg_3": "PAYMENT VOIDED/REFUNDED",
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "order_id_2": order_id,
                    "pmt_status_3": "REFUNDED",
                    "txn_amt_3": float(amount_new_3), "pmt_mode_3": "UPI",
                    "pmt_state_3": "REFUNDED", "rrn_3": str(rrn_new_3),
                    "settle_status_3": "SETTLED",
                    "acquirer_code_3": "HDFC",
                    # "issuer_code_3": "HDFC",
                    "txn_type_3": "REFUND", "mid_3": mid, "tid_3": tid,
                    "org_code_3": org_code,
                    "auth_code_3": auth_code_new_3,
                    "date_3": date_new_3,
                    "order_id_3": order_id
        ...
        if (ConfigReader.read_config("Validations", "portal_validation")) == "True":
            ...
            try:
                ...
                expected_portal_values = {
                    ...
                    "pmt_state_3": "REFUNDED",
                    "pmt_type_3": "UPI",
                    "txn_amt_3": f"{str(amount_new_3)}.00",
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_102_134():
    """
    Sub Feature Code: UI_Common_BQRV4_UPI_Two_Partial_Refund_Amount_Greater_Than_Original_Amount_HDFC
    Sub Feature Description: Verification of a BQRV4 UPI Partial Refund transaction where partial refund amount
    TC naming code description: 100: Payment Method, 102: BQR, 134: TC134
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
