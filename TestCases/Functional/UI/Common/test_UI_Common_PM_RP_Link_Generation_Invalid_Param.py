...
@pytest.mark.apiVal
def test_common_100_103_323():
    """
    Sub Feature Code: UI_Common_PM_RP_Link_Generation_Amount_Field
    Sub Feature Description: Amount field is mandatory for any payment option in Api to start with the transaction
    TC naming code description: 100: Payment Method, 103: RemotePay, 323: TC323
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "err_msg": "Transaction declined. Amount entered is less than minimum allowed for the "
                               "transaction. Minimum Allowed: null"
                }
...
@pytest.mark.usefixtures("log_on_success", "method_setup")
@pytest.mark.apiVal
def test_common_100_103_333():
    """
     Sub Feature Code: UI_Common_PM_RP_Failed_Link_Generation_Invalid_Payment_Flow
     Sub Feature Description: Verification of link generation with invalid "paymentFlow" say "Browers"
     TC naming code description: 100: Payment Method, 103: RemotePay, 333: TC333
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    "success_status": False,
                    "err_msg": "Processing failed. Please try again."
                }
                logger.debug(f"expected_api_values: {expected_api_values}")
...
@pytest.mark.usefixtures("log_on_success", "method_setup")
@pytest.mark.apiVal
def test_common_100_103_334():
    """
     Sub Feature Code: UI_Common_PM_RP_Failed_Link_Generation_Invalid_Payment_Flow
     Sub Feature Description: Verification of link generation with invalid "paymentFlow" say "Browse"
     TC naming code description: 100: Payment Method, 103: RemotePay, 334: TC334
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.usefixtures("log_on_success", "method_setup")
@pytest.mark.apiVal
def test_common_100_103_335():
    """
     Sub Feature Code: UI_Common_PM_RP_Failed_Link_Generation_Blank_Payment_Flow
     Sub Feature Description: Verification of link generation with blank "paymentFlow"
     TC naming code description: 100: Payment Method, 103: RemotePay, 335: TC335
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_common_100_103_336():
    """
     Sub Feature Code: UI_Common_PM_RP_Success_Link_Generation_Without_Browser_Flow_Via_HDFC
     Sub Feature Description: Success Remote Pay txn via HDFC without sending "paymentFlow" as param
     TC naming code description: 100: Payment Method, 103: RemotePay, 333: TC333
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
