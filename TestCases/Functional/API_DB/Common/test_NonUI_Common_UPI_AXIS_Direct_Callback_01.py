...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_sample_001():
    """
    ...
    try:
        ...
        try:
            ...
            logger.debug("Generating QR using UPI QR generate APi")
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_sample_002():
    """
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_sample_003():
    """
...
@pytest.mark.apiVal
@pytest.mark.appVal
def test_common_100_sample_004():
    """
    Sub Feature Code: UI_Common_PM_UPI_Pure_UPI_Pending_Via_AXIS_DIRECT
    Sub Feature Description: Verification of sa check status for upi pending txn via AXIS_DIRECT
    TC naming code description: 100: Payment Method, 101: UPI, 052: TC052
    """
