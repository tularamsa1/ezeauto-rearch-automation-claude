...
def test_sa_100_102_078():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_Checkstatus_Success_AXIS_ATOS
    Sub Feature Description: Verification of a BQRV4 SA Checkstatus Success via AXIS_ATOS
    TC naming code description: 100: Payment Method, 102: BQR, 078: TC078
    """
    try:
...
def test_sa_100_102_079():
    ...
    TC naming code description: 100: Payment Method, 102: BQR, 079: TC079
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
