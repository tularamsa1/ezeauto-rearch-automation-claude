...
def test_common_100_102_101():
    """
    Sub Feature Code: Tid Dep - UI_Common_PM_BQRV4_BQR_Refund_HDFC
    Sub Feature Description: Tid Dep - Verification of a BQRV4 BQR Refund transaction via HDFC PG
...
def test_common_100_102_103():
    """
    Sub Feature Code: Tid Dep - UI_Common_PM_BQRV4_BQR_Refund_Failed_HDFC
    Sub Feature Description: Tid Dep - Verification of a BQRV4 BQR Refund failed transaction  via HDFC pg
    TC naming code description: 100: Payment Method, 102: BQR, 103: TC103
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                actual_api_values = {
                    ...
                    "acquirer_code_2": acquirer_code_api_refunded,
                    "txn_type_2": txn_type_api_refunded,
                    # "mid": mid_api_refunded, "tid": tid_api_refunded,
                    "org_code_2": org_code_api_refunded,
                    "auth_code": auth_code_api_original,
                    "date": date_time_converter.from_api_to_datetime_format(date_api_original),
                    "date_2": date_time_converter.from_api_to_datetime_format(date_api_refunded),
...
def test_common_100_102_104():
    """
    Sub Feature Code: Tid Dep - UI_Common_PM_BQRV4_BQR_Refund_Posted_HDFC
    Sub Feature Description: Tid Dep - Verification of a BQRV4 BQR Refund posted transaction via HDFC pg
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    "bqr_pmt_state_2": "REFUND_INITIATED",
                    "bqr_txn_amt_2": float(amount),
                    "bqr_txn_type_2": "REFUND",  # "brq_terminal_info_id_2": terminal_info_id,
                    "bqr_bank_code_2": "HDFC",
                    "bqr_merchant_config_id_2": bqr_mc_id, "bqr_txn_primary_id_2": txn_id_refunded,
                ...
                actual_db_values = {
                    ...
                    "mid": mid_db_original,
                    "tid": tid_db_original,
                    # "refund_mid_2": mid_db_refunded,
                    #"refund_tid_2": tid_db_refunded,
                    "device_serial": str(device_serial_db),
                    #"device_serial_2": str(device_serial_db_refunded),
                    "bqr_pmt_status": bqr_status_db, "bqr_pmt_state": bqr_state_db,
                    "bqr_txn_amt": bqr_amount_db,
                    "bqr_txn_type": bqr_txn_type_db, "brq_terminal_info_id": brq_terminal_info_id_db,
                    "bqr_bank_code": bqr_bank_code_db,
