...
def test_common_100_110_033():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_Success_Refund_MultiAcc_AXIS_ATOS
    Sub Feature Description: Multi Account - Verification of a successful bqrv4 upi Refund txn via AXIS ATOS
    TC naming code description: 100: Payment Method 110: MultiAcc_BQR, 033: TC033
    """
    try:
...
def test_common_100_110_034():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_Partial_Refund_MultiAcc_AXIS_ATOS
    Sub Feature Description: Multi Account - Verification of bqrv4 upi successful Partial Refund txn via AXIS ATOS
    TC naming code description: 100: Payment Method 110: MultiAcc_BQR, 034: TC034
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
