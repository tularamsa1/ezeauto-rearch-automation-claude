...
#     """
#     :Description: Verification of a BQR Callback Failed transaction via YES_ATOS
#     :Sub Feature code: UI_Common_PM_BQR_Callback_Failed_YES_ATOS_23
#     :TC naming code description: 100->Payment Method
#                                 102->BQR
#                                 023-> TC23
#     """
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_102_028():
    """
    :Description: Verification of a BQR Success transaction with two Callback via YES_ATOS
    :Sub Feature code: UI_Common_PM_BQR_two_Callback_Success_YES_ATOS_28
    :TC naming code description: 100->Payment Method
                                102->BQR
                                028-> TC28
    """
