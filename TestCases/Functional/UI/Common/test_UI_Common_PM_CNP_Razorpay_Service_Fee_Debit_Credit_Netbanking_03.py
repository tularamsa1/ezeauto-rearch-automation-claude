...
def test_common_100_103_530():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_Debit_Credit_Fixed_&Netbanking_Any_Schemes_Amt_Fixed_with_Credit_Card_Details
    Sub Feature Description: Verify Service Fee when debit credit netbanking enabled and JSON is debit and credit with
    FIXED and ANY netbanking scheme and amount in FIXED range with credit details.
    TC naming code description: 100: Payment Method, 103: RemotePay, 530: TC_530
    """
    ...
    try:
        ...
        scheme = "MASTER_CARD"
        payment_by = "CREDIT"
        json_id = "service_fee_json_TC_100_103_530"
        payment_mode = "CNP"
        acc_label = ""
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_531():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_Debit_Credit_PERCENT_&Netbanking_Any_Schemes_Amt_Percent_with_Credit_Card_Details
    Sub Feature Description: Verify Service Fee when debit credit netbanking enabled and JSON is debit and credit with
    PERCENT and ANY netbanking scheme and amount in Percent range with credit details.
    TC naming code description: 100: Payment Method, 103: RemotePay, 531: TC_531
    """
    expected_message = "Your payment is successfully completed! You may close the browser now."
    try:
        testcase_id = sys._getframe().f_code.co_name
        ...
        scheme = "MASTER_CARD"
        payment_by = "CREDIT"
        json_id = "service_fee_json_TC_100_103_531"
        payment_mode = "CNP"
        acc_label = ""
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_532():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_Debit_Credit_FIXED_PERCENT_&Netbanking_Any_Schemes_Amt_Fixed_Percent_with_Credit_Card_Details
    Sub Feature Description: Verify Service Fee when debit credit netbanking enabled and JSON is debit and credit with
    FIXED_PERCENT and ANY netbanking scheme and amount in Fixed Percent range with credit details.
    TC naming code description: 100: Payment Method, 103: RemotePay, 532: TC_532
    """
    expected_message = "Your payment is successfully completed! You may close the browser now."
    try:
        testcase_id = sys._getframe().f_code.co_name
        ...
        scheme = "MASTER_CARD"
        payment_by = "CREDIT"
        json_id = "service_fee_json_TC_100_103_532"
        payment_mode = "CNP"
        acc_label = ""
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_533():
    """
    Sub Feature Code:UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_Debit_Credit_Fixed_&Netbanking_HDFC_Any_Schemes_Amt_Fixed_with_Debit_Card_Details
    Sub Feature Description:Verify Service Fee when debit credit netbanking enabled and JSON is debit and credit with FIXED and ANY HDFC netbanking scheme and amount in FIXED range with debit details
    TC naming code description: 100: Payment Method, 103: RemotePay, 533: TC_533
    """
    expected_message = "Your payment is successfully completed! You may close the browser now."
    try:
        testcase_id = sys._getframe().f_code.co_name
        ...
        scheme = "MASTER_CARD"
        payment_by = "DEBIT"
        json_id = "service_fee_json_TC_100_103_533"
        payment_mode = "CNP"
        acc_label = ""
        derivation_type = "FIXED"
        bank = "NULL"
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_534():
    """
    Sub Feature Code:UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_Debit_Credit_Fixed_&Netbanking_HDFC_Schemes_Amt_Fixed_with_Credit_Card_Details
    Sub Feature Description:Verify Service Fee when debit credit netbanking enabled and JSON is debit and credit with FIXED and ANY HDFC netbanking scheme and amount in FIXED range with credit details
    TC naming code description: 100: Payment Method, 103: RemotePay, 534: TC_534
    """
    expected_message = "Your payment is successfully completed! You may close the browser now."
    try:
        testcase_id = sys._getframe().f_code.co_name
        ...
        scheme = "MASTER_CARD"
        payment_by = "CREDIT"
        json_id = "service_fee_json_TC_100_103_534"
        payment_mode = "CNP"
        acc_label = ""
        derivation_type = "FIXED"
        bank = "NULL"
