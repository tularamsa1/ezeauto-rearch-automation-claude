...
def test_mp_700_702_023():
    """
    Sub Feature Code: UI_MP_Report_based_on_username_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Filter username when logging in as Regional Head
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_702_024():
    """
    Sub Feature Code: UI_MP_Report_based_on_order_number_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Filter order number when logging in as Regional Head
    TC naming code description:
    700: Merchant Portal
    702: Region
    024: TC024
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_702_025():
    """
    Sub Feature Code: UI_MP_Report_based_on_calender_dates_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Filter calender dates when logging in as Regional Head
    TC naming code description:
    700: Merchant Portal
    702: Region
    025: TC025
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_702_026():
    """
    Sub Feature Code: UI_MP_Report_based_on_Location_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Filter All Location when logging in as Regional Head
    TC naming code description:
    700: Merchant Portal
    702: Region
    026: TC026
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_702_027():
    """
    Sub Feature Code: UI_MP_Report_based_on_User_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Filter User when logging in as Regional Head
    TC naming code description:
    700: Merchant Portal
    702: Region
    027: TC027
