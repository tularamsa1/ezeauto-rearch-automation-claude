...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_139():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMVCTLS_DEBIT_VISA
        Sub Feature Description:API that performs EMVCTLS Online Refund txn having DEBIT VISA card via ATOS_TLE
    ...
    try:
        ...
        try:
            ...
            if card_payment_success == True:
                ...
                query = "select id from terminal_info where device_serial = '" + card_details['Device Serial'] + "' and payment_gateway = 'ATOS_TLE' and acquirer_code = 'AXIS';"
                ...
                if settle_success == True:
                    ...
                    api_details = DBProcessor.get_api_details('DB Refresh')#Need to add portal creds in req payload
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                ...
                expectedDBValues = {"txn_amt": float(original_amount), "pmt_mode":"CARD",
                                    ...
                                    "txn_type":"REFUND", "acq_code":"AXIS", "pmt_gateway":"ATOS_TLE",
                                    ...
                                    "mware_txn_type": "REFUND", "mware_acq_code": "AXIS", "mware_pmt_gateway": "ATOS_TLE",
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_140():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMVCTLS_DEBIT_MASTER
        Sub Feature Description:API that performs EMVCTLS Online Refund txn having DEBIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        140: TC140
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_141():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMVCTLS_DEBIT_RUPAY
        Sub Feature Description:API that performs EMVCTLS Online Refund txn having DEBIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        141: TC141
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_142():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMVCTLS_CREDIT_VISA
        Sub Feature Description:API that performs EMVCTLS Online Refund txn having CREDIT VISA card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        142: TC142
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_143():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMVCTLS_CREDIT_MASTER
        Sub Feature Description:API that performs EMVCTLS Online Refund txn having CREDIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        143: TC143
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_144():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMVCTLS_CREDIT_RUPAY
        Sub Feature Description:API that performs EMVCTLS Online Refund txn having CREDIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        141: TC144
