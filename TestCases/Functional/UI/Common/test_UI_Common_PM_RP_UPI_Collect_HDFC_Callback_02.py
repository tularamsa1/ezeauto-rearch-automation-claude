...
def test_common_100_103_019():  # Make sure to add the test case name as same as the sub feature code.
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"generated transaction date and time  is : {created_time}")
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {"pmt_status": "AUTHORIZED",
                                       ...
                                       "tid": tid,
                                       "org_code": org_code,
                                       "date": date,    #do i need to change pmt_status => pmt_status_1
