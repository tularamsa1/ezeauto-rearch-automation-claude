...
def test_mp_700_703_064():
    """
    Sub Feature Code: UI_MP_Profile_Info_as_State_head
    Sub Feature Description: Verifying Profile information by logging in and log out  when logging in as State Head
