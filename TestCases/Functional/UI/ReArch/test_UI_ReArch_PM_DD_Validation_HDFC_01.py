...
@pytest.mark.appVal
def test_common_rearch_0031():
    """
    Sub Feature Code: UI_ReArch_PM_DD_Validation_HDFC
    Sub Feature Description:
        ...
        overlay -> scroll down -> Demand Draft -> click Confirm Payment without filling
        any fields -> verify all validation error messages are displayed:
        "DD number should be 6 digits", "Please select a bank",
        "Please provide Branch Name", scroll down and verify "Please enter DD Date".
    ...
    NL Source Steps:
      ...
      Test Steps:
        ...
        8. verify error messages: "DD number should be 6 digits",
           "Please select a bank", "Please provide Branch Name",
           scroll down and verify "Please enter DD Date"
    ...
    try:
        ...
        try:
            ...
            # Step 7: Click Confirm Payment without filling any DD details
            dd_page = ReArchDemandDraftPage(app_driver)
            dd_page.wait_for_dd_form()
            dd_page.click_confirm_payment()
            logger.debug("Clicked Confirm Payment on empty DD form")
        ...
        if ConfigReader.read_config("Validations", "app_validation") == "True":
            ...
            try:
                ...
                expected_app_values = {
                    "dd_number_error": "DD number should be 6 digits",
                    "select_bank_error": "Please select a bank",
                    "branch_name_error": "Please provide Branch Name",
                    "dd_date_error": "Please enter DD Date",
                }
                logger.debug(f"expected_app_values: {expected_app_values}")

                dd_number_error = str(dd_page.is_error_dd_number_displayed())
                select_bank_error = str(dd_page.is_error_select_bank_displayed())
                branch_name_error = str(dd_page.is_error_branch_name_displayed())

                # Scroll down to verify DD date error
                dd_page.swipe_up()
                dd_date_error = str(dd_page.is_error_dd_date_displayed())

                actual_app_values = {
                    "dd_number_error": "DD number should be 6 digits" if dd_number_error == "True" else "NOT DISPLAYED",
                    "select_bank_error": "Please select a bank" if select_bank_error == "True" else "NOT DISPLAYED",
                    "branch_name_error": "Please provide Branch Name" if branch_name_error == "True" else "NOT DISPLAYED",
                    "dd_date_error": "Please enter DD Date" if dd_date_error == "True" else "NOT DISPLAYED",
                }
