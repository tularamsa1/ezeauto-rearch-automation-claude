...
def test_mp_700_701_001():
    """
    Sub Feature Code: UI_MP_Dashboard_TotalSales_Txns_as_Country_head
    Sub Feature Description: Verifying Total sales, Total Txns and hierarchy details for Upper hierarchy when logging in as Country Head
