...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_073():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Void_EMV_DEBIT_VISA
        Sub Feature Description: API that performs EMV Void txn having DEBIT VISA card via PRIZMV2
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_074():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Void_EMV_DEBIT_MASTER
        Sub Feature Description: API that performs EMV Void txn having DEBIT MASTER card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        074: TC074
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_075():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Void_EMV_DEBIT_RUPAY
        Sub Feature Description: API that performs EMV Void txn having DEBIT RUPAY card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        075: TC075
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_076():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Void_EMV_CREDIT_VISA
        Sub Feature Description: API that performs EMV Void txn having CREDIT VISA card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        076: TC076
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_077():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Void_EMV_CREDIT_MASTER
        Sub Feature Description: API that performs EMV Void txn having CREDIT MASTER card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        077: TC077
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_078():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Void_EMV_CREDIT_RUPAY
        Sub Feature Description: API that performs EMV Void txn having CREDIT RUPAY card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        078: TC078
