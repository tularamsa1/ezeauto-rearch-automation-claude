...
def test_card():
    ...
    try:
        ...
        try:
            ...
            payment_page.click_on_credit_debit_card_mode()
        ...
        if (ConfigReader.read_config("Validations", "charge_slip_validation")) == "True":
            ...
            try:
                ...
                expected_values = {'merchant_ref_no': 'Ref # ' + str(order_id),
                                   ...
                                   'AUTH CODE': auth_code, 'BATCH NO':str(batch_number), 'CARD TYPE':'RUPAY', 'AUTH CODE':auth_code,
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_preauth_release():
    """
        Sub Feature Code: success_preauth_txn_release
        Sub Feature Description: Verification of success preauth transaction release
        TC naming code description:
        """
    try:
        testcase_id = sys._getframe().f_code.co_name
