...
@pytest.mark.appVal
def test_common_100_103_146():
    """
    Sub Feature Code: UI_Common_PM_RP_2_UPI_Collect_failed_callback_before_expiry_AXIS_DIRECT_AutoRefund_Disabled
    Sub Feature Description: Performing two UPI collect failed callback via Axis Direct before expiry when autorefund is disabled
    100: Payment Method
    103: RemotePay
    146: TC146
    """
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_147():
    """
    Sub Feature Code: UI_Common_PM_RP_2_UPI_Collect_failed_callback_before_expiry_AXIS_DIRECT_AutoRefund_Enabled
    Sub Feature Description: Performing two UPI Collect failed callback via Axis Direct before expiry when autorefund is enabled
    100: Payment Method
    103: RemotePay
    147: TC147
    """
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_148():
    """
    Sub Feature Code: UI_Common_PM_RP_2_UPI_Collect_failed_callback_after_expiry_AXIS_DIRECT_AutoRefund_Enabled
    Sub Feature Description: Performing two UPI Collect failed callback via Axis Direct after expiry when autorefund is enabled
    100: Payment Method
    103: RemotePay
    148: TC148
    """
