...
def test_common_100_101_042():
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"fetched refund_rr_number from txn table is : {refund_rrn}")
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_101_050():
    """
    Sub Feature Code: UI_Common_PM_UPI_Refund_Failed_Via_API_AXIS_DIRECT
    Sub Feature Description: Verification of a upi refund failed using api for AXIS_DIRECT
    TC naming code description: 100: Payment Method, 101: UPI, 050: TC050
    """
...
def test_common_100_101_051():
    """
    Sub Feature Code: UI_Common_PM_UPI_Refund_Posted_Via_API_AXIS_DIRECT
    Sub Feature Description: Verification of a upi refund posted using api for AXIS_DIRECT
    TC naming code description: 100: Payment Method, 101: UPI ,051: TC051
    """
