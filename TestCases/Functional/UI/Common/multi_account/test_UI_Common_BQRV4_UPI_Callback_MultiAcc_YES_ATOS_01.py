...
def test_common_100_110_019():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_Success_Callback_MultiAcc_YES_ATOS
    Sub Feature Description: Multi Account - Verification of a successful bqrv4 upi txn via YES ATOS using callback
    TC naming code description: 100: Payment Method 110: MultiAcc_BQR, 019: TC019
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.portalVal
def test_common_100_110_020():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_Failed_Callback_MultiAcc_YES_ATOS
    Sub Feature Description: Multi Account - Verification of a failed bqrv4 upi txn via YES ATOS using callback
    TC naming code description: 100: Payment Method 110: MultiAcc_BQR, 020: TC020
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
