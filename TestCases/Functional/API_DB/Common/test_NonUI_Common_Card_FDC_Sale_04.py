...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_177():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Sale_EMVCTLS_WITH_PIN_DEBIT_VISA
        Sub Feature Description: API that performs EMVCTLS with pin Sale txn using DEBIT VISA card via FDC
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_260():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Sale_EMVCTLS_WITH_PIN_DEBIT_MASTER
        Sub Feature Description: API that performs EMVCTLS with pin Sale txn using DEBIT MASTER card via FDC
        TC naming code description:
        100: Payment Method
        104: CARD
        260: TC260
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_261():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Sale_EMVCTLS_WITH_PIN_DEBIT_RUPAY
        Sub Feature Description: API that performs EMVCTLS with pin Sale txn using DEBIT RUPAY card via FDC
        TC naming code description:
        100: Payment Method
        104: CARD
        261: TC261
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_242():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Sale_EMVCTLS_WITH_PIN_CREDIT_MASTER
        Sub Feature Description: API that performs EMVCTLS with pin Sale txn using CREDIT MASTER card via FDC
        TC naming code description:
        100: Payment Method
        104: CARD
        242: TC242
