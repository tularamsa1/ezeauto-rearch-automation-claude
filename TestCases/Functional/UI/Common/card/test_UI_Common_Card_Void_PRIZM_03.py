...
def test_common_100_115_202():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMV_VISA_DebitCard_With_Pin_428090
    Sub Feature Description: Performing the EMV Void transaction via PRIZM PG using VISA Debit card having 16 digit
    PAN length with pin (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 202: TC202
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_203():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMV_RUPAY_DebitCard_With_Pin_608326
    Sub Feature Description: Performing the EMV Void transaction via PRIZM PG using RUPAY Debit card having 16 digit
    PAN length with pin (bin: 608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 203: TC203
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_204():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMV_VISA_DebitCard_Without_Pin_476173
    Sub Feature Description: Performing the EMV Void transaction via PRIZM PG using VISA Debit card having 16 digit
    PAN length without pin (bin: 476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 204: TC204
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_205():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMV_MASTER_DebitCard_Without_Pin_222360
    Sub Feature Description: Performing the EMV Void transaction via PRIZM PG using MASTER Debit card having 16 digit
    PAN length without pin (bin: 222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 205: TC205
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_206():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMV_RUPAY_DebitCard_Without_Pin_608326
    Sub Feature Description: Performing the EMV Void transaction via PRIZM PG using RUPAY Debit card having 16 digit
    PAN length without pin (bin: 608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 206: TC206
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
