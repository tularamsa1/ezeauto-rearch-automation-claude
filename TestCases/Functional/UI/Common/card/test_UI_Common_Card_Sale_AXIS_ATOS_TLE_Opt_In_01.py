...
def test_common_100_116_021():
    """
    Sub Feature Code: UI_Common_Card_Sale_AXIS_ATOS_TLE_Opt_In_MC_Chip_KWD_CreditCard_With_Online_Pin_222297
    Sub Feature Description: Performing the opt in MC Chip KWD sale transaction via AXIS_ATOS_TLE PG using Credit card
    with online pin  (bin:222297)
    TC naming code description: 100: Payment Method, 116: CARD_DCC, 021: TC021
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                expected_app_values = {
                    ...
                    "opted_type": "Yes",
                    "local_card": "No",
                    "txn_currency": "JPY {:,.2f}".format(converted_amount),
                    "markup_fee": "4.50 %",
                    "currency_conversion_fee_rate": "0.52480573 JPY/INR",
                    "currency_converted_rate": "JPY {:,.2f}".format(converted_amount),
        ...
        if (ConfigReader.read_config("Validations", "charge_slip_validation")) == "True":
            ...
            try:
                ...
                expected_charge_slip_values = {
                    ...
                    "RRN": str(rrn),
                    "TRANSACTION AMOUNT:": "JPY " + str(dcc_converted_amount_db) + "0",
                    "AUTH CODE": auth_code,
                    "date": txn_date,
                    "time": txn_time,
                    "payment_option": "SALE",
                    ...
                    "TID": tid,
                    "Fx Rate": "1 INR = 0.52480573 JPY/INR"
                }
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_116_022():
    """
    Sub Feature Code: UI_Common_Card_Sale_AXIS_ATOS_TLE_Opt_In_VISA_ctls_GBP_CreditCard_With_Online_Pin_417666
    Sub Feature Description: Performing the opt in MC Chip KWD sale transaction via AXIS_ATOS_TLE PG using Credit card
    with online pin  (bin:222297)
    TC naming code description: 100: Payment Method, 116: CARD_DCC, 022: TC022
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_116_023():
    """
    Sub Feature Code: UI_Common_Card_Sale_AXIS_ATOS_TLE_Opt_In_VISA_ctls_JPY_CreditCard_With_Online_Pin_405170
    Sub Feature Description: Performing the opt in VISA ctls JPY sale transaction via AXIS_ATOS_TLE PG using Credit card
    with online pin  (bin:405170)
    TC naming code description: 100: Payment Method, 116: CARD_DCC, 023: TC023
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
