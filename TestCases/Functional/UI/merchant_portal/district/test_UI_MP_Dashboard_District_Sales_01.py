...
def test_mp_700_704_001():
    """
    Sub Feature Code: UI_MP_Dashboard_Sales_as_District_head
    Sub Feature Description: Verifying Total sales, Total Txns and hierarchy details for Upper hierarchy when logging in as District Head
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where" \
                    ...
                    "' and '" + current_end_date_1 + "' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "');"
