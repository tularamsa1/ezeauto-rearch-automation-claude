...
def test_common_100_115_07_144():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Brand_Percentage_Block_Success_Txn_For_An_Org_HDFC_Dummy_KOTAK_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenure
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand_EMI, 144: TC144
    """
    try:
        ...
        query = f"select * from subvention_plan where brand_id='{brand_id}' and org_code='{org_code}' and card_type= 'DEBIT' and bank='KOTAK' and eze_emi_enabled=b'0';"
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_145():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Band_Percentage_Unblock_Failed_Txn_For_An_Org_HDFC_Dummy_KOTAK_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenture
    Sub Feature Description: Performing the brand EMI payback by brand percentage unblock failed transaction for
    an org via HDFC Dummy PG for KOTAK issuer using EMV VISA Debit card with pin for 3 months tenure (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 145: TC145
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_146():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Band_Percentage_Unblock_Success_Txn_For_An_Org_HDFC_Dummy_KOTAK_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenture
    Sub Feature Description: Performing the brand EMI payback by brand percentage unblock success transaction for
    an org via HDFC Dummy PG for KOTAK issuer using EMV VISA Debit card with pin for 3 months tenure (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 146: TC146
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_147():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Brand_Percentage_Block_Failed_Txn_For_An_Org_HDFC_Dummy_KOTAK_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenure
    ...
    via HDFC Dummy PG for KOTAK issuer using EMV VISA Debit card with pin for 3 months tenure (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand_EMI, 147: TC147
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.usefixtures("log_on_success", "method_setup")
@pytest.mark.dbVal
def test_common_100_115_07_148():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_Check_Eligibility_For_An_Org_HDFC_Dummy_KOTAK_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenure
    Sub Feature Description: Performing the brand EMI check eligibility for an org (not ezetap) via HDFC Dummy PG for
    KOTAK issuer using EMV VISA Debit card with pin for 3 months tenure (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand_EMI, 148: TC148
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
