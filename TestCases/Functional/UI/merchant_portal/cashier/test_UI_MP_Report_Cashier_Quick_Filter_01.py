...
def test_mp_700_709_020():
    """
    Sub Feature Code: UI_MP_Report_for_Daily_txn_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page using Daily quick Filter when logged in as Cashier
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_709_021():
    """
    Sub Feature Code: UI_MP_Report_for_Monthly_txn_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page using Monthly quick Filter when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    021: TC021
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_709_022():
    """
    Sub Feature Code: UI_MP_Report_for_Weekly_txn_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page using weekly quick Filter when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    022: TC022
