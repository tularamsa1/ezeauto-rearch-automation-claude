...
def test_sa_100_110_021():
    """
    :Description: Multi Account - Verification of a successful bqrv4 upi txn via YES ATOS using checkstatus
    :Sub Feature code: UI_SA_BQRV4_UPI_Success_Checkstatus_MultiAcc_YES_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 UPI, 021-> TC021
    """
    try:
...
def test_sa_100_110_022():
    """
    :Description: Multi Account - Verification of a failed bqrv4 upi txn via YES ATOS using checkstatus
    :Sub Feature code: UI_SA_BQRV4_UPI_Failed_Checkstatus_MultiAcc_YES_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 UPI, 022-> TC022
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_sa_100_110_038():
    """
    :Description: Multi Account - Verification of a successful bqrv4 upi txn via YES ATOS using checkstatus with 2nd account label
    :Sub Feature code: UI_SA_BQRV4_UPI_Success_Checkstatus_with_2nd_label_MultiAcc_YES_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 UPI, 038-> TC038
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
