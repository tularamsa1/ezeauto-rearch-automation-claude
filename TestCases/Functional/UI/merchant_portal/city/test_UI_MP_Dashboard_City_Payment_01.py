...
def test_mp_700_706_008():
    """
    Sub Feature Code: UI_MP_Payment_using_Card_as_City_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using card when logged in as City Head
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'CARD'" \
                                                "and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + taluk_username + "', '" + district_username + "');"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_706_009():
    """
    Sub Feature Code: UI_MP_Payment_using_Cash_as_City_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using Cash when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    009: TC009
        ...
        try:
            ...
            query = "select sum(amount) from txn where" \
                    " org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'CASH' and " \
                                                 "id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + taluk_username + "', '" + district_username + "');"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_706_010():
    """
    Sub Feature Code: UI_MP_Payment_using_UPI_as_City_hea
    Sub Feature Description: Verifying txn details on dashboard for payment done using UPI when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    010: TC010
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'UPI' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + taluk_username + "', '" + district_username + "');"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_706_011():
    """
    Sub Feature Code: UI_MP_Payment_using_BQR_as_City_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using BQR when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    011: TC011
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'BHARATQR' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + taluk_username + "', '" + district_username + "');"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_706_012():
    """
    Sub Feature Code: UI_MP_Payment_using_CNP_as_City_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using CNP when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    012: TC012
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'CNP' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + taluk_username + "', '" + district_username + "');"
