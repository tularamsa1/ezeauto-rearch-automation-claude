...
@pytest.mark.appVal
def test_common_100_115_108():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMVCTLS_VISA_DebitCard_With_Pin_476173
    Sub Feature Description: Performing the EMVCTLS Reversal transaction via HDFC Dummy PG using VISA Debit card having
    16 digit PAN length with pin (bin: 476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 0108: TC108
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                expected_app_values = {
                    ...
                    "pmt_mode": "CARD",
                    "txn_id": txn_id,
                    "pmt_status": "REVERSAL_PENDING",
                    "rrn": "N/A" if rrn is None else rrn,
                    "order_id": order_id,
                    "pmt_msg": "PAYMENT PENDING",
                    "settle_status": "PENDING",
                    "auth_code": "N/A" if auth_code is None else auth_code,
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_109():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMVCTLS_MASTER_DebitCard_With_Pin_222360
    Sub Feature Description: Performing the EMVCTLS Reversal transaction via HDFC Dummy PG using MASTER Debit card having
    16 digit PAN length with pin (bin: 222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 109: TC109
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_110():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMVCTLS_RUPAY_DebitCard_With_Pin_608326
    Sub Feature Description: Performing the EMVCTLS Reversal transaction via HDFC Dummy PG using RUPAY Debit card having
    16 digit PAN length  with pin (bin: 608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 110: TC110
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_111():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMVCTLS_VISA_DebitCard_Without_Pin_476173
    Sub Feature Description: Performing the EMVCTLS Reversal transaction via HDFC Dummy PG using VISA Debit card having
    16 digit PAN length without pin (bin:476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 111: TC111
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_112():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMVCTLS_MASTER_DebitCard_Without_Pin_222360
    Sub Feature Description: Performing the EMVCTLS Reversal transaction via HDFC Dummy PG using MASTER Debit card having
    16 digit PAN length without pin (bin: 222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 112: TC112
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
