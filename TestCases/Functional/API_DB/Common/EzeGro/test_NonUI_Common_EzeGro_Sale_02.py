...
def test_common_600_601_001():
    ...
    Sub Feature Description: Validate for New user by hitting generate_otp and validate_otp api
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                actual_api_values = {
                    ...
                    "opted_for_comm": merchant_opt_comm,
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                ...
                expected_db_values = {
                    ...
                    "application_name": "ezegro",
                    "application_key_status": "ACTIVE",
                ...
                actual_db_values = {
                    ...
                    "application_key": application_key_db,
                    "application_name": application_name_db,
                    "application_key_status": application_key_status_db,
...
def test_common_600_601_002():
    ...
    Sub Feature Description: Validate for existing user by hitting generate_otp and validate_otp api
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                ...
                expected_db_values = {
                    ...
                    "push_status": "ACTIVE",
                    # "push_token": expected_push_token_db,
                    "user_device_identifier": device_identifier,
                    "user_device_identifier_type": device_identifier_type,
...
def test_common_600_601_003():
    ...
    Sub Feature Description: Validate for existing user by hitting generate_otp,resend_otp and validate_otp api
...
def test_common_600_601_004():
    """
    Sub Feature Code: NonUI_Common_EzeGro_Sale_Generate_Validate_and_Autologin_OTP_For_ExistingUser
    Sub Feature Description: Validate for existing user by hitting generate_otp, validate_otp api autologin api
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                expected_api_values = {
                    ...
                    # "product_category": autologin_merchant_product_category,
                    "status": autologin_merchant_status
                }
                ...
                actual_api_values = {
                    ...
                    "resend_count_left": generate_otp_resend_count_left,
                    "success": generate_otp_success,
                    "device_identifier": generate_otp_device_identifier,
                    "device_identifier_type": generate_otp_device_identifier_type,
                    "mobile_no": generate_otp_mobile_number,
                    "user": expected_user_db,
                    "customer_version": int(validate_otp_customer_version),
                    "review_version": int(validate_otp_review_version),
                    "order_version": int(validate_otp_order_version),
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                ...
                actual_db_values = {
                    ...
                    "user_mobile_no": user_mobile_number_db,
                    "user": user_db,
                    "merchant_customer_version": merchant_customer_version,
                    "merchant_order_version": merchant_order_version,
                    "merchant_review_version": merchant_review_version
                }
...
def test_common_600_601_005():
    """
    Sub Feature Code: NonUI_Common_EzeGro_Sale_Generate_Validate_OTP_and_Logout
    Sub Feature Description: Validate for existing user by hitting generate_otp,validate_otp and autologin api
