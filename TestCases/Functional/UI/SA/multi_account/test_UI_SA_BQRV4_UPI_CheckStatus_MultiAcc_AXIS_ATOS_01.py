...
def test_sa_100_110_035():
    """
    Sub Feature Code: UI_SA_PM_BQRV4_UPI_Success_Checkstatus_MultiAcc_AXIS_ATOS
    Sub Feature Description: Multi Account - Verification of a successful bqrv4 upi txn via AXIS ATOS using checkstatus
    TC naming code description: 100: Payment Method 110: MultiAcc_BQR, 035: TC035
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {"pmt_status": "AUTHORIZED",
                                       ...
                                       "acquirer_code": "AXIS",
                                       "issuer_code": "AXIS","txn_type": "CHARGE",
                                       "mid": mid, "tid": tid,
                                       "org_code": org_code,
                                       "auth_code": auth_code,
                                       "date": date,
...
@pytest.mark.appVal
@pytest.mark.portalVal
def test_sa_100_110_036():
    """
    Sub Feature Code: UI_SA_PM_BQRV4_UPI_Failed_Checkstatus_MultiAcc_AXIS_ATOS
    Sub Feature Description: Multi Account - Verification of a failed bqrv4 upi txn via AXIS ATOS using checkstatus
    TC naming code description: 100: Payment Method 110: MultiAcc_BQR, 036: TC036
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.chargeSlipVal
def test_sa_100_110_040():
    """
    Sub Feature Code: UI_SA_PM_BQRV4_UPI_Success_Checkstatus_with_2nd_label_MultiAcc_AXIS_ATOS
    Sub Feature Description: Multi Account - Verification of a successful bqrv4 upi txn via AXIS ATOS using checkstatus with 2nd account label
    TC naming code description: 100: Payment Method 110: MultiAcc_BQR, 040: TC040
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
