...
def test_common_100_102_152():
    """
    Sub Feature Code: Tid Dep - UI_Common_PM_BQRV4_BQR_Success_Via_CheckStatus_API_ICICI_FDC
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    # "bqr_merchant_pan": bqr_merchant_pan,
                    "bqr_rrn": rrn,
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_102_154():
    """
    Sub Feature Code: Tid Dep - UI_Common_PM_BQRV4_BQR_Failed_Via_CheckStatus_API_ICICI_FDC
    Sub Feature Description: Tid Dep - Verification of a failed bqrv4 bqr txn via ICICI_FDC using check status api
    TC naming code description: 100: Payment Method, 102: BQR, 154: TC154
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_102_157():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_BQR_Pending_Via_CheckStatus_API_TID_Dep_ICICI_FDC
    Sub Feature Description: Verification of a pending bqrv4 bqr txn via ICICI_FDC Tid Dep using check status api
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "txn_type": txn_type, "mid": mid, "tid": tid,
                    "org_code": org_code_txn,
                    # "auth_code": auth_code, "rrn": str(rrn),
                    "date": date,
                    "order_id": order_id,
                    "device_serial": str(device_serial)
                }
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_102_158():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_BQR_CheckStatus_Via_API_After_Expiry_TID_Dep_ICICI_FDC
    Sub Feature Description: Verification of a bqrv4 bqr txn after expiry via ICICI_FDC Tid Dep using check status api
    TC naming code description:
    100: Payment Method
    102: BQRV4
    158: TC158
