...
def test_common_100_115_07_197():
    """
    Sub Feature Code:  UI_Common_Disable_Brand_EMI_in_Portal_Settings
    Sub Feature Description: Disable the brand EMI in the portal and verify that the brand EMI option is not displayed in the universal pay screen under affordability.
