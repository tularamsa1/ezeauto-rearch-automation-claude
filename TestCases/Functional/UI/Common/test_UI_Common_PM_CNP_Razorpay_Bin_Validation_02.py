...
def test_common_100_103_432():
    """
    Sub Feature Code:UI_Common_PM_CNP_Razorpay_Bin_Validation_Payment_Card_Type_In_Lower_Case_In_Bin_Info_Txn_Failed
    Sub Feature Description:Verify that when payment_card_type field at bin_info table is in lower case txn should not get success
    TC naming code description: 100: Payment Method, 103: RemotePay, 432: TC_432
    """
    expected_error_message = f"Card number is invalid!!"
    try:
