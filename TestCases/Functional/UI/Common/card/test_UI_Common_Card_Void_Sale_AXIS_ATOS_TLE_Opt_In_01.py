...
def test_common_100_116_032():
    """
    Sub Feature Code: UI_Common_Card_Void_Sale_HDFC_PLANET_Opt_In_MC_Chip_KWD_CreditCard_With_Online_Pin_222297
    Sub Feature Description: Performing the opt in MC Chip KWD void sale transaction via HDFC PLANET PG using Credit
    card with online pin  (bin:222297)
    TC naming code description: 100: Payment Method, 116: CARD_DCC, 032: TC032
    """
    try:
