...
def test_common_100_110_027():
    """
    :Description: Multi Account - Verification of a successful bqrv4 bqr txn via AXIS ATOS using callback
    :Sub Feature code: UI_Common_BQRV4_BQR_Success_Callback_MultiAcc_AXIS_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 BQR, 027-> TC027
    """
    try:
...
def test_common_100_110_028():
    ...
    :Sub Feature code: UI_Common_BQRV4_BQR_Failed_Callback_MultiAcc_AXIS_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 BQR, 028-> TC028
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
