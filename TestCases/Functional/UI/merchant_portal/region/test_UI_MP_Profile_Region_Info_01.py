...
def test_mp_700_702_064():
    """
    Sub Feature Code: UI_MP_Profile_Info_as_Regional_Head
    Sub Feature Description: Verifying Profile information by logging in and log out  as Regional Head
