...
def test_common_100_101_043():
    """
    Sub Feature Code: UI_Common_PM_Pure_UPI_partial_Refund_via_API_AXIS_DIRECT
    Sub Feature Description: Verification of a partial refund using api for AXIS_DIRECT
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                expected_app_values = {"refunded_txn_status": "STATUS:REFUNDED",
                                       ...
                                       "refunded_txn_amt": str(refund_amount),
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                expected_api_values = {"refunded_txn_status": "REFUNDED",
                                       "refunded_txn_amt": refund_amount,
                                       "refunded_txn_mode": "UPI",
        ...
        if (ConfigReader.read_config("Validations", "charge_slip_validation")) == "True":
            ...
            try:
                ...
                chargeslip_val_result_1 = receipt_validator.perform_charge_slip_validations(
                    txn_id_original, {"username": username, "password": password}, expected_chargeslip_values_original)
                chargeslip_val_result_2 = receipt_validator.perform_charge_slip_validations(
                    txn_id_refunded, {"username": username, "password": password}, expected_chargeslip_values_refunded)
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_101_130():
    """
    Sub Feature Code: UI_Common_PM_UPI_two_times_partial_refund_via_api_amount_greater_than_original_amount_AXIS_DIRECT
    Sub Feature Description: Verification of a UPI partial refund via api when partial refund amount is greater than original amount for AXIS_DIRECT
    TC naming code description:
    100: Payment Method
    101: UPI
    130: TC130
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "original_acquirer_code": "AXIS",
                    "original_issuer_code": "AXIS",
                    "original_txn_type": txn_type,
                    "original_mid": mid, "original_tid": tid,
                    "original_org_code": org_code_txn,
                    "refunded_acquirer_code": "AXIS",
                    # "issuer_code_refunded": "AXIS",
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    "original_acquirer_code": "AXIS",
                    "refunded_acquirer_code": "AXIS",
                    "original_bank_code": "AXIS",
                    "bank_code_refunded": "AXIS_DIRECT",
                    "original_pmt_gateway": "AXIS",
                    "refunded_pmt_gateway": "AXIS",
                    "original_upi_txn_type": "PAY_QR",
                    "refunded_upi_txn_type": "REFUND",
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_101_131():
    """
    Sub Feature Code: UI_Common_PM_UPI_two_times_successful_partial_refund_via_api_AXIS_DIRECT
    Sub Feature Description: Verification of two times partial refund for upi txn via api for Tid Dep AXIS_DIRECT
    TC naming code description:
    100: Payment Method
    101: UPI
    131: TC131
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "partial_refund_date_2": partial_refund_date_and_time_2,
                    "acquirer_code": "AXIS",
                    "partial_refund_acquirer_code_1": "AXIS",
                    "partial_refund_acquirer_code_2": "AXIS",
                    "issuer_code": "AXIS",
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    "pmt_gateway": "AXIS",
                    "partial_refund_pmt_gateway_1": "AXIS",
                    "partial_refund_pmt_gateway_2": "AXIS",
                    "upi_txn_type": "PAY_QR",
                    "partial_refund_upi_txn_type_1": "REFUND",
                    "partial_refund_upi_txn_type_2": "REFUND",
                    "upi_bank_code": "AXIS_DIRECT",
                    "partial_refund_upi_bank_code_1": "AXIS_DIRECT",
                    "partial_refund_upi_bank_code_2": "AXIS_DIRECT",
                    "upi_mc_id": upi_mc_id,
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_101_132():
    """
    Sub Feature Code: UI_Common_PM_Pure_UPI_PartialRefund_In_Decimal_via_api_AXIS_DIRECT
    Sub Feature Description: Verification of  a pure UPI txn when Partial refund is performed via api for AXIS_DIRECT
