...
def test_common_100_111_009():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_Refund_By_API_HDFC_MultiAcc
    Sub Feature Description: MultiAcc - Verification of a successful refund for Remote Pay UPI using api for HDFC
    ...
    try:
        ...
        logger.info(f" account_label_name_2 is  : {account_label_name_2}")
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_111_010():
    """
    Sub Feature Code: UI_Common_PM_RP_Pure_upi_PartialRefund_HDFC_MultiAcc
    Sub Feature Description: MultiAcc - Verification of a remote pay partial refund for pure upi txn
    TC naming code description:
    100: Payment Method
    111: MultiAcc_RemotePay
    010: TC010
    ...
    try:
        ...
        try:
            ...
            api_details = DBProcessor.get_api_details('paymentRefund', request_body={
                "username": app_username, "password": app_password, "amount": refunded_amount,
