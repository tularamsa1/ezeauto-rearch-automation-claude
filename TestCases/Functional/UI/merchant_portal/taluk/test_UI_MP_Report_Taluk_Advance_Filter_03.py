...
def test_mp_700_705_051():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_VISACardBrand_as_Taluk_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter VISACardBrand when logging in as Taluk Head
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_card_brand='" + card_brand_search_value + "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') order by created_time asc limit 1;"
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_705_052():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_MASTERCardBrand_as_Taluk_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter MASTERCardBrand when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    052: TC052
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_705_053():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_RUPAYCardBrand_as_Taluk_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter RUPAYCardBrand when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    053: TC053
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_705_054():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_ALL_CardBrand_as_Taluk_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for ALL CardBrand when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    054: TC054
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_705_055():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_Cash_as_Taluk_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode Cash when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    055: TC055
