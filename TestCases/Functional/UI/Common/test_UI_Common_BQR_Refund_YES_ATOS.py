...
def test_common_100_102_035():
    """
    :Description: Verification of a BQRV4 BQR Refund transaction through Portal via YES_ATOS
    :Sub feature code: UI_Common_BQRV4_BQR_Refund_Portal_via_YES_ATOS
    :TC naming code description:100->Payment Method, 102->BQR, 035-> TC035
    """
    try:
...
def test_common_100_102_036():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_BQR_Refund_API_via_YES_ATOS
    Sub Feature Description: Verification of a BQRV4 BQR Refund transaction through API via YES_ATOS
    TC naming code description: 100: Payment Method, 102: BQR, 036: TC036
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_common_100_102_044():
    ...
    :TC naming code description:100->Payment Method, 102->BQR, 044-> TC044
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_common_100_102_045():
    ...
    :TC naming code description:100->Payment Method, 102->BQR, 045-> TC045
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
