...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_104():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_timeout_MSR_DEBIT_VISA
        Sub Feature Description: API that performs IS Success and inquiry timeout on IS settlement for MSR DEBIT VISA card via IDFC_FDC
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_105():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_timeout_MSR_DEBIT_MASTER
        Sub Feature Description: API that performs IS Success and inquiry timeout on IS settlement for MSR MASTER_CARD VISA card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        105: TC105
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_106():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_timeout_MSR_DEBIT_RUPAY
        Sub Feature Description: API that performs IS Success and inquiry timeout on IS settlement for MSR RUPAY VISA card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        106: TC106
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_107():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_timeout_MSR_CREDIT_VISA
        Sub Feature Description: API that performs IS Success and inquiry timeout on IS settlement for MSR VISA CREDIT card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        107: TC107
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_108():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_timeout_MSR_CREDIT_MASTER
        Sub Feature Description: API that performs IS Success and inquiry timeout on IS settlement for MSR MASTER_CARD CREDIT card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        108: TC108
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_109():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_timeout_MSR_CREDIT_RUPAY
        Sub Feature Description: API that performs IS Success and inquiry timeout on IS settlement for MSR RUPAY CREDIT card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        109: TC109
