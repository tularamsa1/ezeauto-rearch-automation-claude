...
def test_mp_700_702_001():
    """
    Sub Feature Code: UI_MP_Dashboard_Sales_as_Regional_head
    Sub Feature Description: Verifying Total sales, Total Txns and hierarchy details for Upper hierarchy when logging in as Regional Head
    ...
    try:
        ...
        try:
            ...
            logger.info(f"bearer token from api : {token}")
            api_details['Header'] = {'Authorization': 'Bearer ' + token, 'Content-Type': 'application/json'}
