...
def test_common_100_115_07_050():
    """
        Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Brand_Percentage_Void_Txn_For_Root_Org_HDFC_Dummy_DebitCard_Without_Pin_476173_For_3_Months_Tenure
        Sub Feature Description: Performing the brand EMI payback by brand percentage void transaction for root org via HDFC Dummy PG using EMV VISA Debit card with pin for 3 months tenure (bin: 476173)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 050: TC050
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_052():
    """
        Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Brand_Percentage_Void_Txn_For_Root_Org_HDFC_Dummy_DebitCard_Without_Pin_476173_For_6_Months_Tenure
        Sub Feature Description: Performing the brand EMI payback by brand percentage void transaction for root org via HDFC Dummy PG using EMV VISA Debit card with pin for 6 months tenure (bin: 476173)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 052: TC052
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_054():
    """
        Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Brand_Percentage_Void_Txn_For_Root_Org_HDFC_Dummy_DebitCard_Without_Pin_476173_For_9_Months_Tenure
        Sub Feature Description: Performing the brand EMI payback by brand percentage void transaction for root org via HDFC Dummy PG using EMV VISA Debit card with pin for 9 months tenure (bin: 476173)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 054: TC054
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
