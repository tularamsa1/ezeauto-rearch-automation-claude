...
def test_common_100_102_052():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_Refund_HDFC
    Sub Feature Description: Verification of a BQRV4 Refund transaction via HDFC
...
def test_common_100_102_053():
    """
    Sub Feature Code: UI_Common_BQRV4_UPI_Refund_via_API_HDFC
    Sub Feature Description: Verification of a BQRV4 Refund transaction through API via HDFC
    TC naming code description: 100: Payment Method, 102: BQRV4, 053: TC053
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
