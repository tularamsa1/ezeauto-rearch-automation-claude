...
def test_common_100_102_151():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_Success_Via_BQRV4_UPI_Callback_TID_Dep_ICICI_FDC
    Sub Feature Description: Verification of a successful BQRV4 upi txn via ICICI_FDC Tid Dep using success callback
...
def test_common_100_102_161():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_Success_Callback_After_QR_Expiry_TID_Dep_ICICI_FDC
    Sub Feature Description: Performing successful BQRV4 UPI callback after qr expiry via ICICI_FDC Tid Dep
...
def test_common_100_102_162():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_1_UPI_1_BQR_Success_Callback_After_QR_Expiry_TID_Dep_ICICI_FDC
    Sub Feature Description: Performing successful BQRV4 1 UPI and 1 BQR callback after qr expiry via ICICI_FDC Tid Dep
...
def test_common_100_102_164():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_2_UPI_Success_Callback_Before_QR_Expiry_TID_Dep_ICICI_FDC
    Sub Feature Description: Performing 2 successful BQRV4 UPI callback before qr expiry via ICICI_FDC Tid Dep
