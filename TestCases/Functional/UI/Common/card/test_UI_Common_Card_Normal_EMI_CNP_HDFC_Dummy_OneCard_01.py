...
def test_common_100_103_05_001():
    """
    Sub Feature Code: UI_Common_Card_Normal_EMI_Success_CNP_Txn_For_An_Org_HDFC_Dummy_OneCard_VISA_CreditCard_400000_For_3_Months_Tenure
    Sub Feature Description: Performing the normal EMI success CNP transaction for an org (not ezetap) via HDFC Dummy PG for
    OneCard issuer using VISA Credit card for 3 months tenure (bin: 400000)
    TC naming code description: 100: Payment Method, 103: CNP, 05: NORMAL_EMI, 001: TC001
    """
    ...
    try:
        ...
        testsuite_teardown.update_bin_info(bin_number='400000', bank_code='ONECARD', bank='ONECARD')
