...
@pytest.mark.apiVal
@pytest.mark.appVal
def test_common_rearch_0023():
    """
    Sub Feature Code: UI_ReArch_PM_UPI_Failed_HDFC
    Sub Feature Description:
        Launch ReArch app, handle login if required, enter a random amount (101-200),
        select UPI, proceed through Order Details overlay, wait for QR screen,
        cancel payment (HDFC simulator failed scenario), verify app returns to
    ...
    NL Source Steps:
      ...
      Test Steps:
        ...
        4.  enter amount (random 101-200)
        5.  click upi
        6.  wait for order details screen
        7.  click proceed
        8.  wait for qr screen
        9.  cancel payment (HDFC simulator Failed scenario)
        10. click on history button on enter amount screen
        11. do app and api validation

      NOTE: No charge slip validation — failed txns have no RRN/auth code.
    ...
    try:
        ...
        try:
            ...
            amount = str(random.randint(101, 200))
            ...
            # App returns to enter amount screen after failed cancel
            home_page.wait_for_home_page_load()
        ...
        if ConfigReader.read_config("Validations", "api_validation") == "True":
            ...
            try:
                ...
                expected_api_values = {
                    "pmt_status":    "FAILED",        # TODO: verify on first run
