...
def test_d102_101_002():
    ...
    TC naming code description:
    100-> Payment Method, 101-> UPI, 002->TC002
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_d102_101_013():
    ...
    TC naming code description: d102-> Payment Method, 101:- UPI, 013:-TC013
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_d102_101_014():
    ...
    TC naming code description: d102-> Payment Method, 101:- UPI, 014:-TC014
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
