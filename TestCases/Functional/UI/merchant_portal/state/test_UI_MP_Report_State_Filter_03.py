...
def test_mp_700_703_033():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Voided_as_State_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Voided when logging in as State Head
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_703_034():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Reversed_as_State_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Reversed when logging in as State Head
    TC naming code description:
    700: Merchant Portal
    703: State
    034: TC034
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_703_035():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Refund_pending_as_State_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Refund Pending when logging in as State Head
    TC naming code description:
    700: Merchant Portal
    703: State
    035: TC035
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_703_036():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Pre_Auth_as_State_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Pre Auth when logging in as State Head
    TC naming code description:
    700: Merchant Portal
    703: State
    036: TC036
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_703_037():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_REL_Pre_Auth_as_State_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status REL_Pre_Auth when logging in as State Head
    TC naming code description:
    700: Merchant Portal
    703: State
    037: TC037
