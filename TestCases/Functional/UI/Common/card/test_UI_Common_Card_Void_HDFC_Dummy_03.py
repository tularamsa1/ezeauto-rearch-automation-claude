...
def test_common_100_115_137():
    """
    Sub Feature Code: UI_Common_Card_Void_HDFC_Dummy_EMV_VISA_DebitCard_Without_Pin_476173
    Sub Feature Description:  Performing the EMV Void transaction via HDFC Dummy PG using Visa Debit card having
     16 digit PAN length without pin (bin: 476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 137: TC137
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_138():
    """
    Sub Feature Code: UI_Common_Card_Void_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090
    Sub Feature Description:  Performing the EMV Void transaction via HDFC Dummy PG using Visa Debit card having
     16 digit PAN length with pin (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 138: TC138
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_139():
    """
    Sub Feature Code: UI_Common_Card_Void_HDFC_Dummy_EMV_VISA_CreditCard_Without_Pin_417666
    Sub Feature Description:  Performing the EMV Void transaction via HDFC Dummy PG using Visa Credit card having
     16 digit PAN length without pin (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 139: TC139
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_140():
    """
    Sub Feature Code: UI_Common_Card_Void_HDFC_Dummy_EMV_VISA_CreditCard_With_Pin_417666
    Sub Feature Description:  Performing the CTLS Void transaction via HDFC Dummy PG using Visa Credit card having
     16 digit PAN length with pin (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 140: TC140
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_141():
    """
    Sub Feature Code: UI_Common_Card_Void_HDFC_Dummy_EMV_MASTER_DebitCard_Without_Pin_222360
    Sub Feature Description:  Performing the CTLS Void transaction via HDFC Dummy PG using MASTER Debit card having
     16 digit PAN length without pin (bin: 222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 141: TC141
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
