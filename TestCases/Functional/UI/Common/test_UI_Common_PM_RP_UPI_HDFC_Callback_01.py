...
def test_common_100_103_059():
    """
    Sub Feature Code: UI_Common_PM_UPI_success_callback_after_expiry_AutoRefund_Disabled_HDFC
    Sub Feature Description:Performing a UPI  success callback via HDFC after expiry when autorefund is disabled
    TC naming code description:
    100: Payment Method
    103: RemotePay
    059: TC_059
    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                app_date_and_time = txn_history_page.fetch_date_time_text()
                logger.info(f"Fetching date from txn history for the txn : {new_txn_id}, {app_date_and_time}")
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {"pmt_status": "FAILED",
                                       ...
                                       "new_tid": tid, "new_org_code": original_org_code_txn,
                                       "date": date,
                                       }
                logger.debug(f"expected_api_values: {expected_api_values}")
                api_details = DBProcessor.get_api_details('txnDetails',
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    "new_acquirer_code": "HDFC",
                    "new_bank_code": "HDFC",
                    "new_payment_gateway": "HDFC",
                    "new_upi_txn_type_db": "REMOTE_PAY_UPI_INTENT",
                    "new_upi_bank_code_db": "HDFC",
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_061():
    """
    Sub Feature Code: UI_Common_PM_Two_UPI_Success_Callback_After_Expiry_AutoRefundDisabled_HDFC
    ...
    try:
        ...
        try:
            ...
            logger.info(f"New modified time for api is : {new_txn_posting_date_api}")
            new_txn_posting_date_app = result['modified_time'].values[0]
