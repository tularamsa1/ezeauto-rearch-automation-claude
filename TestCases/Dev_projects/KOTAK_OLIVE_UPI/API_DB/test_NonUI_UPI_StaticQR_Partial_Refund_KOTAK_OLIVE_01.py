...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d103_107_009():
    """
    Sub Feature Code: NonUI_Common_UPI_StaticQR_Partial_Refund_Success_KOTAK_OLIVE
    Sub Feature Description: Initiate upi static QR via api and perform upi success callback and perform partial refund
    for the same via KOTAK_OLIVE.
    TC naming code description: d103->Dev Project[KOTAK_OLIVE_UPI], 107-> UPI Static QR, 009->TC009
    """
    try:
        ...
        try:
            ...
            logger.debug(f"performing partial refund through api")
