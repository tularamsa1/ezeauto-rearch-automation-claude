...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_201():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Void_EMV_WITH_PIN_DEBIT_VISA
        Sub Feature Description: API that performs EMV with pin Void txn having DEBIT VISA card via PRIZMV2
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_187():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Void_EMV_WITH_PIN_DEBIT_RUPAY
        Sub Feature Description: API that performs EMV with pin Void txn having DEBIT RUPAY card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        187: TC187
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_215():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Void_EMV_WITH_PIN_CREDIT_VISA
        Sub Feature Description: API that performs EMV with pin Void txn having CREDIT VISA card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        215: TC215
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_229():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Void_EMV_WITH_PIN_CREDIT_MASTER
        Sub Feature Description: API that performs EMV with pin Void txn having CREDIT MASTER card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        229: TC229
