...
@pytest.mark.appVal
def test_common_100_115_01_013():
    """
    Sub Feature Code: UI_Common_Card_Sale_Tip_Reversal_Txn_HDFC_Dummy_EMVCTLS_VISA_DebitCard_Without_pin_476173
    Sub Feature Description: Performing the EMVCTLS sale tip reversal transaction via HDFC Dummy PG using VISA Debit
    card having 16 digit PAN length without pin (bin:476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 01: Sale+Tip, 013: TC013
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                expected_app_values = {
                    ...
                    "rr_number": "N/A" if rrn is None else rrn,
                    "order_id": order_id,
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_01_014():
    """
    Sub Feature Code: UI_Common_Card_Sale_Tip_Reversal_Txn_HDFC_Dummy_EMVCTLS_MASTER_DebitCard_Without_pin_222360
    Sub Feature Description: Performing the EMVCTLS sale tip reversal transaction via HDFC Dummy PG using MASTER Debit
    card having 16 digit PAN length without pin (bin:222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 01: Sale+Tip, 014: TC014
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_01_015():
    """
    Sub Feature Code: UI_Common_Card_Sale_Tip_Reversal_Txn_HDFC_Dummy_EMVCTLS_RUPAY_DebitCard_Without_pin_608326
    Sub Feature Description: Performing the EMVCTLS sale tip reversal transaction via HDFC Dummy PG using RUPAY Debit
    card having 16 digit PAN length without pin (bin:608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 01: Sale+Tip, 015: TC015
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
