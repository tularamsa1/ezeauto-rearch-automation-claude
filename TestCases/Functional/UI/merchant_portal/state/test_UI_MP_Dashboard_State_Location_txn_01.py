...
def test_mp_700_703_006():
    """
    Sub Feature Code: UI_MP_Calender_txn_for_specific_location_using_dropdown_values_as_State_head
    Sub Feature Description: Verifying txn details on dashboard  for specific location using dropdown values when logging in as State Head
    ...
    try:
        ...
        try:
            ...
            location_hierarchy = ["Maharastra", "Mumbai_City_District", "Akole", "Mumbai1", "Hub1", str(node_name)]
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_703_007():
    """
    Sub Feature Code: UI_MP_Calender_txn_for_specific_location_using_search_option_as_State_head
    Sub Feature Description: Verifying txn details on dashboard  for specific location using search option when logging in as State Head
    TC naming code description:
    700: Merchant Portal
    703: State
    007: TC007
