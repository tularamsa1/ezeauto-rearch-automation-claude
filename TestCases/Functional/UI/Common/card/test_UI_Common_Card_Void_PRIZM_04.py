...
def test_common_100_115_207():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMV_VISA_CreditCard_With_Pin_417666
    Sub Feature Description: Performing the EMV Void transaction via PRIZM PG using VISA Credit card having 16 digit
    PAN length with pin (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 207: TC207
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_208():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMV_MASTER_CreditCard_With_Pin_541333
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 208: TC208
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_209():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMV_VISA_CreditCard_Without_Pin_417666
    Sub Feature Description:  Performing the EMV Void transaction via PRIZM PG using VISA Credit card having 16 digit
    PAN length without pin (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 209: TC209
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
