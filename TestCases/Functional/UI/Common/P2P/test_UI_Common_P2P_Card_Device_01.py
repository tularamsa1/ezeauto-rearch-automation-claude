...
def test_500_503_019():
    ...
    try:
        ...
        try:
            ...
            # Checking P2P notification
            app_driver.open_notifications()
            logger.info(f"Pulled notification bar after network reconnection")
            ...
            if actual_notification == expected_notification:
                ...
                logger.error(f"Could not find P2P connection notification on device after network reconnection")
                raise Exception("Could not find P2P connection notification on device after network reconnection")
