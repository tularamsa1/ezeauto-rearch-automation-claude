...
def test_common_100_110_017():
    """
    :Description: Multi Account - Verification of a successful bqrv4 bqr Refund txn via YES ATOS
    :Sub Feature code: UI_Common_BQRV4_BQR_Success_Refund_MultiAcc_YES_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 BQR, 017-> TC017
    """
    try:
...
def test_common_100_110_018():
    """
    :Description: Multi Account - Verification of bqrv4 bqr successful Partial Refund txn via YES ATOS
    :Sub Feature code: UI_Common_BQRV4_BQR_Partial_Refund_MultiAcc_YES_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 BQR, 018-> TC018
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
