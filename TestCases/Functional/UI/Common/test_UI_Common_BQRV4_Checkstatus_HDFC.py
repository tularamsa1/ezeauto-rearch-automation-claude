...
def test_common_100_102_050():
    """
    Sub Feature Code: UI_Common_PM_Initiate_BQRV4_qr_via_api_Success_Via_CheckStatus_API_HDFC
...
def test_common_100_102_131():
    """
    :Description: Verification of a BQRV4 UPI Amount mismatch upon Checkstatus via HDFC
    :Sub Feature code: UI_Common_BQRV4_UPI_Checkstatus_Amount_Missmatch_HDFC
    :TC naming code description: 100->Payment Method, 102->BQR, 124-> TC131
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
