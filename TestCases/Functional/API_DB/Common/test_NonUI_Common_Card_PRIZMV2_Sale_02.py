...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_067():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Sale_EMVCTLS_DEBIT_VISA
        Sub Feature Description: API that performs EMVCTLS Sale txn using DEBIT VISA card via PRIZMV2
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_068():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Sale_EMVCTLS_DEBIT_MASTER
        Sub Feature Description: API that performs EMVCTLS Sale txn using DEBIT MASTER card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        068: TC068
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_069():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Sale_EMVCTLS_DEBIT_RUPAY
        Sub Feature Description: API that performs EMVCTLS Sale txn using DEBIT RUPAY card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        069: TC069
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_070():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Sale_EMVCTLS_CREDIT_VISA
        Sub Feature Description: API that performs EMVCTLS Sale txn using CREDIT VISA card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        070: TC070
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_071():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Sale_EMVCTLS_CREDIT_MASTER
        Sub Feature Description: API that performs EMVCTLS Sale txn using CREDIT MASTER card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        071: TC071
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_072():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Sale_EMVCTLS_CREDIT_RUPAY
        Sub Feature Description: API that performs EMVCTLS Sale txn using CREDIT RUPAY card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        072: TC072
