...
def test_common_100_110_017():
    ...
    Sub Feature Description: Multi Account - Verification of a successful bqrv4 bqr Refund txn via YES ATOS
    TC naming code description: 100: Payment Method 110: MultiAcc_BQR, 017: TC017
    """
    try:
...
def test_common_100_110_018():
    ...
    Sub Feature Description: Multi Account - Verification of bqrv4 bqr successful Partial Refund txn via YES ATOS
    TC naming code description: 100: Payment Method 110: MultiAcc_BQR, 018: TC018
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
