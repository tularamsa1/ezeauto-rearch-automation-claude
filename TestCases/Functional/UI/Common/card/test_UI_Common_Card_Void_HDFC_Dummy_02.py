...
def test_common_100_115_050():
    """
    Sub Feature Code: UI_Common_Card_Void_HDFC_Dummy_EMVCTLS_RUPAY_DebitCard_Without_Pin_608326
    Sub Feature Description:  Performing the EMVCTLS Void transaction via HDFC Dummy PG using RUPAY Debit card having 16 digit
     PAN length without pin (bin: 608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 050: TC050
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_051():
    """
    Sub Feature Code: UI_Common_Card_Void_HDFC_Dummy_EMVCTLS_VISA_CreditCard_Without_Pin_417666
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 051: TC051
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_052():
    """
    Sub Feature Code: UI_Common_Card_Void_HDFC_Dummy_EMVCTLS_MASTER_CreditCard_Without_Pin_541333
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 052: TC052
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_053():
    """
    Sub Feature Code: UI_Common_Card_Void_HDFC_Dummy_EMVCTLS_MASTER_CreditCard_With_Pin_541333
    Sub Feature Description:  Performing the CTLS Void transaction via HDFC Dummy PG using Master Credit card having
    16 digit PAN length with pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 053: TC053
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
