...
def test_d102_101_021():
    ...
    TC naming code description: d102: ICICI DIRECT UPI Dev, 101: UPI, 021: TC021
    """
    try:
...
def test_d102_101_022():
    ...
    TC naming code description: d102: ICICI DIRECT UPI Dev, 101: UPI, 022: TC022
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_d102_101_023():
    ...
    via ICICI_Direct pg
    TC naming code description: d102: ICICI DIRECT UPI Dev, 101: UPI, 023: TC023
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_d102_101_024():
    ...
    via ICICI_Direct pg
    TC naming code description: d102: ICICI DIRECT UPI Dev, 101: UPI, 024: TC024
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
