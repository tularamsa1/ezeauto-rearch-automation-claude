...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d103_101_001():
    """
    Sub Feature Code: NonUI_Common_UPI_QR_Generation_Success_KOTAK_OLIVE
    Sub Feature Description: Generate QR through api successfully for UPI txn of KOTAK_OLIVE pg
    TC naming code description:d103->Dev Project[KOTAK_OLIVE_UPI], 101-> UPI, 001->TC001
    """
    try:
        ...
        try:
            ...
            logger.debug(f"Fetching txn_id and tr_id from the API_OUTPUT, txn_id : {txn_id} and tr_id : {tr_in_qrcode_uri}")
