...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_127():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Online_Refund_EMVCTLS_DEBIT_VISA
        Sub Feature Description: API that performs EMVCTLS online refund txn using DEBIT VISA card via FDC
    ...
    try:
        ...
        try:
            ...
            if card_payment_success == True:
                ...
                query = "select id from terminal_info where device_serial = '" + card_details[
                    'Device Serial'] + "' and payment_gateway = 'FDC' and acquirer_code = 'ICICI';"
                ...
                if settle_success == True:
                    api_details = DBProcessor.get_api_details('Online_Refund',
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_128():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Online_Refund_EMVCTLS_DEBIT_MASTER
        Sub Feature Description: API that performs EMVCTLS online refund txn using DEBIT MASTER card via FDC
        TC naming code description:
        100: Payment Method
        104: CARD
        128: TC128
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_129():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Online_Refund_EMVCTLS_DEBIT_RUPAY
        Sub Feature Description: API that performs EMVCTLS online refund txn using DEBIT RUPAY card via FDC
        TC naming code description:
        100: Payment Method
        104: CARD
        129: TC129
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_130():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Online_Refund_EMVCTLS_CREDIT_VISA
        Sub Feature Description: API that performs EMVCTLS online refund txn using CREDIT VISA card via FDC
        TC naming code description:
        100: Payment Method
        104: CARD
        130: TC0130
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_131():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Online_Refund_EMVCTLS_CREDIT_MASTER
        Sub Feature Description: API that performs EMVCTLS online refund txn using CREDIT MASTER card via FDC
        TC naming code description:
        100: Payment Method
        104: CARD
        131: TC131
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_132():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Online_Refund_EMVCTLS_CREDIT_RUPAY
        Sub Feature Description: API that performs EMVCTLS online refund txn using CREDIT RUPAY card via FDC
        TC naming code description:
        100: Payment Method
        104: CARD
        132: TC132
