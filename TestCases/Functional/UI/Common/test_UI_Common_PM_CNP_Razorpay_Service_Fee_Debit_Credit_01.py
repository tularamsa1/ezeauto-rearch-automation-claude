...
@pytest.mark.apiVal
def test_common_100_103_509():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Both_Enabled_JSON_Debit_With_FIXED_PERCENT_Scheme_Credit_Card_Details
    Sub Feature Description: Verify Error Message when debit credit both enabled  and JSON is debit with FIXED_PERCENT scheme with Credit Card details
    TC naming code description: 100: Payment Method, 103: RemotePay, 509: TC_509
    """
    try:
        ...
        scheme = "MASTER_CARD"
        payment_by = "DEBIT"
        json_id = "service_fee_json_TC_100_103_509"
        payment_mode = "CNP"
        acc_label = ""
...
@pytest.mark.usefixtures("log_on_success", "method_setup")
@pytest.mark.apiVal
def test_common_100_103_510():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Both_Enabled_JSON_Credit_With_FIXED_PERCENT_Scheme_Debit_Card_Details
    Sub Feature Description: Verify Error Message when debit credit both enabled  and JSON is credit with FIXED_PERCENT scheme with Debit Card details
    TC naming code description: 100: Payment Method, 103: RemotePay, 509: TC_510
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        scheme = "MASTER_CARD"
        payment_by = "CREDIT"
        json_id = "service_fee_json_TC_100_103_510"
        payment_mode = "CNP"
        acc_label = ""
        derivation_type = "FIXED_PERCENT"
        bank = "NULL"
...
def test_common_100_103_511():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Both_Enabled_JSON_Debit_Credit_With_Fixed_Scheme_Debit_Card_Details
    Sub Feature Description: Verify Service Fee when debit credit both enabled  and JSON is debit and credit with FIXED
    scheme with Debit Card details.
    TC naming code description: 100: Payment Method, 103: RemotePay, 511: TC_511
    """
    ...
    try:
        ...
        scheme = "MASTER_CARD"
        payment_by = "DEBIT"
        json_id = "service_fee_json_TC_100_103_511"
        payment_mode = "CNP"
        acc_label = ""
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_512():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Both_Enabled_JSON_Debit_Credit_With_Percent_Scheme_Debit_Card_Details
    Sub Feature Description: Verify Service Fee when debit credit both enabled  and JSON is debit and credit with
    PERCENT scheme with Debit Card details.
    TC naming code description: 100: Payment Method, 103: RemotePay, 512: TC_512
    """
    expected_message = "Your payment is successfully completed! You may close the browser now."
    try:
        testcase_id = sys._getframe().f_code.co_name
        ...
        scheme = "MASTER_CARD"
        payment_by = "DEBIT"
        json_id = "service_fee_json_TC_100_103_512"
        payment_mode = "CNP"
        acc_label = ""
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_513():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Both_Enabled_JSON_Debit_Credit_With_Fixed_Percent_Scheme_Debit_Card_Details
    Sub Feature Description: Verify Service Fee when debit credit both enabled  and JSON is debit and credit with
    FIXED_PERCENT scheme with Debit Card details.
    TC naming code description: 100: Payment Method, 103: RemotePay, 513: TC_513
    """
    expected_message = "Your payment is successfully completed! You may close the browser now."
    try:
        testcase_id = sys._getframe().f_code.co_name
        ...
        scheme = "MASTER_CARD"
        payment_by = "DEBIT"
        json_id = "service_fee_json_TC_100_103_513"
        payment_mode = "CNP"
        acc_label = ""
        derivation_type = "FIXED_PERCENT"
        bank = "NULL"
