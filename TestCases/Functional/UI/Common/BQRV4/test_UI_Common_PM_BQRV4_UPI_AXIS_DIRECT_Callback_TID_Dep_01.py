...
def test_common_100_102_324():
    """
    Sub Feature Code: TID_Dep_UI_Common_PM_BQRV4_UPI_Success_using_UPI_Success_Callback_Via_AXISDIRECT
    Sub Feature Description: TID Dep - Performing a  bqrv4 upi success callback via AXIS_DIRECT
    TC naming code description: 100: Payment Method, 102: BQRV4, 324: TC324
    """
    try:
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_102_325():
    """
    Sub Feature Code: TID_Dep_UI_Common_PM_BQRV4_UPI_Failed_using_UPI_Failed_Callback_Via_AXISDIRECT
    Sub Feature Description: TID Dep - Performing a bqrv4 upi failed callback via AXIS_DIRECT
    TC naming code description: 100: Payment Method, 102: BQRV4, 325: TC325
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_102_326():
    """
    Sub Feature Code: TID_Dep_UI_Common_PM_BQRV4_UPI_success_callback_after_qr_expiry_AutoRefund_Enabled_AXIS_DIRECT
    Sub Feature Description: TID Dep - Verification of  one callback for expired QR when auto refund enabled via Axis acq and Axis PG where bqrv4 upi config is Axis_Direct
    TC naming code description: 100: Payment Method, 102: BQRV4, 326: TC326
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_102_327():
    """
    Sub Feature Code: TID_Dep_UI_Common_PM_BQRV4_UPI_failed_callback_after_qr_expiry_AutoRefund_Disabled_AXIS_DIRECT
    Sub Feature Description: TID Dep - Verification of  one callback for expired QR when auto refund enabled via Axis acq and Axis PG where bqrv4 upi config is Axis_Direct
    TC naming code description: 100: Payment Method, 102: BQRV4, 327: TC327
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_102_328():
    """
    Sub Feature Code: TID_Dep_UI_Common_PM_BQRV4_1_UPI_AXIS_DIRECT_and_1_BQR_HDFC_success_callback_after_qr_expiry_AutoRefund_Disabled
    Sub Feature Description: TID Dep - Performing a pure bqrv4 1 upi success callback via AXIS_DIRECT and 1 bqr success callback via HDFC, after qr expiry when autorefund is disabled
    TC naming code description: 100: Payment Method, 102: BQRV4, 328: TC328
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
