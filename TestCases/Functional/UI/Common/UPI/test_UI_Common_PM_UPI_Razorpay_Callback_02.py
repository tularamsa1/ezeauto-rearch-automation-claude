...
def test_common_100_101_226():
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"razorpay_signature received for razorpay_callback_generator_HMAC api for second "
                         f"callback is : {razorpay_signature_2}")
...
def test_common_100_101_230():
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"api_details for razorpay_callback_generator_HMAC for second callback : {api_details_hmac_2}")
