...
def test_common_100_102_001():
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"API Paylaod for call back is: {payload}")
            ...
            logger.debug(f"API response is :{response['STATUS_DESC']}")
    ...
    # -------------------------------------------End of Validation---------------------------------------------
        ...
        logger.info("**********Test case Execution and Validation compeleted**************")
...
def test_common_100_102_002(): #Make sure to add the test case name as same as the sub feature code.
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"Payload for performing callback using API : {payload}")
            response = APIProcessor.post(payload, "callback_hdfc")
