...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_019():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Void_EMVCTLS_DEBIT_VISA
        Sub Feature Description: API that performs EMVCTLS Void txn having DEBIT VISA card via ATOS_TLE
    ...
    try:
        ...
        try:
            ...
            api_details = DBProcessor.get_api_details('ATOS_TLE_Card_Sale_EMVCTLS_Debit_VISA',
                                                      request_body={"amount": original_amount,
                                                                    "externalRefNumber" : "UFAZMJK1ON071341J1" + str(random.randint(0,9))})
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                ...
                expectedDBValues = {"txn_amt": float(original_amount), "pmt_mode":"CARD",
                                    ...
                                    "txn_type":"CHARGE", "acq_code":"AXIS", "pmt_gateway":"ATOS_TLE",
                                    ...
                                    "mware_txn_type": "CHARGE", "mware_acq_code": "AXIS", "mware_pmt_gateway": "ATOS_TLE",
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_020():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Void_EMVCTLS_DEBIT_MASTER
        Sub Feature Description: API that performs EMVCTLS Void txn having DEBIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        020: TC020
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"Execution Timer started in testcase function : {testcase_id}")
            original_amount = random.randint(10,1000)
            api_details = DBProcessor.get_api_details('ATOS_TLE_Card_Sale_EMVCTLS_Debit_MASTER',
                                                      request_body={"amount": original_amount,
                                                                    "externalRefNumber" : "UFAZMJK1ON071341J1" + str(random.randint(0,9))})
            response = APIProcessor.send_request(api_details)
            card_payment_success = response['success']
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_021():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Void_EMVCTLS_DEBIT_RUPAY
        Sub Feature Description: API that performs EMVCTLS Void txn having DEBIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        021: TC021
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"Execution Timer started in testcase function : {testcase_id}")
            original_amount = random.randint(10,1000)
            api_details = DBProcessor.get_api_details('ATOS_TLE_Card_Sale_EMVCTLS_Debit_RUPAY',
                                                      request_body={"amount": original_amount,
                                                                    "externalRefNumber" : "UFAZMJK1ON071341J1" + str(random.randint(0,9))})
            response = APIProcessor.send_request(api_details)
            card_payment_success = response['success']
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_022():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Void_EMVCTLS_CREDIT_VISA
        Sub Feature Description: API that performs EMVCTLS Void txn having CREDIT VISA card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        022: TC022
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"Execution Timer started in testcase function : {testcase_id}")
            original_amount = random.randint(10,1000)
            api_details = DBProcessor.get_api_details('ATOS_TLE_Card_Sale_EMVCTLS_Credit_VISA',
                                                      request_body={"amount": original_amount,
                                                                    "externalRefNumber" : "UFAZMJK1ON071341J1" + str(random.randint(0,9))})
            response = APIProcessor.send_request(api_details)
            card_payment_success = response['success']
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_023():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Void_EMVCTLS_CREDIT_MASTER
        Sub Feature Description: API that performs EMVCTLS Void txn having CREDIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        023: TC023
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"Execution Timer started in testcase function : {testcase_id}")
            original_amount = random.randint(10,1000)
            api_details = DBProcessor.get_api_details('ATOS_TLE_Card_Sale_EMVCTLS_Credit_MASTER',
                                                      request_body={"amount": original_amount,
                                                                    "externalRefNumber" : "UFAZMJK1ON071341J1" + str(random.randint(0,9))})
            response = APIProcessor.send_request(api_details)
            card_payment_success = response['success']
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_024():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Void_EMVCTLS_CREDIT_RUPAY
        Sub Feature Description: API that performs EMVCTLS Void txn having CREDIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        024: TC024
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"Execution Timer started in testcase function : {testcase_id}")
            original_amount = random.randint(10,1000)
            api_details = DBProcessor.get_api_details('ATOS_TLE_Card_Sale_EMVCTLS_Credit_RUPAY',
                                                      request_body={"amount": original_amount,
                                                                    "externalRefNumber" : "UFAZMJK1ON071341J1" + str(random.randint(0,9))})
            response = APIProcessor.send_request(api_details)
            card_payment_success = response['success']
