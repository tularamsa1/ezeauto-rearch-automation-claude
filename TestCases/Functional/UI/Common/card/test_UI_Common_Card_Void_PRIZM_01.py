...
def test_common_100_115_072():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMVCTLS_VISA_DebitCard_With_Pin_476173
    Sub Feature Description: Performing the EMVCTLS Void transaction via PRIZM PG using VISA Debit card having
    16 digit PAN length with pin (bin: 476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 072: TC072
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_073():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMVCTLS_MASTER_DebitCard_With_Pin_222360
    Sub Feature Description: Performing the EMVCTLS Void transaction via PRIZM PG using MASTER Debit card having
    16 digit PAN length with pin (bin: 222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 073: TC073
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_074():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMVCTLS_RUPAY_DebitCard_With_Pin_608326
    Sub Feature Description: Performing the EMVCTLS Void transaction via PRIZM PG using RUPAY Debit card having
    16 digit PAN length with pin (bin: 608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 074: TC074
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_075():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMVCTLS_VISA_DebitCard_Without_Pin_476173
    Sub Feature Description: Performing the EMVCTLS Void transaction via PRIZM PG using VISA Debit card having
    16 digit PAN length without pin  (bin: 476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 075: TC075
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_076():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMVCTLS_MASTER_DebitCard_Without_Pin_222360
    Sub Feature Description: Performing the EMVCTLS Void transaction via PRIZM PG using MASTER Debit card having
    16 digit PAN length without pin  (bin: 222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 076: TC076
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
