...
def test_500_502_007():
    ...
    TC naming code description: 500: P2P, 502: BQR, 007: TC 006
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.dbVal
@pytest.mark.appVal
def test_500_502_008():
    """
    Sub Feature Code: UI_Common_P2P_BQR_Start_API_Transaction_Failed_08
    Sub Feature Description: Send notification for BQR, fail the payment from device and check notification is not getting removed until successful payment
    TC naming code description: 500: P2P, 502: BQR, 007: TC 008
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
