...
def test_common_100_102_066():
    ...
    :Sub Feature code: UI_Common_BQRV4_UPG_AUTOREFUND_ENABLED_YES_ATOS_66
    :TC naming code description: 100->Payment Method, 102->BQR, 066-> TC66
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                date_and_time = date_time_converter.date_and_time_val_against_app(posting_date)
                expected_app_values = {
                    "pmt_mode": "UPI",
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                actual_api_values = {
                    ...
                    "date": date_time_converter.date_and_time_val_against_api(date_api)
                }
...
def test_common_100_102_067():
    ...
    :Sub Feature code: UI_Common_BQRV4_UPG_AUTOREFUND_DISABLED_YES_ATOS_67
    :TC naming code description: 100->Payment Method, 102->BQR, 067-> TC67
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_common_100_102_068():
    """
    :Description: Verification of  a BQRV4 UPG Refund txn when Auto refund is disabled through API via YES_ATOS
    :Sub Feature code: UI_Common_BQRV4_UPG_Refund_Via_API_YES_ATOS_68
    :TC naming code description: 100->Payment Method, 102->BQR, 068-> TC68
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                logger.info(f"Fetching status from txn history for the txn : {txn_id_refunded}, {app_payment_status_refunded}")
                ...
                logger.info(f"Fetching payment mode from txn history for the txn : {txn_id_refunded}, {app_payment_mode_refunded}")
                ...
                app_payment_msg_refunded = txn_history_page.fetch_txn_payment_msg_text()
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "org_code": org_code_txn,
                    "date": date,
                    "refunded_pmt_status": "UPG_REFUNDED",
                    "refunded_txn_amt": amount, "refunded_pmt_mode": "UPI",
                    "refunded_pmt_state": "UPG_REFUNDED", "refunded_rrn": str(rrn_refunded),
                    "refunded_settle_status": "SETTLED",
                    "refunded_acquirer_code": "YES",
                    "refunded_txn_type": "REFUND", "refunded_mid": mid, "refunded_tid": tid,
                    "refunded_org_code": org_code_txn,
                    "refunded_date": refund_date
                ...
                amount_api_refunded = int(response["amount"])  # actual=345.00, expected should be in the same format
                ...
                orgCode_api_refunded = response["orgCode"]
                ...
                actual_api_values = {
                    ...
                    "org_code": orgCode_api,
                    "date": date_time_converter.from_api_to_datetime_format(date_api),
                    "refunded_pmt_status": status_api_refunded, "refunded_txn_amt": amount_api_refunded,
                    "refunded_pmt_mode": payment_mode_api_refunded,
                    "refunded_pmt_state": state_api_refunded, "refunded_rrn": str(rrn_api_refunded),
                    "refunded_settle_status": settlement_status_api_refunded,
                    "refunded_acquirer_code": acquirer_code_api_refunded,
                    "refunded_txn_type": txn_type_api_refunded, "refunded_mid": mid_api_refunded, "refunded_tid": tid_api_refunded,
                    "refunded_org_code": orgCode_api_refunded,
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    "ipr_pg_merchant_id": pgMerchantId,
                    "refunded_pmt_status": "UPG_REFUNDED",
                    "refunded_pmt_state": "UPG_REFUNDED",
                    "refunded_pmt_mode": "UPI",
                    "refunded_txn_amt": amount,
                    "refunded_upi_txn_status": "UPG_REFUNDED",
                    "refunded_settle_status": "SETTLED",
                    "refunded_acquirer_code": "YES",
                    "refunded_upi_bank_code": "YES",
                    "refunded_payment_gateway": "ATOS",
                ...
                actual_db_values = {
                    ...
                    "refunded_payment_gateway": payment_gateway_db_refunded,
                    "refunded_mid": mid_db_refunded,
                    "refunded_tid": tid_db_refunded,
