...
def test_common_100_102_146():
    """
    :Description: Verification of a BQRV4 UPI Amount mismatch upon Checkstatus Success via AXIS_ATOS
    :Sub Feature code: UI_Common_BQRV4_UPI_Checkstatus_Amount_Mismatch_AXIS_ATOS
