...
class HomePage(BasePage):
    ...
    def enter_amount_and_order_number_for_card(self, amt, order_number, device_serial):
        self.perform_click(self.txt_enterAmountField)
        list = self.type_amount(amt)
        for i in list:
            self.perform_click(i)
    ...
    def enter_tip_amount_and_order_number_for_card(self, amt, order_number, tip_amt, device_serial):
        self.perform_click(self.txt_enterAmountField)
        list = self.type_amount(amt)
        for i in list:
            self.perform_click(i)
