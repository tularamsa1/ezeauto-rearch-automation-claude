...
@pytest.mark.appVal
def test_common_100_115_05_049():
    """
    Sub Feature Code: UI_Common_Card_Normal_EMI_Txn_Without_EMI_Settings_For_An_Org_HDFC_Dummy_OneCard_EMV_VISA_CreditCard_With_Pin_417666
    Sub Feature Description: Performing the normal EMI transaction without emi settings for an org (not ezetap) via HDFC
    Dummy PG for OneCard issuer using EMV VISA Credit card with pin (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 049: TC049
    """
    try:
