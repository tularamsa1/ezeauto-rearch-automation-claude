...
def test_common_100_102_124():
    """
    :Description: Verification of a BQRV4 UPI Amount mismatch upon Checkstatus Tid Dep via HDFC
    :Sub Feature code: UI_Common_BQRV4_UPI_Checkstatus_Amount_Missmatch_Tid_Dep_HDFC
