...
@pytest.mark.apiVal
def test_common_100_103_520():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_Debit_Credit_Schemes_with_Netbanking _Details
    Sub Feature Description: Verify Error Message when debit credit netbanking enabled and JSON is debit and credit with netbanking details
    TC naming code description: 100: Payment Method, 103: RemotePay, 520: TC520
    """
    try:
        ...
        scheme = "MASTER_CARD"
        payment_by = "DEBIT"
        json_id = "service_fee_json_TC_100_103_520"
        payment_mode = "CNP"
        acc_label = ""
...
@pytest.mark.usefixtures("log_on_success", "method_setup")
@pytest.mark.apiVal
def test_common_100_103_521():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_ANY_ANY_Schemes_with_Netbanking _Details
    Sub Feature Description: Verify Error Message when debit credit netbanking enabled and JSON is Any Any with netbanking details
    TC naming code description: 100: Payment Method, 103: RemotePay, 521: TC521
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        scheme = "ANY"
        payment_by = "ANY"
        json_id = "service_fee_json_TC_100_103_521"
        payment_mode = "CNP"
        acc_label = ""
...
@pytest.mark.usefixtures("log_on_success", "method_setup")
@pytest.mark.apiVal
def test_common_100_103_522():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_Netbanking_Schemes_with_Credit_Card_Details
    Sub Feature Description: Verify Error Message when debit credit netbanking enabled and JSON is Netbanking schemes with credit card details
    TC naming code description: 100: Payment Method, 103: RemotePay, 522: TC522
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        scheme = "ANY"
        payment_by = "NB"
        json_id = "service_fee_json_TC_100_103_522"
        payment_mode = "CNP"
        acc_label = ""
        derivation_type = "FIXED"
        bank = "ANY"
...
@pytest.mark.usefixtures("log_on_success", "method_setup")
@pytest.mark.apiVal
def test_common_100_103_523():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_Netbanking_Schemes_with_Debit_Card_Details
    Sub Feature Description: Verify Error Message when debit credit netbanking enabled and JSON is Netbanking schemes with debit card details
    TC naming code description: 100: Payment Method, 103: RemotePay, 523: TC523
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        scheme = "ANY"
        payment_by = "NB"
        json_id = "service_fee_json_TC_100_103_523"
        payment_mode = "CNP"
        acc_label = ""
        derivation_type = "FIXED"
        bank = "ANY"
...
def test_common_100_103_524():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_Debit_Credit_Fixed_&Netbanking_Any_Schemes_Amt_Fixed_with_Debit_Card_Details
    Sub Feature Description: Verify Service Fee when debit credit netbanking enabled and JSON is debit and credit with
    FIXED and ANY netbanking scheme and amount in FIXED range with debit details.
    TC naming code description: 100: Payment Method, 103: RemotePay, 524: TC_524
    """
    ...
    try:
        ...
        scheme = "MASTER_CARD"
        payment_by = "DEBIT"
        json_id = "service_fee_json_TC_100_103_524"
        payment_mode = "CNP"
        acc_label = ""
        derivation_type = "FIXED"
        bank = "NULL"
