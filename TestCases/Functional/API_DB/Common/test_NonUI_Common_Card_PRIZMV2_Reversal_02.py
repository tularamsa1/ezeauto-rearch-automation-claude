...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_202():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Reversal_EMV_WITH_PIN_DEBIT_VISA
        Sub Feature Description:API that performs EMV with pin Reversal txn having DEBIT VISA card via PRIZMV2
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_188():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Reversal_EMV_WITH_PIN_DEBIT_RUPAY
        Sub Feature Description:API that performs EMV with pin Reversal txn having DEBIT RUPAY card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        188: TC188
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_216():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Reversal_EMV_WITH_PIN_CREDIT_VISA
        Sub Feature Description:API that performs EMV with pin Reversal txn having CREDIT VISA card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        216: TC216
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_230():
    """
        Sub Feature Code: NonUI_Common_PRIZMV2_Card_Reversal_EMV_WITH_PIN_CREDIT_MASTER
        Sub Feature Description:API that performs EMV with pin Reversal txn having CREDIT MASTER card via PRIZMV2
        TC naming code description:
        100: Payment Method
        104: CARD
        230: TC230
