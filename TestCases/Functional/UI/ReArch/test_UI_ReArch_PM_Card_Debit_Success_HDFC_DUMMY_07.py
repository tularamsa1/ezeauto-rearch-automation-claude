...
def test_common_rearch_0016():
    ...
    Sub Feature Description:
        ...
        screen, search the transaction by Amount (not txn_id), click it and
        verify amount and Payment Authorized status.
    ...
    try:
        ...
        # ── App Validation ────────────────────────────────────────────────────
        # Steps 8-10: Click history → search by amount → click transaction → verify
        if ConfigReader.read_config("Validations", "app_validation") == "True":
            ...
            try:
                ...
                # Step 9: Search transaction by Amount (not txn_id)
