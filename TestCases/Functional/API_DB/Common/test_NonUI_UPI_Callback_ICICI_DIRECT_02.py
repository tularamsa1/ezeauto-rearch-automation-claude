...
def test_d102_101_012():
    ...
    TC naming code description: d102: Payment Method, 101: UPI, 012: TC012
    """
    try:
...
def test_d102_101_015():
    ...
    TC naming code description: d102: Payment Method, 101: UPI, 015: TC015
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_d102_101_016():
    ...
    via ICICI_Direct pg when auto refund is disabled
    TC naming code description: d102: Payment Method, 101: UPI, 016: TC016
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_d102_101_020():
    ...
    via ICICI_Direct pg when auto refund is disabled
    TC naming code description: d102: Payment Method, 101: UPI, 020: TC020
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
