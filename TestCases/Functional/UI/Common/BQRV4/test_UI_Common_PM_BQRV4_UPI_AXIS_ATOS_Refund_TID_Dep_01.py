...
def test_common_100_102_283():
    """
    Sub Feature code: TID_Dep_UI_Common_BQRV4_UPI_Refund_via_AXIS_ATOS
    Sub Feature Description: TID Dep - Verification of a BQRV4_UPI refund using api via AXIS_ATOS
    TC naming code description:100: Payment Method, 102: BQRV4, 283: TC283
    """
    try:
        ...
        query = "select mid, tid, id from upi_merchant_config where org_code='" + org_code + "' and status = 'ACTIVE' and bank_code='AXIS'"
        result = DBProcessor.getValueFromDB(query)
        ...
        try:
            ...
            logger.debug(f"Resonse received for QR genration api is : {response}")
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                device_serial_original = response["deviceSerial"]
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_102_284():
    """
    Sub feature code: TID_Dep_UI_Common_PM_BQRV4_UPI_Refund_Failed_AXIS_ATOS
    Sub feature Description: TID Dep - Verification of a BQRV4 UPI refund failed via AXIS_ATOS
    TC naming code description:100: Payment Method, 102: BQRV4, 284: TC284
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                logger.info(f"Fetching txn payer name from txn history for the txn : {txn_id_new_2}, {app_payer_name_new_2}")
