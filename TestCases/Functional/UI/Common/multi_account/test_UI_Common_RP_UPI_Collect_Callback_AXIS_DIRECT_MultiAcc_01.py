...
def test_common_100_111_019():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_Collect_Success_Via_UPI_Collect_Callback_Axis_Direct_MultiAcc
    Sub Feature Description: MultiAccount - Verification of a Remote Pay successful pure upi txn via AXIS_DIRECT using callback
    Sub Feature Code: UI_Common_PM_UPI_Collect_success_callback_before_expiry_AutoRefund_Enabled_Axis_Direct_MultiAcc
    Sub Feature Description: MultiAccount - Performing a  UPI Collect success callback via Axis_Direct before expiry when auto refund is enabled
    ...
    try:
        ...
        try:
            ...
            if response['success'] == False:
                ...
                ui_driver.goto(payment_link_url)
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_111_020():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_Collect_Failed_callback_Via_AXIS_DIRECT_MultiAcc
    Sub Feature Description: MultiAccount -  Verification of a Remote Pay failed UPI collect txn via AXIS DIRECT using callback
    TC naming code description:
    100: Payment Method
    111: MultiAcc_RemotePay
    020: TC_020
