...
def test_mp_700_705_064():
    """
    Sub Feature Code: UI_MP_Profile_Info__as_Taluk_head
    Sub Feature Description: Verifying Profile information by logging in and log out  when logging in as Taluk Head
