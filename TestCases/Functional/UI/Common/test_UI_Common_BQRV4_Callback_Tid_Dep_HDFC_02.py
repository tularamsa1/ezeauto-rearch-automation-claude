...
def test_common_100_102_115():
    """
    Sub Feature Code: Tid dep - UI_Common_BQRV4_UPI_Success_Two_Callback_Before_QR_Expiry_Auto_Refund_Disabled_HDFC
    Sub Feature Description: Tid Dep - Performing a pure upi success two callback via tid dep HDFC when auto refund is disabled
    TC naming code description: 100: Payment Method, 102: BQR, 113: TC113
    """
    try:
        ...
        query = "update terminal_dependency_config set terminal_dependent_enabled=1 where org_code ='" + org_code + "' and acquirer_code='HDFC' and payment_gateway='HDFC'"
        ...
        try:
            ...
            rrn_new_2 = random.randint(1111110, 9999999)
            logger.debug(f"generated random rrn number is : {rrn}")
            ref_id = '211115084892E01' + str(rrn)
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                date_and_time = date_time_converter.to_app_format(modified_date)
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                date_new = date_time_converter.db_datetime(modified_date)
                date_new_2 = date_time_converter.db_datetime(modified_date_new_2)
                expected_api_values = {
                    "pmt_status": "AUTHORIZED",
                    ...
                    "pmt_state_2": "SETTLED", "rrn_2": str(rrn_new_2),
                    "settle_status_2": "SETTLED",
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                ...
                actual_db_values = {
                    ...
                    "pmt_gateway_2": payment_gateway_db_new_2,
        ...
        if (ConfigReader.read_config("Validations", "portal_validation")) == "True":
            ...
            try:
                date_and_time_portal = date_time_converter.to_portal_format(modified_date)
                date_and_time_portal_2 = date_time_converter.to_portal_format(modified_date_new_2)
        ...
        if (ConfigReader.read_config("Validations", "charge_slip_validation")) == "True":
            ...
            try:
                txn_date, txn_time = date_time_converter.to_chargeslip_format(modified_date)
                expected_charge_slip_values = {
                    'PAID BY:': 'UPI', 'merchant_ref_no': 'Ref # ' + str(order_id), 'RRN': str(rrn),
                    'BASE AMOUNT:': "Rs." + str(amount), 'date': txn_date,
                    'time': txn_time, 'AUTH CODE': auth_code
                }
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_102_116():
    """
    Sub Feature Code: Tid dep - UI_Common_BQRV4_UPI_Success_Two_Callback_Before_QR_Expiry_Auto_Refund_Enabled_HDFC
    Sub Feature Description: Tid Dep - Performing a pure upi success two callback via tid dep HDFC when auto refund is enabled
    TC naming code description: 100: Payment Method, 102: BQR, 116: TC116
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "pmt_status_2": "REFUND_PENDING",
                    "txn_amt_2": float(amount), "pmt_mode_2": "UPI",
                    "pmt_state_2": "REFUND_PENDING", "rrn_2": str(rrn_new_2),
                    "settle_status_2": "SETTLED",
                    "acquirer_code_2": "HDFC",
                    "issuer_code_2": "HDFC",
                    "txn_type_2": "CHARGE", "mid_2": mid, "tid_2": tid,
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_102_117():
    """
    Sub Feature Code: Tid Dep - UI_Common_BQRV4_UPI_Two_Callback_After_QR_Expiry_Auto_Refund_Disabled_HDFC
    Sub Feature Description: Tid Dep - Performing a pure upi two callback via HDFC after expiry the qr when auto refund is disabled
    TC naming code description: 100: Payment Method, 102: BQR, 117: TC117
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        try:
            ...
            modified_date_new_3 = result['created_time'].values[0]
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                logger.info(
                    f"Fetching txn settlement_status from txn history for the txn : {txn_id_new}, {app_customer_name_new}")
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                date_new = date_time_converter.db_datetime(modified_date_new)
                date_new_3 = date_time_converter.db_datetime(modified_date_new_3)
                ...
                device_serial_api_new_3 = response["deviceSerial"]
                ...
                actual_api_values = {"pmt_status": status_api, "txn_amt": amount_api,"pmt_mode": payment_mode_api,
                                     ...
                                     "txn_type_3": txn_type_api_new_3, "mid_3": mid_api_new_3, "tid_3": tid_api_new_3,
        ...
        if (ConfigReader.read_config("Validations", "portal_validation")) == "True":
            ...
            try:
                ...
                date_and_time_portal_2 = date_time_converter.to_portal_format(modified_date_new)
                date_and_time_portal_3 = date_time_converter.to_portal_format(modified_date_new_3)
                expected_portal_values = {
                    "date_time": date_and_time_portal,
                    "pmt_state": "EXPIRED",
                    "pmt_type": "BHARATQR",
...
def test_common_100_102_118():
    ...
    Sub Feature Description: Tid Dep - Performing a pure upi two callback via HDFC after expiry the qr when auto refund is enabled
    TC naming code description: 100: Payment Method, 102: BQR, 118: TC118
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {"pmt_status": "EXPIRED","txn_amt": float(amount),"pmt_mode": "BHARATQR",
                                       ...
                                       "pmt_status_3": "REFUND_PENDING",
                                       "txn_amt_3": float(amount), "pmt_mode_3": "UPI",
                                       "pmt_state_3": "REFUND_PENDING", "rrn_3": str(rrn_new_2),
                                       "settle_status_3": "SETTLED",
                                       "acquirer_code_3": "HDFC",
                                       "issuer_code_3": "HDFC",
                                       "txn_type_3": "CHARGE", "mid_3": mid, "tid_3": tid,
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_102_125():
    """
    Sub Feature Code: Tid dep -  UI_Common_BQRV4_UPI_Amount_Mismatch_Via_Pure_UPI_Success_Callback_HDFC
    Sub Feature Description: Tid dep - Performing a amount mismatch using pure upi success callback via  HDFC
    TC naming code description: 100: Payment Method, 102:BQR, 125: TC125
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        try:
            ...
            amount = amount + 1
            logger.debug(f"changing the amount to perform the mismatch scenario")
            logger.debug(
                f"replacing the Txn_id with {txn_id}, amount with {amount}.00, vpa with {vpa} and rrn with {rrn} "
                f"in the curl_data")
            logger.info("performing pure upi success callback for HDFC PG to perform amount_mismatch/upg_authorized")
            ...
            for line in iter(lambda: ssh_stdout.readline(), ''):
                data_buffer += line
            logger.debug(f"encrypted data output is : {data_buffer}")
            logger.debug(f"preparing the request payload data to trigger the "
                         f"/api/2.0/upimerchant/hdfc/callBackUpiMerchantRes")
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                app_rrn = txn_history_page.fetch_RRN_text()
                logger.info(
                    f"Fetching txn_id from txn history for the txn : {ipr_txn_id}, {app_rrn}")  # behavior is diff on
                # both emulator and device (Number/NUMBER)
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    "rrn": str(rrn),
                    # "device_serial": str(device_serial),
                    "ipr_error_message": "Input parameter invalid: "+str(txn_id)
                }
