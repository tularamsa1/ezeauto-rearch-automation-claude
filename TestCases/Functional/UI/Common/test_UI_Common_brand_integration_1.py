...
def test_common_100_115_05_0006():
    """
    Sub Feature Code:
    Sub Feature Description: verify brand emi flow for any one of the tenure-- cash back type none
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_05_0007():
    """
    Sub Feature Code:
    Sub Feature Description: Verify min and max emi eligibility : EZETAP- CREDIT CARD
    TC naming code description:
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_05_0008():
    """
    Sub Feature Code:
    Sub Feature Description: Verify min and max emi eligibility - MERCHANT LEVEL
    TC naming code description:
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_05_0009():
    """
    Sub Feature Code:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_05_00010():
    """
    Sub Feature Code:
    Sub Feature Description: Verify the error message for invalid product
    TC naming code description:
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
