...
def test_common_100_110_019():
    """
    :Description: Multi Account - Verification of a successful bqrv4 upi txn via YES ATOS using callback
    :Sub Feature code: UI_Common_BQRV4_UPI_Success_Callback_MultiAcc_YES_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 UPI, 019-> TC019
    """
    try:
...
def test_common_100_110_020():
    """
    :Description: Multi Account - Verification of a failed bqrv4 upi txn via YES ATOS using callback
    :Sub Feature code: UI_Common_BQRV4_UPI_Failed_Callback_MultiAcc_YES_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 UPI, 020-> TC020
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
