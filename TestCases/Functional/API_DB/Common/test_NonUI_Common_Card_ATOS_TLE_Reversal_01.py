...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_025():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Reversal_EMV_DEBIT_VISA
        Sub Feature Description:API that performs EMV Reversal txn having DEBIT VISA card via ATOS_TLE
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_026():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Reversal_EMV_DEBIT_MASTER
        Sub Feature Description:API that performs EMV Reversal txn having DEBIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        026: TC026
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_027():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Reversal_EMV_DEBIT_RUPAY
        Sub Feature Description:API that performs EMV Reversal txn having DEBIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        027: TC027
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_028():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Reversal_EMV_CREDIT_VISA
        Sub Feature Description:API that performs EMV Reversal txn having CREDIT VISA card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        028: TC028
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_029():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Reversal_EMV_CREDIT_MASTER
        Sub Feature Description:API that performs EMV Reversal txn having CREDIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        029: TC029
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_030():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Reversal_EMV_CREDIT_RUPAY
        Sub Feature Description:API that performs EMV Reversal txn having CREDIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        030: TC030
