...
def test_common_100_115_081():
    """
    Sub Feature Code: UI_Common_Card_Void_ATOS_TLE_EMVCTLS_VISA_DebitCard_Without_Pin_476173
    Sub Feature Description:  Performing the EMVCTLS Void transaction via ATOS TLE PG using VISA Debit card having 16 digit
     PAN length without pin (bin: 476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 081: TC081
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_082():
    """
    Sub Feature Code: UI_Common_Card_Void_ATOS_TLE_EMVCTLS_MASTER_DebitCard_Without_Pin_222360
    Sub Feature Description:  Performing the EMVCTLS Void transaction via ATOS TLE PG using MASTER Debit card having 16 digit
     PAN length without pin (bin: 222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 082: TC082
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_083():
    """
    Sub Feature Code: UI_Common_Card_Void_ATOS_TLE_EMVCTLS_RUPAY_DebitCard_Without_Pin_608326
    Sub Feature Description:  Performing the EMVCTLS Void transaction via ATOS TLE PG using RUPAY Debit card having 16 digit
     PAN length without pin (bin: 608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 083: TC083
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_084():
    """
    Sub Feature Code: UI_Common_Card_Void_ATOS_TLE_EMVCTLS_VISA_DebitCard_With_Pin_476173
    Sub Feature Description:  Performing the EMVCTLS Void transaction via ATOS TLE PG using VISA Debit card having 16 digit
     PAN length with pin (bin: 476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 084: TC084
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_085():
    """
    Sub Feature Code: UI_Common_Card_Void_ATOS_TLE_EMVCTLS_MASTER_DebitCard_With_Pin_222360
    Sub Feature Description:  Performing the EMVCTLS Void transaction via ATOS TLE PG using MASTER Debit card having 16 digit
     PAN length with pin (bin: 222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 085: TC085
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
