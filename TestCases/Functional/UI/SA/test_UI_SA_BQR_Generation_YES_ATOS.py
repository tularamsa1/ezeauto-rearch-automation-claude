...
def test_sa_100_102_028():
    ...
    :Subfeature code: UI_SA_PM_BQR_YES_ATOS_QR_Generation_Success_028
...
def test_sa_100_102_029():
    ...
    :Subfeature code: UI_SA_PM_BQR_YES_ATOS_QR_Generation_Failed_029
    :TC naming code description: 100->Payment Method
                                102->BQR
                                029-> TC29
    """
    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            try:
                # --------------------------------------------------------------------------------------------
                expectedAppValues = {"Payment Screen text": "Payment Failed"}
