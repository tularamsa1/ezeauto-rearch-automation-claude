...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_140():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_Failed_MSR_DEBIT_VISA
        Sub Feature Description: API that performs IS Success and inquiry Failed for instant settlement txn using MSR DEBIT VISA card via IDFC_FDC
    ...
    try:
        ...
        try:
            ...
            response_refresh = APIProcessor.send_request(api_details)
            logger.info(f"response of DB refresh: {response_refresh}")
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_141():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_Failed_MSR_DEBIT_MASTER
        Sub Feature Description: AAPI that performs IS Success and inquiry Failed for instant settlement txn using MSR DEBIT MASTER card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        141: TC141
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_142():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_Failed_MSR_DEBIT_RUPAY
        Sub Feature Description: API that performs IS Success and inquiry Failed for instant settlement txn using MSR DEBIT RUPAY card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        142: TC142
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_143():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_Failed_MSR_CREDIT_VISA
        Sub Feature Description: API that performs IS Success and inquiry Failed for instant settlement txn using MSR CREDIT VISA card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        143: TC143
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_144():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_Failed_MSR_CREDIT_MASTER
        Sub Feature Description: API that performs IS Success and inquiry Failed for instant settlement txn using MSR CREDIT MASTER card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        144: TC144
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_145():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_Failed_MSR_CREDIT_RUPAY
        Sub Feature Description: API that performs IS Success and inquiry Failed for instant settlement txn using MSR CREDIT RUPAY card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        145: TC145
