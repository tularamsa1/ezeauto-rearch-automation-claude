...
def test_common_100_115_05_077():
    """
    Sub Feature Code: UI_Common_Card_Normal_EMI_BO_Instant_Discount_Txn_For_An_Org_HDFC_Dummy_Federal_EMV_VISA_CreditCard_With_Pin_417666_For_3_Months_Tenure
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 077: TC077
    """
    try:
        ...
        query = f"select * from rule where org_code='{org_code}' and credit_type='INSTANT' and name like 'NA_FEDERAL_CREDIT%' and status='ACTIVE'"
        ...
        try:
            ...
            # credit_type: INSTANT , org_code: TANUAPPSEP12 , txn_amount: 3233.0000 (amount - 100) , payment_mode: CARD , bo_txn_type: NORMAL_EMI
            # ------------------------------------------------------------------------------------------------
