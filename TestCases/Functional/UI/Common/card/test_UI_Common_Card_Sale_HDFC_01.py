...
def test_common_100_115_001():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_CTLS_VISA_DEBIT_476173
    Sub Feature Description:  Performing the EMV sale transaction via HDFC PG using CTLS VISA Debit card having 16 digit
     PAN length with pin (bin: 476173)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 001: TC001
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_002():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_CTLS_WITH_PIN_VISA_DEBIT_476173
    Sub Feature Description:  Performing the EMV sale transaction via HDFC PG using CTLS With Pin VISA Debit card
    having 16 digit PAN length with pin (bin: 476173)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 002: TC002
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                app_rrn = txn_history_page.fetch_RRN_text()
                # txn_history_page.scroll_to_given_input_text("Auth Code")
                app_auth_code = txn_history_page.fetch_auth_code_text()
                app_batch_no = txn_history_page.fetch_batch_number_text()
                app_customer_name = txn_history_page.fetch_customer_name_text()
                app_mid = txn_history_page.fetch_mid_text()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_003():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_CTLS_MASTER_DEBIT_222360
    Sub Feature Description:  Performing the EMV sale transaction via HDFC PG using CTLS MASTER Debit card
    having 16 digit PAN length with pin (bin: 222360)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 003: TC003
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_004():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_CTLS_WITH_PIN_MASTER_DEBIT_222360
    Sub Feature Description:  Performing the EMV sale transaction via HDFC PG using CTLS With Pin MASTER Debit card
    having 16 digit PAN length with pin (bin: 222360)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 004: TC004
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_005():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_CTLS_RUPAY_DEBIT_608326
    Sub Feature Description:  Performing the EMV sale transaction via HDFC PG using CTLS RUPAY Debit card
    having 16 digit PAN length with pin (bin: 608326)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 005: TC005
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        try:
            ...
            card_page.select_cardtype("CTLS_RUPAY_DEBIT_608326")
            # sleep(2)
            payment_page.click_on_proceed_homepage()
