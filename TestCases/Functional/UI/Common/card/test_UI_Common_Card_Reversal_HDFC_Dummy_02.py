...
@pytest.mark.appVal
def test_common_100_115_113():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMVCTLS_RUPAY_DebitCard_Without_Pin_608326
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 113: TC113
    """
    try:
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_114():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMVCTLS_MASTER_CreditCard_With_Pin_541333
    Sub Feature Description:  Performing the EMVCTLS Reversal transaction via HDFC Dummy PG using MASTER Credit card
    having 16 digit PAN length with pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 114: TC114
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_115():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMVCTLS_VISA_CreditCard_Without_Pin_417666
    Sub Feature Description:  Performing the EMVCTLS Reversal transaction via HDFC Dummy PG using VISA Credit card having
    16 digit PAN length without pin (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 115: TC115
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_116():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMVCTLS_MASTER_CreditCard_Without_Pin_541333
    Sub Feature Description: Performing the EMVCTLS Reversal transaction via HDFC Dummy PG using MASTER Credit card
    having 16 digit PAN length without pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 116: TC116
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_173():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMV_MASTER_CreditCard_Without_Pin_541333
    Sub Feature Description: Performing the EMV Reversal transaction via HDFC Dummy PG using MASTER Credit card having
    16 digit PAN length without pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 173: TC173
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
