...
def test_common_100_111_023():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_Refund_By_API_AxisDirect_MultiAcc
    Sub Feature Description: MultiAccount - Verification of a Remote Pay refund using api for AxisDirect
    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "portal_validation")) == "True":
            ...
            refunded_date_time = date_time_converter.to_portal_format(posting_date)
            original_date_time = date_time_converter.to_portal_format(created_time_original)
            ...
            try:
                expected_portal_values = {
                    ...
                    "date_time_1": refunded_date_time,
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_111_024():
    """
    Sub Feature Code: UI_Common_PM_RP_Pure_upi_PartialRefund_MultiAcc
    Sub Feature Description: MultiAccount - Verification of a Remote Pay upi partial refund via AxisDirect
    TC naming code description:
    100: Payment Method
    111: MultiAcc_RemotePay
    024: TC024
