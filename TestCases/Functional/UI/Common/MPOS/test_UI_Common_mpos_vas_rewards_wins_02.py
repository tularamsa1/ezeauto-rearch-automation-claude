...
@pytest.mark.appVal
def test_mpos_600_602_020():
    """
    Sub Feature Code: UI_mpos_vas_Rewards_Claims_Cashback
    Sub Feature Description:Verify user is able to claim the cashback from the WINS tab after a goal is completed
    TC naming code description:600:  value_added_services,602: rewards,020: TC020
    """
    try:
