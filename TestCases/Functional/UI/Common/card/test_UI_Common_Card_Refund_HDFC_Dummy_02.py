...
def test_common_100_115_059():
    """
    Sub Feature Code: UI_Common_Card_Refund_HDFC_Dummy_EMVCTLS_RUPAY_DebitCard_Without_Pin_608326
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 059: TC059
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_060():
    """
    Sub Feature Code: UI_Common_Card_Refund_HDFC_Dummy_EMVCTLS_MASTER_CreditCard_With_Pin_541333
    Sub Feature Description:Performing the EMVCTLS Refund transaction via HDFC Dummy PG using MASTER Credit card having
    16 digit PAN length with pin  (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 060: TC060
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_061():
    """
    Sub Feature Code: UI_Common_Card_Refund_HDFC_Dummy_EMVCTLS_VISA_CreditCard_Without_Pin_417666
    Sub Feature Description: ming the EMVCTLS Refund transaction via HDFC Dummy PG using VISA Credit card having
    16 digit PAN length without pin (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 061: TC061
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_062():
    """
    Sub Feature Code: UI_Common_Card_Refund_HDFC_Dummy_EMVCTLS_MASTER_CreditCard_Without_Pin_541333
    Sub Feature Description: Performing the EMVCTLS Refund transaction via HDFC Dummy PG using MASTER Credit card having
    16 digit PAN length without pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 062: TC062
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
