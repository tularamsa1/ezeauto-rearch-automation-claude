...
def test_mp_700_707_051():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_VISACardBrand_as_HUB_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter VISACardBrand when logging in as HUB Head
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_card_brand='" + card_brand_search_value + "' and username NOT IN ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + district_username + "', '" + taluk_username + "', '" + city_username + "') order by created_time asc limit 1;"
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_707_052():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_MASTERCardBrand_as_HUB_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter MASTER CardBrand when logging in as HUB Head
    TC naming code description:
    700: Merchant Portal
    707: HUB
    052: TC052
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_707_053():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_RUPAYCardBrand_as_HUB_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter RUPAY CardBrand when logging in as HUB Head
    TC naming code description:
    700: Merchant Portal
    707: HUB
    053: TC053
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_707_054():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_ALL_CardBrand_as_HUB_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for ALL CardBrand  when logging in as HUB Head
    TC naming code description:
    700: Merchant Portal
    707: HUB
    054: TC054
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_mode = 'CARD' and username NOT IN ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + district_username + "', '" + taluk_username + "', '" + city_username + "')  order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_txn_id_last = result['id'].values[0]
            logger.debug(f"txn_id from db : {db_txn_id_last}")
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_707_055():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_Cash_as_HUB_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode Cash when logging in as HUB Head
    TC naming code description:
    700: Merchant Portal
    707: HUB
    055: TC055
