...
@pytest.mark.appVal
def test_common_100_103_091():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_UPG_AUTHORIZED_via_AXIS_DIRECT_when_UPGRefund_&_UPGAutoRefund_Disabled
    Sub Feature Description: Verification of a upg txn using upi success callback when upg refund and upg autorefund disabled
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_092():
    """
    Sub Feature Code: UI_Common_PM_UPI_UPG_FAILED_via_AXIS_DIRECT_when_UPGRefund_&_UPGAutoRefund_Disabled
    Sub Feature Description: Verification of a upg txn using upi failed callback when upg refund and upg autorefund are disabled
    TC naming code description:
    100: Payment Method
    103: RemotePay
    092: TC092
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_093():
    """
    Sub Feature Code: UI_Common_PM_UPI_UPG_REFUND_PENDING_via_AXIS_DIRECT_when_UPGRefund_&_UPGAutoRefund_Enabled
    Sub Feature Description: Verification of a upg txn using upi success callback when upg refund and upg autorefund is enabled and refund the same txn using api
    TC naming code description:
    100: Payment Method
    103: RemotePay
    093: TC093
...
def test_common_100_103_095():
    """
    Sub Feature Code: UI_Common_PM_UPI_amount_mismatch_Via_Pure_UPI_Success_Callback_AXISDIRECT
    Sub Feature Description: Verification of a Remote Pay upi callback for amount mismatch UPGRefund_&_UPGAutoRefund_Enabled
    TC naming code description:
    100: Payment Method
    103: RemotePay
    095: TC095
