...
def test_common_100_110_041():
    """
    :Description: Multi Account - Verification of a successful bqrv4 bqr txn via YES ATOS using callback
    :Sub Feature code: UI_Common_BQRV4_BQR_Success_Callback_MultiAcc_YES_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 BQR, 041-> TC041
    """
    try:
...
def test_common_100_110_014():
    ...
    :Sub Feature code: UI_Common_BQRV4_BQR_Failed_Callback_MultiAcc_YES_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 BQR, 014-> TC014
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
