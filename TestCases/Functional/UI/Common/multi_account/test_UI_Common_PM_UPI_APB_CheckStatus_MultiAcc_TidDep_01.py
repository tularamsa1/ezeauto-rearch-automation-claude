...
def test_common_100_109_017():
    """
    Sub Feature Code: Tid Dep - UI_Common_PM_UPI_Success_Via_CheckStatus_API_MultiAcc_APB
    Sub Feature Description: Multi Account Tid Dep - Verification of a successful UPI txn via APB using check status API
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 017: TC017
    """
    try:
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_109_018():
    """
    Sub Feature Code: Tid Dep - UI_Common_PM_UPI_Failed_Via_CheckStatus_API_MultiAcc_APB
    Sub Feature Description: Multi Account Tid Dep - Verification of a failed UPI txn via APB using check status API
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 018: TC018
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_109_023():
    """
    Sub Feature Code: Tid Dep - UI_SA_PM_UPI_Success_Via_SA_CheckStatus_with_2nd_label_MultiAcc_APB
    Sub Feature Description: Multi Account Tid Dep - Performing a successful upi txn via APB using SA check status with second account(ex:acc2 label)
