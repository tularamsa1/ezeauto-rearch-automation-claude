...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_007():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMVCTLS_DEBIT_VISA
        Sub Feature Description: API that performs EMVCTLS Sale txn using DEBIT VISA card via ATOS_TLE
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_008():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMVCTLS_DEBIT_MASTER
        Sub Feature Description: API that performs EMVCTLS Sale txn using DEBIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        008: TC008
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_009():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMVCTLS_DEBIT_RUPAY
        Sub Feature Description: API that performs EMVCTLS Sale txn using DEBIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        009: TC009
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_010():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMVCTLS_CREDIT_VISA
        Sub Feature Description: API that performs EMVCTLS Sale txn using CREDIT VISA card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        010: TC010
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_011():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMVCTLS_CREDIT_MASTER
        Sub Feature Description: API that performs EMVCTLS Sale txn using CREDIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        011: TC011
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_012():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMVCTLS_CREDIT_RUPAY
        Sub Feature Description: API that performs EMVCTLS Sale txn using CREDIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        012: TC012
