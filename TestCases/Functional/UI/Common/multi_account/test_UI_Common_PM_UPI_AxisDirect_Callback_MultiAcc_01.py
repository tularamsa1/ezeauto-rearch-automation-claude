...
def test_common_100_109_027():
    """
    Sub Feature Code: UI_Common_PM_UPI_Success_Via_Pure_UPI_Success_Callback_MultiAcc_AxisDirect
    Sub Feature Description: Multi Account - Performing a UPI Authorized Txn using pure UPI Success callback for AxisDirect
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 027: TC027
    """
    try:
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_109_028():
    """
    Sub Feature Code: UI_Common_PM_UPI_Failed_Via_Pure_UPI_Failed_Callback_MultiAcc_AxisDirect
    Sub Feature Description: Multi Account - Performing a UPI Failed Txn using pure UPI Failed callback for AxisDirect
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 028: TC028
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
