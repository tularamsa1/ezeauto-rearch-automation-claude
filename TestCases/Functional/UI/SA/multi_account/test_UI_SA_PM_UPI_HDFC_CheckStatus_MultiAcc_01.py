...
def test_sa_100_109_001():
    """
    Sub Feature Code: UI_SA_PM_UPI_Success_Via_SA_CheckStatus_MultiAcc_HDFC
    Sub Feature Description: Multi Account - Verification of a successful upi txn via HDFC using SA check status
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 001: TC001
    """
    try:
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_sa_100_109_002():
    """
    Sub Feature Code: UI_SA_PM_UPI_Failed_Via_SA_CheckStatus_MultiAcc_HDFC
    Sub Feature Description: Multi Account - Verification of a failed upi txn via HDFC using SA check status
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 002: TC002
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_sa_100_109_007():
    """
    Sub Feature Code: UI_SA_PM_UPI_Success_Via_SA_CheckStatus_with_2nd_label_MultiAcc_HDFC
    Sub Feature Description: Multi Account - Performing a successful upi txn via HDFC using SA check status with second account(ex:acc2 label)
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 007: TC007
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
