...
def test_common_100_102_056():
    """
    Sub Feature Code: UI_Common_BQRV4_2_Pure_UPI_success_callback_AutoRefund_Disabled_HDFC
    Sub Feature Description: Performing two pure upi success callback using BQRV4 QR via HDFC before expiry the qr when autorefund is disabled
    100: Payment Method
    101: UPI
    057: TC057
    """
...
def test_common_100_102_057():
    """
    Sub Feature Code: UI_Common_BQRV4_2_Pure_UPI_success_callback_AutoRefund_Enabled_HDFC
    Sub Feature Description: Performing two pure upi success callback using BQRV4 QR via HDFC before expiry the qr when autorefund is enabled
    100: Payment Method
    101: UPI
    058: TC058
    """
