...
def test_common_100_102_355():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_QR_Generation_Success_HDFC_MINTOAK
    Sub Feature Description: Verification of a BQRV4 QR Generation Success through SA via HDFC_MINTOAK
    TC naming code description: 100: Payment Method, 102: BQR, 355: TC355
    """
    try:
        ...
        query = f"select org_code from org_employee where username='{username}';"
        ...
        if (ConfigReader.read_config("Validations", "portal_validation")) == "True":
            ...
            try:
                ...
                print("auth_code_portal",auth_code_portal)
                rr_number = transaction_details[0]['RR Number']
                print("rr_number", rr_number)
