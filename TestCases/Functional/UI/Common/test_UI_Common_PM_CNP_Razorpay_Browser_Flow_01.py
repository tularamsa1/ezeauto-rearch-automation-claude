...
def test_common_100_103_457():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Browser_Flow_Success_Credit_Card_Txn
    Sub Feature Description: Verify that user is able to do a successful CNP txn with Browser Flow using CC.
    TC naming code description: 100: Payment Method, 103: RemotePay, 457: TC_457
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_458():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Browser_Flow_Success_Debit_Card_Txn
    Sub Feature Description: Verify that user is able to do a successful CNP txn with Browser Flow using DC.
    TC naming code description: 100: Payment Method, 103: RemotePay, 458: TC_458
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_459():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Browser_Flow_Success_Netbanking_Txn
    Sub Feature Description: Verify that user is able to do a successful CNP txn with Browser Flow using NB.
    TC naming code description: 100: Payment Method, 103: RemotePay, 459: TC_459
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_460():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Browser_Flow_Failure_Credit_Card_Txn
    Sub Feature Description: Verify that user is able to do a Failure CNP txn with Browser Flow using CC.
    TC naming code description: 100: Payment Method, 716: RemotePay, 460: TC_460
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_461():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Browser_Flow_Failure_Debit_Card_Txn
    Sub Feature Description: Verify that user is able to do a Failure CNP txn with Browser Flow using DC.
    TC naming code description: 100: Payment Method, 103: RemotePay, 461: TC_461
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
