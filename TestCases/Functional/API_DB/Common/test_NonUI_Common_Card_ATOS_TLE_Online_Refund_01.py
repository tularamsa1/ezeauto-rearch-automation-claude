...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_133():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMV_DEBIT_VISA
        Sub Feature Description:API that performs EMV Online Refund txn having DEBIT VISA card via ATOS_TLE
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_134():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMV_DEBIT_MASTER
        Sub Feature Description:API that performs EMV Online Refund txn having DEBIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        134: TC134
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_135():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMV_DEBIT_RUPAY
        Sub Feature Description:API that performs EMV Online Refund txn having DEBIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        135: TC135
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_136():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMV_CREDIT_VISA
        Sub Feature Description:API that performs EMV Online Refund txn having CREDIT VISA card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        136: TC136
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_137():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMV_CREDIT_MASTER
        Sub Feature Description:API that performs EMV Online Refund txn having CREDIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        137: TC137
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_138():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMV_CREDIT_RUPAY
        Sub Feature Description:API that performs EMV Online Refund txn having CREDIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        138: TC138
