...
@pytest.mark.appVal
def test_common_100_101_215():
    """
    Sub Feature Code: UI_Common_PM_UPI_Failed_Via_SA_CheckStatus_Razorpay
    Sub Feature Description: Verification of a failed UPI txn via Razorpay using SA check status
    TC naming code description: 100: Payment Method, 101: UPI, 215: TC215
    """
    try:
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_101_219():
    """
    Sub Feature Code: UI_Common_PM_UPI_SA_CheckStatus_After_Expiry_Razorpay
    Sub Feature Description: Verification of a upi txn after expiry for Razorpay using SA check status
    TC naming code description: 100: Payment Method, 101: UPI, 219: TC219
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_101_235():
    """
    Sub Feature Code: UI_Common_PM_UPI_Pure_UPI_Pending_Via_Razorpay
    Sub Feature Description: Verification of check status for upi pending txn via Razorpay
    TC naming code description: 100: Payment Method, 101: UPI, 235: TC235
    """
