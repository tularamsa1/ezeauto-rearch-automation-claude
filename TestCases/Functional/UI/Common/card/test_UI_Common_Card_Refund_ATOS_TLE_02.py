...
def test_common_100_115_095():
    """
    Sub Feature Code: UI_Common_Card_Refund_ATOS_TLE_EMVCTLS_RUPAY_DebitCard_With_Pin_608326
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 095: TC095
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_096():
    """
    Sub Feature Code: UI_Common_Card_Refund_ATOS_TLE_EMVCTLS_VISA_CreditCard_Without_Pin_417666
    Sub Feature Description: Performing the EMVCTLS Refund transaction via ATOS TLE PG using VISA Credit card having
     16 digit PAN length without pin (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 096: TC096
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_097():
    """
    Sub Feature Code: UI_Common_Card_Refund_ATOS_TLE_EMVCTLS_MASTER_CreditCard_Without_Pin_541333
    Sub Feature Description: Performing the EMVCTLS Refund transaction via ATOS TLE PG using MASTER Credit card having
     16 digit PAN length without pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 097: TC097
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_098():
    """
    Sub Feature Code: UI_Common_Card_Refund_ATOS_TLE_EMVCTLS_MASTER_CreditCard_With_Pin_541333
    Sub Feature Description: Performing the EMVCTLS Refund transaction via ATOS TLE PG using MASTER Credit card having
     16 digit PAN length with pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 098: TC098
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_220():
    """
    Sub Feature Code: UI_Common_Card_Refund_ATOS_TLE_EMV_VISA_DebitCard_Without_Pin_476173
    Sub Feature Description:  Performing the EMV Refund transaction via ATOS_TLE PG using Visa Debit card having
     16 digit PAN length without pin (bin: 476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 220: TC220
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
