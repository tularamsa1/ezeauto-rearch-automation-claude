...
def test_common_100_115_05_090():
    """
    Sub Feature Code: UI_Common_Card_Normal_EMI_Block_Success_Txn_For_An_Org_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenure
    Sub Feature Description: Performing the normal EMI Block success transaction for an org (not ezetap) via HDFC Dummy
    PG using EMV VISA Debit card with pin for 3 months tenure (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 090: TC090
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_05_091():
    """
    Sub Feature Code: UI_Common_Card_Normal_EMI_Unblock_Failed_Txn_For_An_Org_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenure
    Sub Feature Description: Performing the normal EMI unblock failed transaction for an org (not ezetap) via HDFC Dummy PG
    using EMV VISA Debit card with pin for 3 months tenure (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 091: TC091
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_05_092():
    """
    Sub Feature Code: UI_Common_Card_Normal_EMI_Unblock_Success_Txn_For_An_Org_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenure
    Sub Feature Description: Performing the normal EMI unblock success transaction for an org (not ezetap) via HDFC Dummy PG
    using EMV VISA Debit card with pin for 3 months tenure (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 092: TC092
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_05_093():
    """
    Sub Feature Code: UI_Common_Card_Normal_EMI_Block_Failed_Txn_For_An_Org_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenure
    Sub Feature Description: Performing the normal EMI Block failed transaction for an org (not ezetap) via HDFC Dummy
    PG using EMV VISA Debit card with pin for 3 months tenure (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 093: TC093
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.usefixtures("log_on_success", "method_setup")
@pytest.mark.dbVal
def test_common_100_115_05_094():
    """
    Sub Feature Code: UI_Common_Card_Normal_EMI_Check_Eligibility_For_An_Org_HDFC_Dummy_AU_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenure
    Sub Feature Description: Performing the normal EMI check eligibility success transaction for an org (not ezetap)
    via HDFC Dummy PG using EMV VISA Debit card with pin for 3 months tenure (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 094: TC094
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
