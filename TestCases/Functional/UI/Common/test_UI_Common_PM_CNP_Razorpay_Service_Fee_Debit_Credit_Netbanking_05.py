...
from Utilities import DBProcessor, APIProcessor, ResourceAssigner, ConfigReader, date_time_converter, Validator
...
def test_common_100_103_540():
    """
    Sub Feature Code:UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_Debit_Credit_Fixed_Percent_&Netbanking_YES_Schemes_Amt_Fixed_Percent_with_Netbanking_Details
    Sub Feature Description:Verify Service Fee when debit credit netbanking enabled and JSON is debit and credit with FIXED_PERCENT and YES netbanking scheme and amount in FIXED PERCENT range with netbanking details
    TC naming code description: 100: Payment Method, 103: RemotePay, 540: TC_540
    """
    ...
    try:
        ...
        scheme = "ANY"
        payment_by = "NB"
        json_id = "service_fee_json_TC_100_103_540"
        payment_mode = "CNP"
        acc_label = ""
...
@pytest.mark.usefixtures("log_on_success", "method_setup")
@pytest.mark.apiVal
def test_common_100_103_544():
    """
    Sub Feature Code: UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_Debit_Credit_Fixed_&Netbanking_Schemes_with_Netbanking_Bank_Details_Any_Bank_Not_In_JSON
    Sub Feature Description: Verify Error Message when debit credit netbanking enabled and JSON is debit and credit with
    PERCENT and netbanking scheme and amount in PERCENT range with netbanking details of any bank not in JSON.
    TC naming code description: 100: Payment Method, 103: RemotePay, 544: TC_544
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        scheme = "ANY"
        payment_by = "NB"
        json_id = "service_fee_json_TC_100_103_544"
        payment_mode = "CNP"
        acc_label = ""
