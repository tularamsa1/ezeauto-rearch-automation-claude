...
def test_mp_700_701_046():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_rr_number_as_country_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter rr number when logging in as Country Head
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and rr_number='" + rr_number_api + "' order by created_time asc limit 1;"
            ...
            query = "select * from org_flat_hierarchy where org_code = '" + org_code + "' and username = '" + txn_username + "';"
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_701_048():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_DebitCardType_as_country_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter DebitCardType when logging in as Country Head
    TC naming code description:
    700: Merchant Portal
    701: Country
    048: TC048
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_card_type='DEBIT' order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_701_049():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_CreditCardType_as_country_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter CreditCardType when logging in as Country Head
    TC naming code description:
    700: Merchant Portal
    701: Country
    049: TC049
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_card_type='CREDIT' order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_701_050():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_ALL_CardType_as_country_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter ALL CardType when logging in as Country Head
    TC naming code description:
    700: Merchant Portal
    701: Country
    050: TC050
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_card_type in ('DEBIT','CREDIT','UNKNOWN','PREPAID','FPAYDEFAULT') order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
