...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_197():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Sale_EMV_WITH_PIN_DEBIT_VISA
        Sub Feature Description: API that performs EMV with pin Sale txn using DEBIT VISA card via HDFC
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_184():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Sale_EMV_WITH_PIN_DEBIT_RUPAY
        Sub Feature Description: API that performs EMV with pin Sale txn using DEBIT RUPAY card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        184: TC184
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_211():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Sale_EMV_WITH_PIN_CREDIT_VISA
        Sub Feature Description: API that performs EMV with pin Sale txn using CREDIT VISA card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        211: TC211
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_225():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Sale_EMV_WITH_PIN_CREDIT_MASTER
        Sub Feature Description: API that performs EMV with pin Sale txn using CREDIT MASTER card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        225: TC225
