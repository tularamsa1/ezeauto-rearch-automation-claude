...
def test_mp_700_708_023():
    """
    Sub Feature Code: UI_MP_Report_based_on_username_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Filter username when logging in as Store Head
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_708_024():
    """
    Sub Feature Code: UI_MP_Report_based_on_order_number_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Filter order number when logging in as Store Head
    TC naming code description:
    700: Merchant Portal
    708: Store
    024: TC024
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_708_025():
    """
    Sub Feature Code: UI_MP_Report_based_on_calender_dates_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Filter calender dates when logging in as Store Head
    TC naming code description:
    700: Merchant Portal
    708: Store
    025: TC025
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_708_027():
    """
    Sub Feature Code: UI_MP_Report_based_on_User_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Filter User when logging in as Store Head
    TC naming code description:
    700: Merchant Portal
    708: Store
    027: TC027
