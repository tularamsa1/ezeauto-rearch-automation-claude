...
def test_common_100_110_027():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_BQR_Success_Callback_MultiAcc_AXIS_ATOS
    Sub Feature Description: Multi Account - Verification of a successful bqrv4 bqr txn via AXIS ATOS using callback
    TC naming code description: 100: Payment Method 110: MultiAcc_BQR, 027: TC027
    """
    try:
        ...
        try:
            ...
            api_details = DBProcessor.get_api_details('callbackAXISATOS',request_body={"primary_id": pid,
                                                                    "secondary_id":sid,
...
@pytest.mark.dbVal
@pytest.mark.appVal
def test_common_100_110_028():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_BQR_Failed_Callback_MultiAcc_AXIS_ATOS
    Sub Feature Description: Multi Account - Verification of a failed bqrv4 bqr txn via AXIS ATOS using callback
    TC naming code description: 100: Payment Method 110: MultiAcc_BQR, 028: TC028
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
