...
def test_common_100_102_061():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_Checkstatus_Success_YES_ATOS
    Sub Feature Description: Verification of a BQRV4 Checkstatus Success via YES_ATOS
    TC naming code description: 100: Payment Method, 102: BQR, 061: TC061
    """
    try:
...
def test_common_100_102_070():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_CheckStatus_Expired_YES_ATOS
    Sub Feature Description: Verification of a BQRV4 Expired Check status transaction when auto refund disabled via YES_ATOS
    TC naming code description: 100: Payment Method, 102: BQR, 070: TC070
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_common_100_102_062():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_Checkstatus_Amount_Mismatch_YES_ATOS
    Sub Feature Description: Verification of a BQRV4 UPI Amount mismatch upon Checkstatus Success via YES_ATOS
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"Fetching amount_db, payment_mode_db, payment_status_db, payment_state_db, acquirer_code_db, bank_name_db,payer_name_db, mid_db, tid_db, payment_gateway_db, rr_number_db, settlement_status_db, amount_original_db from database for "
                f"current merchant:{amount_db}, {payment_mode_db}, {payment_status_db}, {payment_state_db}, {acquirer_code_db}, {bank_name_db},{payer_name_db}, {mid_db}, {tid_db}, {payment_gateway_db}, {rr_number_db}, {settlement_status_db},{amount_original_db}")
