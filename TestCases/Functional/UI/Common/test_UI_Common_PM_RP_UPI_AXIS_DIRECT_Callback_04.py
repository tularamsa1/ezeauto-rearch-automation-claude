...
@pytest.mark.appVal
def test_common_100_103_124():
    """
    Sub Feature Code: UI_Common_PM_RP_2_UPI_failed_callback_before_expiry_AXIS_DIRECT_AutoRefund_Disabled
    Sub Feature Description: Performing two UPI failed callback via Axis Direct before expiry the when autorefund is disabled
    100: Payment Method
    103: RemotePay
    124: TC124
    """
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_125():
    """
    Sub Feature Code: UI_Common_PM_RP_2_UPI_failed_callback_before_expiry_AXIS_DIRECT_AutoRefund_Enabled
    Sub Feature Description: Performing two UPI failed callback via Axis Direct before expiry the when autorefund is enabled
    100: Payment Method
    103: RemotePay
    125: TC125
    """
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_126():
    """
    Sub Feature Code: UI_Common_PM_RP_2_UPI_failed_callback_after_expiry_AXIS_DIRECT_AutoRefund_Enabled
    Sub Feature Description: Performing two UPI failed callback via Axis Direct after expiry the when autorefund is enabled
    100: Payment Method
    103: RemotePay
    126: TC126
    """
