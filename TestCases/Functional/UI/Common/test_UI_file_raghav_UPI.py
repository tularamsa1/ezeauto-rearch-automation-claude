...
#@pytest.mark.uiVal
def test_common_100_108_9999():  # Make sure to add the test case name as same as the sub feature code.
    """
    This is test try from Raghav for Hands on
    ...
    try:
        ...
        try:
            ...
            query = f"select * from txn where org_code = '{str(org_code)}' order by created_time desc limit 1 ;"
