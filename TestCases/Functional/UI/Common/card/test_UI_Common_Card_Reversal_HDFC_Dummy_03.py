...
@pytest.mark.appVal
def test_common_100_115_165():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090
    Sub Feature Description:  Performing the EMV Reversal transaction via HDFC Dummy PG using VISA Debit card having
    16 digit PAN length with pin (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 165: TC165
    """
    try:
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_166():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMV_RUPAY_DebitCard_With_Pin_608326
    Sub Feature Description: Performing the EMV Reversal transaction via HDFC Dummy PG using RUPAY Debit card having
    16 digit PAN length with pin (bin: 608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 166: TC166
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_167():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMV_VISA_DebitCard_Without_Pin_476173
    Sub Feature Description: Performing the EMV Reversal transaction via HDFC Dummy PG using VISA Debit card having
    16 digit PAN length without pin  (bin:476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 167: TC167
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_168():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMV_MASTER_DebitCard_Without_Pin_222360
    Sub Feature Description: Performing the EMV Reversal transaction via HDFC Dummy PG using MASTER Debit card having
    16 digit PAN length without pin (bin: 222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 168: TC168
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_115_169():
    """
    Sub Feature Code: UI_Common_Card_Reversal_HDFC_Dummy_EMV_RUPAY_DebitCard_Without_Pin_608326
    Sub Feature Description: Performing the EMV Reversal transaction via HDFC Dummy PG using RUPAY Debit card having
    16 digit PAN length without pin (bin: 608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 169: TC169
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
