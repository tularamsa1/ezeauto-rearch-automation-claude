...
def test_common_100_115_07_102():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_BO_Instant_Discount_Cashback_by_Brand_Fixed_Success_Txn_For_An_Org_HDFC_Dummy_Onecard_EMV_VISA_CreditCard_With_Pin_417666_For_3_Months_Tenure
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand_EMI, 102: TC102
    """
    try:
        ...
        query = f"select * from rule where org_code='{org_code}' and credit_type='INSTANT' and name LIKE '{brand_name}_ONECARD_CREDIT%'"
