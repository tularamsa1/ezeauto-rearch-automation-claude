...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_001():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMV_DEBIT_VISA
        Sub Feature Description: API that performs EMV Sale txn using DEBIT VISA card via ATOS_TLE
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_002():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMV_DEBIT_MASTER
        Sub Feature Description: API that performs EMV Sale txn using DEBIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        002: TC002
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_003():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMV_DEBIT_RUPAY
        Sub Feature Description: API that performs EMV Sale txn using DEBIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        003: TC003
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_004():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMV_CREDIT_VISA
        Sub Feature Description: API that performs EMV Sale txn using CREDIT VISA card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        004: TC004
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_005():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMV_CREDIT_MASTER
        Sub Feature Description: API that performs EMV Sale txn using CREDIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        005: TC005
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_006():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMV_CREDIT_RUPAY
        Sub Feature Description: API that performs EMV Sale txn using CREDIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        006: TC006
