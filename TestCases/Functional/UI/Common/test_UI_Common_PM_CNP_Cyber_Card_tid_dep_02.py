    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                txn_history_page.click_on_transaction_by_txn_id(txn_txn_id)
                ...
                logger.info(f"Fetching txn orderId from txn history for the txn : {txn_txn_id}, {payment_order_id}")
...
def test_common_100_103_152():
    ...
    try:
        ...
        logger.info("Execution Started for the test case : {testcase_id}")
