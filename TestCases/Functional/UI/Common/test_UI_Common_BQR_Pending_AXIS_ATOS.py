...
def test_common_100_102_209():
    """
    Sub Feature Code: UI_Common_BQRV4_BQR_Pending_AXIS_ATOS
    Sub Feature Description: Verification of a BQRV4 BQR Checkstatus pending txn via AXIS ATOS
    TC naming code description: 100: Payment Method, 102: BQR, 209: TC209
    """
    try:
