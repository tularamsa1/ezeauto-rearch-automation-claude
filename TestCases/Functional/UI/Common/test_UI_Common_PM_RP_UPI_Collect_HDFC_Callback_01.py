...
def test_common_100_103_014():
    ...
    try:
        ...
        try:
            ...
            db_txn_status = result['status'].values[0]
...
def test_common_100_103_016():
    """
    Sub Feature Code: UI_Common_PM_Success_RP_upi_collect_Callback_After_Expiry_HDFC
    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                actual_app_values = {"pmt_status": app_payment_status.split(':')[1],
