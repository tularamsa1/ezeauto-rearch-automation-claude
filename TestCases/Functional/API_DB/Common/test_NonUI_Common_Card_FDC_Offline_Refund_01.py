...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_145():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Offline_Refund_EMV_DEBIT_VISA
        Sub Feature Description:API that performs EMV offline Refund txn having DEBIT VISA card via FDC
        ...
        try:
            ...
            if confirm_success == True:
                ...
                if settle_success == True:
                    api_details = DBProcessor.get_api_details('Offline_Refund', request_body={"username": card_details["Username"],
                                                                        "password": card_details["Password"],
                                                                        "ezetapDeviceData": card_details["Ezetap Device Data"],
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_122():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Online_Refund_EMV_DEBIT_MASTER
        Sub Feature Description:API that performs EMV Online Refund txn having DEBIT MASTER card via FDC
        TC naming code description:
        100: Payment Method
        104: CARD
        122: TC122
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_123():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Online_Refund_EMV_DEBIT_RUPAY
        Sub Feature Description:API that performs EMV Online Refund txn having DEBIT RUPAY card via FDC
        TC naming code description:
        100: Payment Method
        104: CARD
        123: TC123
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_124():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Online_Refund_EMV_CREDIT_VISA
        Sub Feature Description:API that performs EMV Online Refund txn having CREDIT VISA card via FDC
        TC naming code description:
        100: Payment Method
        104: CARD
        124: TC124
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_125():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Online_Refund_EMV_CREDIT_MASTER
        Sub Feature Description:API that performs EMV Online Refund txn having CREDIT MASTER card via FDC
        TC naming code description:
        100: Payment Method
        104: CARD
        125: TC125
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_126():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Online_Refund_EMV_CREDIT_RUPAY
        Sub Feature Description:API that performs EMV Online Refund txn having CREDIT RUPAY card via FDC
        TC naming code description:
        100: Payment Method
        104: CARD
        126: TC126
