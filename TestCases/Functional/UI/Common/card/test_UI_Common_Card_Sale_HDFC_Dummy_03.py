...
def test_common_100_115_117():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090
    Sub Feature Description:  Performing the EMV sale transaction via HDFC Dummy PG using VISA Debit card having
    16 digit PAN length with pin (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 117: TC117
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_118():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_Dummy_EMV_RUPAY_DebitCard_With_Pin_608326
    Sub Feature Description:  Performing the EMV sale transaction via HDFC Dummy PG using RUPAY Debit card having
    16 digit PAN length with pin (bin: 608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 118: TC118
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_119():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_Dummy_EMV_VISA_DebitCard_Without_Pin_476173
    Sub Feature Description: Performing the EMV sale transaction via HDFC Dummy PG using VISA Debit card having
    16 digit PAN length without pin (bin: 476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 119: TC119
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_120():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_Dummy_EMV_MASTER_DebitCard_Without_Pin_222360
    Sub Feature Description:  Performing the EMV sale transaction via HDFC Dummy PG using MASTER Debit card having
    16 digit PAN length without pin (bin: 222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 120: TC120
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_121():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_Dummy_EMV_RUPAY_DebitCard_Without_Pin_608326
    Sub Feature Description:  Performing the EMV sale transaction via HDFC Dummy PG using RUPAY Debit card having
    16 digit PAN length without pin (bin: 608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 121: TC121
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
