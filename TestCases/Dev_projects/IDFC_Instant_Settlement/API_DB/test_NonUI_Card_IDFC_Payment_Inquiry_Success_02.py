...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_044():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_Success_Inquiry_Instant_Settlement_EMVCTLS_DEBIT_VISA
        Sub Feature Description: API that performs success inquiry on IS settlement when IS call is Timeout for CTLS DEBIT VISA card via IDFC_FDC
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_045():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_Success_Inquiry_Instant_Settlement_EMVCTLS_DEBIT_MASTER
        Sub Feature Description: API that performs success inquiry on IS settlement when IS call is Timeout for CTLS MASTER_CARD VISA card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        045: TC045
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_046():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_Success_Inquiry_Instant_Settlement_EMVCTLS_DEBIT_RUPAY
        Sub Feature Description: API that performs success inquiry on IS settlement when IS call is Timeout for CTLS RUPAY VISA card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        045: TC045
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_047():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_Success_Inquiry_Instant_Settlement_EMVCTLS_CREDIT_VISA
        Sub Feature Description: API that performs success inquiry on IS settlement when IS call is Timeout for CTLS VISA CREDIT card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        047: TC047
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_048():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_Success_Inquiry_Instant_Settlement_EMVCTLS_CREDIT_MASTER
        Sub Feature Description: API that performs success inquiry on IS settlement when IS call is Timeout for CTLS MASTER_CARD CREDIT card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        048: TC048
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_049():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_Success_Inquiry_Instant_Settlement_EMVCTLS_CREDIT_RUPAY
        Sub Feature Description: API that performs success inquiry on IS settlement when IS call is Timeout for CTLS RUPAY CREDIT card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        049: TC049
