...
def test_common_100_102_081():
    """
    :Description: Verification of a BQRV4 Refund transaction via AXIS_ATOS
    :Sub feature code: UI_Common_BQRV4_Refund_via_AXIS_ATOS_081
    :TC naming code description:100->Payment Method, 102->BQR, 062-> TC081
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    "original_upi_bank_code": "AXIS",
                    "refunded_upi_bank_code": "AXIS",
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_102_082():
    """
    :Description: Verification of a BQRV4 UPI Refund failed transaction through API via AXIS ATOS
    :Subfeature code: UI_Common_BQRV4_UPI_Refund_Failed_via_API_AXIS_ATOS
    :TC naming code description:100->Payment Method, 102->BQR, 082-> TC082
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    "upi_txn_type_2": "REFUND", "upi_mc_id_2": upi_mc_id, "upi_bank_code_2": "AXIS"
