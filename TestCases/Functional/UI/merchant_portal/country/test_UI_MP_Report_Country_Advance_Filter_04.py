...
def test_mp_700_701_056():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_Card_as_country_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode Card when logging in as Country Head
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_mode='" + pmt_mode_search_value + "' order by created_time asc limit 1;"
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_701_057():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_UPI_as_country_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode UPI  when logging in as Country Head
    TC naming code description:
    700: Merchant Portal
    701: Country
    057: TC057
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_701_058():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_BharatQR_as_country_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode BharatQR  when logging in as Country Head
    TC naming code description:
    700: Merchant Portal
    701: Country
    058: TC058
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_701_059():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_CNP_as_country_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode CNP  when logging in as Country Head
    TC naming code description:
    700: Merchant Portal
    701: Country
    059: TC059
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_701_060():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_cheque_as_country_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode Cheque when logging in as Country Head
    TC naming code description:
    700: Merchant Portal
    701: Country
    060: TC060
