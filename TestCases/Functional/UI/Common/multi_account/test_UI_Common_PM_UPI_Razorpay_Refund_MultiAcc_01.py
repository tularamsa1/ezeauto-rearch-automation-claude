...
def test_common_100_109_039():
    """
    Sub Feature Code: UI_Common_PM_Pure_UPI_Full_Refund_Via_API_MultiAcc_Razorpay
    Sub Feature Description: Multi Account - Verification of a UPI full refund using api for Razorpay
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_109_040():
    """
    Sub Feature Code: UI_Common_PM_UPI_Partial_Refund_Via_API_MultiAcc_Razorpay
    Sub Feature Description: Multi Account - Verification of a UPI partial refund using api for Razorpay
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 040: TC040
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
