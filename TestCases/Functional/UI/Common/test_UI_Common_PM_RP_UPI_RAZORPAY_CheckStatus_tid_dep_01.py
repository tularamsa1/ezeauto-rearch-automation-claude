...
def test_common_100_103_283():
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"Query result, rrn from db : {db_rrn}")
            db_auth_code = result['auth_code'].values[0]
            logger.debug(f"Query result, auth_code from db : {db_auth_code}")
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                ...
                logger.debug(
                    f"payment_intent_status from payment_intent table in db validation : {payment_intent_status}")
