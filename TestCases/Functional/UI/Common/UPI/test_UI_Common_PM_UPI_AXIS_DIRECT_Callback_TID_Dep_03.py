...
def test_common_100_101_192():
    ...
    Sub Feature Description: TID Dep - Verification of  two failed callback after expiry when auto refund enabled via Axis acq and Axis PG where upi config is Axis_Direct
    TC naming code description: 100: Payment Method, 101: UPI, 192: TC192
    """
    try:
        ...
        try:
            ...
            logger.info(f"Waiting till QR expiry ... ")
            time.sleep(60)
...
def test_common_100_101_193():
    ...
    Sub Feature Description: TID Dep - Verification of a ref id validation using  upi txn via AXIS_DIRECT
    TC naming code description: 100: Payment Method, 101: UPI, 193: TC193
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
