...
def test_common_100_103_024():
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"generated created time is : {original_created_time}")
...
def test_common_100_103_025():
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"generated original created time is : {orig_created_time}")
            ...
            logger.debug(f"created time after 1st callback is : {new_txn_created_time_1}")
            ...
            logger.debug(f"created time after 1st callback is : {new_txn_created_time_2}")
