...
def test_common_100_102_019():
    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expectedDBValues = {"Payment Status": "UPG_REFUND_PENDING", "Payment mode":"BHARATQR" , "Payment amount":"{:.2f}".format(amount), "State":"UPG_REFUND_PENDING", "State Bharatqr": "UPG_REFUND_PENDING", "Amount Bharatqr": amount, "Status Bharatqr": "Transaction Success"}
                #
...
def test_common_100_102_043():
    ...
    :Sub Feature code: UI_Common_PM_BQR_UPG_Refund_API_HDFC
    :TC naming code description: 100->Payment Method
                                102->BQR
                                040-> TC40
    """
...
def test_common_100_102_044():
    """
    :Description: Verification of  a BQR UPG Refund txn when Auto refund is disabled through API via HDFC
    :Sub Feature code: UI_Common_PM_BQR_UPG_Refund_HDFC
    :TC naming code description: 100->Payment Method
                                102->BQR
                                040-> TC40
    """
