...
def test_common_100_102_019(): #Make sure to add the test case name as same as the sub feature code.
    """
    :Description: Verification of a BQR Refund transaction via HDFC
    :Sub Feature code: UI_Common_PM_BQR_Refund_HDFC _019
    ...
    try:
        logger.info("Starting execution for the test case : test_common_100_102_019")
        ...
        try:
            # ------------------------------------------------------------------------------------------------
            app_cred = ResourceAssigner.getAppUserCredentials('test_common_100_102_019')
            logger.debug(f"Fetched app credentials from the ezeauto db : {app_cred}")
            username = app_cred['Username']
            password = app_cred['Password']
            portal_cred = ResourceAssigner.getPortalUserCredentials('test_common_100_102_019')
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            try:
                ...
                logger.debug(f"Fetching Transaction amount of original txn from transaction api : {amount_api_original} ")
                logger.debug(f"Fetching Transaction payment of original txn mode from transaction api : {payment_mode_api_orginal} ")
                #
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            try:
                ...
                # --------------------------------------------------------------------------------------------
                expectedDBValues = {"Payment Status": "REFUNDED", "Payment mode":"BHARATQR" , "Payment amount":amount, "Payment Status Original":"AUTHORIZED_REFUNDED","Amount Original": amount, "Payment Mode Original": "BHARATQR"}
                #
        ...
        if (ConfigReader.read_config("Validations", "charge_slip_validation")) == "True":
            logger.info("Started ChargeSlip validation for the test case : test_com_100_102_019")
            try:
            ...
            logger.info("Completed ChargeSlip validation for the test case : test_com_100_102_019")
    ...
    # -------------------------------------------End of Validation---------------------------------------------
        ...
        Configuration.executeFinallyBlock("test_common_100_102_019")
        ...
        logger.info("**********Test case Execution and Validation completed for test case : test_common_100_102_019**************")
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_102_020(): #Make sure to add the test case name as same as the sub feature code.
    """
    :Description: Verification of a BQR Refund transaction through API via HDFC
    :Sub Feature code: UI_Common_PM_BQR_Refund_API_HDFC_020
    :TC naming code description: 100->Payment Method
                                102->BQR
                                020-> TC20
    """
    ...
    try:
        logger.info("Starting execution for the test case : test_common_100_102_020")
        # -----------------------------PreConditions(Setup to be done for the test case)--------------------------
        # Write the setup code here
        ...
        # -----------------------------------------Start of ChargeSlip Validation---------------------------------
        if (ConfigReader.read_config("Validations", "charge_slip_validation")) == "True":
            logger.info("Started ChargeSlip validation for the test case : test_com_100_102_020")
            try:
                expectedValues = {'PAID BY:': 'BHARATQR', 'merchant_ref_no': 'Ref # ' + str(order_id),
                                  'RRN': rrn,
                                  'BASE AMOUNT:': 'Rs.' + str(amount) + '.00'}
            ...
            logger.info("Completed ChargeSlip validation for the test case : test_com_100_102_020")
    ...
    # -------------------------------------------End of Validation---------------------------------------------
        ...
        # Test case ID should be passed as argument in string format.
        #Test case ID will be the method name. Eg. test_SubFeatureCode in this case.
        Configuration.executeFinallyBlock("test_sa_100_102_020")
        logger.info("**********Test case Execution and Validation completed for test case : test_common_100_102_020**************")
