...
def test_common_100_102_147():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_UPG_AUTOREFUND_ENABLED_AXIS_ATOS
    Sub Feature Description: Verification of a BQRV4 UPI UPG txn when Auto refund is enabled via AXIS_ATOS
...
def test_common_100_102_148():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_UPG_AUTOREFUND_DISABLED_AXIS_ATOS
    Sub Feature Description: Verification of a BQRV4 UPI UPG txn when Auto refund is disabled via AXIS_ATOS
    TC naming code description: 100: Payment Method, 102: BQR, 148: TC148
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_common_100_102_149():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_UPG_Refund_Via_API_AXIS_ATOS
    Sub Feature Description: Verification of  a BQRV4 UPG Refund txn when Auto refund is disabled through API via AXIS_ATOS
