...
def test_common_100_115_01_007():
    """
    Sub Feature Code: UI_Common_Card_Sale_Tip_Void_Txn_HDFC_Dummy_EMVCTLS_VISA_DebitCard_Without_pin_476173
    Sub Feature Description: Performing the EMVCTLS sale tip void transaction via HDFC Dummy PG using VISA Debit card
    having 16 digit PAN length without pin (bin:476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 01: Sale+Tip, 007: TC007
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_01_008():
    """
    Sub Feature Code: UI_Common_Card_Sale_Tip_Void_Txn_HDFC_Dummy_EMVCTLS_MASTER_DebitCard_Without_pin_222360
    Sub Feature Description: Performing the EMVCTLS sale tip void transaction via HDFC Dummy PG using MASTER Debit card
    having 16 digit PAN length without pin (bin:222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 01: Sale+Tip, 008: TC008
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_01_009():
    """
    Sub Feature Code: UI_Common_Card_Sale_Tip_Void_Txn_HDFC_Dummy_EMVCTLS_RUPAY_DebitCard_Without_pin_608326
    Sub Feature Description: Performing the EMVCTLS sale tip void transaction via HDFC Dummy PG using RUPAY Debit card
    having 16 digit PAN length without pin (bin:608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 01: Sale+Tip, 009: TC009
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
