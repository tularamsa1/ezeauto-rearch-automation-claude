...
from PageFactory.ReArch.rearch_native_locators import TxnHistoryLocators, OnboardingLocators
...
@pytest.mark.appVal
def test_common_rearch_0043():
    """
    Sub Feature Code: UI_ReArch_Home_Verify_DeleteCacheLogin_HDFC
    Sub Feature Description:
        ...
        relaunch, select environment, login with hardcoded credentials
        (10000010101 / AQWERTY), then verify the Start button is NOT visible.
    ...
    NL Source Steps:
      ...
      Test Steps:
        ...
        8.  wait until select Environment page is visible
        9.  scroll down and tap on environment
        10. wait until login page is visible
        11. enter username as 10000010101 and password as AQWERTY
        12. tap on login button

      App Validation:
        13. Verify "Start" button is not visible
    ...
    try:
        ...
        try:
            ...
            # Step 8: Wait until Select Environment page is visible
            ...
            logger.debug("Select Environment page is visible")

            # Step 9: Scroll down and tap on environment
            ...
            # Step 11: Enter username 10000010101 and password AQWERTY
            login_page.enter_username("10000010101")
            login_page.enter_password("AQWERTY")
            logger.debug("Entered hardcoded credentials (10000010101 / AQWERTY)")

            # Step 12: Tap on login button
        ...
        if ConfigReader.read_config("Validations", "app_validation") == "True":
            ...
            try:
                # Step 13: Verify "Start" button is NOT visible
                start_visible = login_page.is_element_visible(OnboardingLocators.btn_start, time=10)

                expected_app_values = {
                    "start_button_visible": "False",
                }
                actual_app_values = {
                    "start_button_visible": str(start_visible),
                }
