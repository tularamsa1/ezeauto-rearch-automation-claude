...
def test_mp_700_708_062():
    """
    Sub Feature Code: UI_MP_Profile_Info_as_Store_head
    Sub Feature Description: Verifying Profile information by logging in and log out  as Store Head
