...
def test_common_100_115_221():
    """
    Sub Feature Code: UI_Common_Card_Refund_ATOS_TLE_EMV_VISA_DebitCard_With_Pin_428090
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 221: TC221
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_223():
    """
    Sub Feature Code: UI_Common_Card_Refund_ATOS_TLE_EMV_VISA_CreditCard_With_Pin_417666
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 223: TC223
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_224():
    """
    Sub Feature Code: UI_Common_Card_Refund_ATOS_TLE_EMV_MASTER_DebitCard_Without_Pin_222360
    Sub Feature Description:  Performing the EMV Refund transaction via ATOS_TLE PG using MASTER Debit card having
     16 digit PAN length without pin (bin: 222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 224: TC224
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_225():
    """
    Sub Feature Code: UI_Common_Card_Refund_ATOS_TLE_EMV_MASTER_CreditCard_Without_Pin_541333
    Sub Feature Description:  Performing the EMV Refund transaction via ATOS_TLE PG using MASTER Credit card having
     16 digit PAN length without pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 225: TC225
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
