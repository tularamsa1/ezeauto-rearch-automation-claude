...
def test_common_100_115_05_082():
    """
    Sub Feature Code: UI_Common_Card_Normal_EMI_Void_Txn_For_An_Org_HDFC_Dummy_ICICI_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenure
    Sub Feature Description: Performing the normal EMI void transaction for an org (not ezetap) via HDFC Dummy PG for
    ICICI issuer using EMV VISA Debit card with pin for 3 months tenure (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 082: TC082
    """
    try:
