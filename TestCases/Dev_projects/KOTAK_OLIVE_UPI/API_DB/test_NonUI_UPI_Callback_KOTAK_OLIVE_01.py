...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d103_101_005():
    """
    Sub Feature Code: NonUI_Common_UPI_Success_Callback_KOTAK_OLIVE
    Sub Feature Description: Generate QR through api and perform success callback for UPI txn of KOTAK_OLIVE pg
    TC naming code description: d103: Dev Project[KOTAK_OLIVE_UPI], 101-> UPI, 005->TC005
    """
    try:
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d103_101_006():
    """
    Sub Feature Code: NonUI_Common_UPI_Failed_Callback_KOTAK_OLIVE
    Sub Feature Description: Generate QR through api and perform failed callback for UPI txn of KOTAK_OLIVE pg
    TC naming code description: d103: Dev Project[KOTAK_OLIVE_UPI], 101-> UPI, 006->TC006
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d103_101_007():
    """
    Sub Feature Code: NonUI_Common_UPI_Rejected_Callback_KOTAK_OLIVE
    Sub Feature Description: Generate QR through api and perform rejected callback for UPI txn of KOTAK_OLIVE pg
    TC naming code description: d103: Dev Project[KOTAK_OLIVE_UPI], 101-> UPI, 007->TC007
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d103_101_008():
    """
    Sub Feature Code: NonUI_Common_UPI_Expired_Callback_KOTAK_OLIVE
    Sub Feature Description: Generate QR through api and perform expired callback for UPI txn of KOTAK_OLIVE pg
    TC naming code description: d103: Dev Project[KOTAK_OLIVE_UPI], 101-> UPI, 008->TC008
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
