...
def test_common_100_115_07_031():
    """
        Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Merchant_Percentage_Success_Txn_For_An_Org_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenure
        Sub Feature Description: Performing the brand EMI payback by merchant percentage success transaction for an org via HDFC Dummy PG using EMV VISA Debit card with pin for 3 months tenure (bin: 428090)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 031: TC031
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_033():
    """
        Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Merchant_Percentage_Success_Txn_For_An_Org_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090_For_6_Months_Tenure
        Sub Feature Description: Performing the brand EMI payback by merchant percentage success transaction for an org via HDFC Dummy PG using EMV VISA Debit card with pin for 6 months tenure (bin: 428090)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 033: TC033
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_035():
    """
        Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Merchant_Percentage_Success_Txn_For_An_Org_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090_For_9_Months_Tenure
        Sub Feature Description: Performing the brand EMI payback by merchant percentage success transaction for an org via HDFC Dummy PG using EMV VISA Debit card with pin for 9 months tenure (bin: 428090)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 033: TC033
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_037():
    """
        Sub Feature Code: UI_Common_Card_Brand_EMI_Cashback_by_Merchant_Fixed_Success_Txn_For_An_Org_HDFC_Dummy_EMV_VISA_CreditCard_With_Pin_417666_For_3_Months_Tenure
        Sub Feature Description: Performing the brand EMI cashback by merchant fixed success transaction for an org via HDFC Dummy PG using EMV VISA Credit card with pin for 3 months tenure (bin: 417666)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 037: TC037
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_039():
    """
        Sub Feature Code: UI_Common_Card_Brand_EMI_Cashback_by_Merchant_Fixed_Success_Txn_For_An_Org_HDFC_Dummy_EMV_VISA_CreditCard_With_Pin_417666_For_6_Months_Tenure
        Sub Feature Description: Performing the brand EMI cashback by merchant fixed success transaction for an org via HDFC Dummy PG using EMV VISA Credit card with pin for 6 months tenure (bin: 417666)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 039: TC039
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
