...
def test_common_rearch_0006():
    ...
    Sub Feature Description:
        Launch ReArch app, enter a random 3-digit amount, select UPI, proceed
        through Order Details overlay, wait for QR screen (HDFC simulator
        auto-authorizes on QR display), cancel QR navigation, verify the
        transaction is AUTHORIZED via App, API, and Charge Slip validation.
    ...
    NL Source Steps:
      ...
      Test Steps:
        ...
        11. cancel payment  (HDFC simulator auto-authorizes when QR is shown)
        12. verify payment failed screen
        13. click accept more payments

      App Validation:
        14. go to transaction history → first transaction → txn detail
        18. validate txn status is AUTHORIZED
        19. validate payment mode is UPI
        20. validate payment id is not empty
      ...
      Charge Slip Validation:
        PAID BY=UPI, merchant_ref_no=order_id, RRN=rrn,
        BASE AMOUNT=amount, date, time  (no AUTH CODE for UPI)
    ...
    try:
        ...
        try:
            ...
            # Step 1-2: Launch ReArch app and log in
            ...
            # Resolve txn from DB using order_id
            query = (
            ...
            # Step 13: Click accept more payments → back to amount screen
        ...
        if ConfigReader.read_config("Validations", "app_validation") == "True":
            ...
            try:
                ...
                # Steps 14-17: Navigate to TxnDetail
                home_page.wait_for_home_page_load()
