...
def test_mp_700_704_008():
    """
    Sub Feature Code: UI_MP_Payment_using_Card_as_District_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using card when logging in as District Head
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'CARD'" \
                                                "and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "');"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_704_009():
    """
    Sub Feature Code: UI_MP_Payment_using_Cash_as_District_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using Cash when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    009: TC009
        ...
        try:
            ...
            query = "select sum(amount) from txn where" \
                    " org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'CASH' and " \
                                                 "id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "');"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_704_010():
    """
    Sub Feature Code: UI_MP_Payment_using_UPI_as_District_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using UPI when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    010: TC010
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'UPI' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "');"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_704_011():
    """
    Sub Feature Code: UI_MP_Payment_using_BQR_as_District_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using BQR when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    011: TC011
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'BHARATQR' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "');"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_704_012():
    """
    Sub Feature Code: UI_MP_Payment_using_CNP_as_District_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using CNP when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    012: TC012
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'CNP' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "');"
