...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_098():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_timeout_EMVCTLS_DEBIT_VISA
        Sub Feature Description: API that performs IS Success and inquiry timeout on IS settlement for CTLS DEBIT VISA card via IDFC_FDC
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_099():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_timeout_EMVCTLS_DEBIT_MASTER
        Sub Feature Description: API that performs IS Success and inquiry timeout on IS settlement for CTLS MASTER_CARD VISA card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        099: TC099
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_100():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_timeout_EMVCTLS_DEBIT_RUPAY
        Sub Feature Description: API that performs IS Success and inquiry timeout on IS settlement for CTLS RUPAY VISA card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        100: TC100
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_101():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_timeout_EMVCTLS_CREDIT_VISA
        Sub Feature Description: API that performs IS Success and inquiry timeout on IS settlement for CTLS VISA CREDIT card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        101: TC101
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_102():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_timeout_EMVCTLS_CREDIT_MASTER
        Sub Feature Description: API that performs IS Success and inquiry timeout on IS settlement for CTLS MASTER_CARD CREDIT card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        102: TC102
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_103():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Success_and_Inquiry_timeout_EMVCTLS_CREDIT_RUPAY
        Sub Feature Description: API that performs IS Success and inquiry timeout on IS settlement for CTLS RUPAY CREDIT card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        103: TC103
