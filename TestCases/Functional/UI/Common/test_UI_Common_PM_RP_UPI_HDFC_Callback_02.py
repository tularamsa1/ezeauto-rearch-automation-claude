...
def test_common_100_103_062():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_Success_Callback_After_Expiry_AutoRefundEnabled_HDFC
    Sub Feature Description: Verification of a one upi  success callback after expiry via HDFC when auto refund is enalbed.
    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                logger.info(f"Fetching txn settlement_status from txn history for the txn : {new_txn_id}, {new_app_settlement_status}")
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expectedDBValues = {"pmt_status": "FAILED",
                                    ...
                                    "new_acquirer_code": "HDFC",
                                    "upi_bank_code": "HDFC",
                                    "new_upi_txn_type": "REMOTE_PAY_UPI_INTENT",
                                    "new_mid": new_txn_mid,
                                    "new_tid": new_txn_tid,
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_063():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_Two_Success_Callback_After_Expiry_AutoRefundEnabled_HDFC
    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                txn_type_api = response["txnType"]
                date_api = response["postingDate"]
                rrnNumber_api = response["rrNumber"]
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_065():
    """
    Sub Feature Code: UI_Common_PM_RP_2_UPI_success_callback_before_expiry_HDFC_AutoRefund_Disabled
    Sub Feature Description: Verification of a two UPI  success callback via HDFC beofre expiry the when autorefund is disabled
    100: Payment Method
    103: RemotePay
    065: TC065
    """
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_066():
    """
    Sub Feature Code: UI_Common_PM_RP_2_UPI_success_callback_before_expiry_HDFC_AutoRefund_Enabled
    Sub Feature Description: Verification of two UPI success callback via HDFC before expiry the when autorefund is enabled
    100: Payment Method
    103: RemotePay
    066: TC066
    """
