...
def test_mp_700_703_020():
    """
    Sub Feature Code: UI_MP_Report_for_Daily_txn_as_State_head
    Sub Feature Description: Verifying txn details on Report Page using Daily quick Filter when logging in as State Head
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_703_021():
    """
    Sub Feature Code: UI_MP_Report_for_Monthly_txn_as_State_head
    Sub Feature Description: Verifying txn details on Report Page using Monthly quick Filter when logging in as State Head
    TC naming code description:
    700: Merchant Portal
    703: State
    021: TC021
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_703_022():
    """
    Sub Feature Code: UI_MP_Report_for_Weekly_txn_as_State_head
    Sub Feature Description: Verifying txn details on Report Page using weekly quick Filter when logging in as State Head
    TC naming code description:
    700: Merchant Portal
    703: State
    022: TC022
