...
def test_common_100_101_151():
    """
    Sub Feature Code: UI_SA_PM_BQRV4_BQR_Success_Via_API_CheckStatus_KOTAK
    Sub Feature Description: Verification of a successful bqr txn via BQRV4 via KOTAK using check status api
