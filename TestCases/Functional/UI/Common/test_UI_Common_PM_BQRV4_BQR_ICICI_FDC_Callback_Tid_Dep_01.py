...
def test_common_100_102_159():
    ...
    Sub Feature Description: Performing 2 successful BQRV4 BQR callback after qr expiry via ICICI_FDC Tid Dep
    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                ...
                actual_db_values = {
                    ...
                    "bqr_merchant_config_id_2": bqr_merchant_config_id_db_2, "bqr_txn_primary_id_2": bqr_txn_primary_id_db_2,
        ...
        if (ConfigReader.read_config("Validations", "charge_slip_validation")) == "True":
            ...
            try:
                ...
                expected_values = {'PAID BY:': 'BHARATQR', 'merchant_ref_no': 'Ref # ' + str(order_id), 'RRN': str(rrn_2),
                                   'BASE AMOUNT:': "Rs." + str(amount) + ".00",
                                   'date': txn_date, 'time': txn_time, 'AUTH CODE': auth_code_2}
                logger.debug(f"expected_values : {expected_values}")
...
def test_common_100_102_160():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_BQR_UPI_Success_Callback_After_QR_Expiry_TID_Dep_ICICI_FDC
    Sub Feature Description: Performing 2 successful BQRV4 BQR callback after qr expiry via ICICI_FDC Tid Dep
    TC naming code description: 100: Payment Method, 102: BQRV4, 159: TC159
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "pmt_state_3": "SETTLED", "rrn_3": str(rrn_2),
                    "settle_status_3": "SETTLED",
