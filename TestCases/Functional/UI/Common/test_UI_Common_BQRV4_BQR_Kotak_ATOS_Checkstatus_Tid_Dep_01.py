...
def test_common_100_102_258():
    """
    Sub Feature Code: Tid Dep – UI_Common_BQRV4_BQR_Success_Checkstatus_KOTAK_ATOS
    Sub Feature Description: Tid Dep – Verification of a successful bqr txn using BQRV4 BQR Success Checkstatus via Kotak_ATOS
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_102_259():
    """
    Sub Feature Code: Tid Dep – UI_Common_PM_BQRV4_BQR_Failed_Via_API_CheckStatus_KOTAK_ATOS
    Sub Feature Description: Tid Dep - Performing a failed bqr txn via BQRV4 KOTAK ATOS using check status api
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_102_260():
    """
    Sub Feature Code: Tid Dep - UI_Common_BQRV4_BQR_Check_Status_via_API_After_Expiry_KOTAK_ATOS
    Sub Feature Description: Tid Dep - Performing a expired bqr txn via BQRV4 KOTAK_ATOS when qr is generated by App and check status via api
