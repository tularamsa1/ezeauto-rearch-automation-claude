...
def test_common_100_109_037():
    """
    Sub Feature Code: UI_Common_PM_UPI_Success_Via_SA_CheckStatus_MultiAcc_Razorpay
    Sub Feature Description: Multi Account - Verification of a successful upi txn via Razorpay using SA check status
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 037: TC037
    """
    try:
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_109_038():
    """
    Sub Feature Code: UI_Common_PM_UPI_Failed_Via_SA_CheckStatus_MultiAcc_Razorpay
    Sub Feature Description: Multi Account - Verification of a failed upi txn via Razorpay using SA check status
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 038: TC038
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_109_041():
    """
    Sub Feature Code: UI_Common_PM_UPI_Success_Via_SA_CheckStatus_with_2nd_label_MultiAcc_Razorpay
    Sub Feature Description: Multi Account - Performing a successful upi txn via Razorpay using SA check status with second account(ex:acc2 label)
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 041: TC041
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
