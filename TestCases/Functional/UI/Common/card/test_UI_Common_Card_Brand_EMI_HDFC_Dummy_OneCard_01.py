...
def test_common_100_115_07_058():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Brand_Fixed_Success_Txn_For_An_Org_HDFC_Dummy_OneCard_EMV_VISA_CreditCard_With_Pin_417666_For_3_Months_Tenure
    Sub Feature Description: Performing the brand EMI payback by Brand fixed success transaction for an org (not ezetap)
    via HDFC Dummy PG for OneCard issuer using EMV VISA Credit card with pin for 3 months tenure (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 058: TC058
    """
    try:
        ...
        query = f"select * from subvention_plan where brand_id='{brand_id}' and org_code='{org_code}' and card_type= 'CREDIT' and bank='ONECARD' and eze_emi_enabled=b'0';"
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_059():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Brand_Fixed_Success_Txn_For_An_Org_HDFC_Dummy_OneCard_EMV_VISA_CreditCard_With_Pin_417666_For_6_Months_Tenure
    Sub Feature Description: Performing the brand EMI payback by Brand fixed success transaction for an org (not ezetap)
    via HDFC Dummy PG for OneCard issuer using EMV VISA Credit card with pin for 6 months tenure (bin: 417666)
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_060():
    """
...
@pytest.mark.usefixtures("log_on_success", "method_setup")
@pytest.mark.appVal
def test_common_100_115_07_061():
    """
...
@pytest.mark.usefixtures("log_on_success", "method_setup")
@pytest.mark.appVal
def test_common_100_115_07_072():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Brand_Fixed_Txn_With_CardType_UNKNOWN_For_An_Org_HDFC_Dummy_OneCard_EMV_VISA_CreditCard_With_Pin_417666_For_3_Months_Tenture
    Sub Feature Description: Performing the brand EMI payback by brand fixed transaction with card type UNKNOWN for
    an org via HDFC Dummy PG for onecard issuer using EMV VISA Credit card with pin for 3 months tenure (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 072: TC072
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.usefixtures("log_on_success", "method_setup")
@pytest.mark.appVal
def test_common_100_115_07_091():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Brand_Fixed_Txn_With_CardType_PREPAID_For_An_Org_HDFC_Dummy_OneCard_EMV_VISA_CreditCard_With_Pin_417666_For_3_Months_Tenture
    Sub Feature Description: Performing the brand EMI payback by brand fixed transaction with card type PREPAID for an
    org via HDFC Dummy PG for onecard issuer using EMV VISA Credit card with pin for 3 months tenure (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 091: TC091
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
