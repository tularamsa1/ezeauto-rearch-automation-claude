...
def test_common_100_109_019():
    """
    Sub Feature Code: Tid Dep - UI_Common_PM_UPI_Success_Via_Pure_UPI_Success_Callback_MultiAcc_APB
    Sub Feature Description: Multi Account Tid Dep - Performing a UPI Authorized Txn using pure UPI Success callback for APB PG
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 019: TC019
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                actual_api_values = {
                    ...
                    "externalRefNumber": external_ref_number_api,
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_109_020():
    """
    Sub Feature Code: Tid Dep - UI_Common_PM_UPI_Failed_Via_Pure_UPI_Failed_Callback_MultiAcc_APB
    Sub Feature Description: Multi Account Tid Dep - Performing a UPI Failed Txn using pure UPI Failed callback for APB
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 020: TC020
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
