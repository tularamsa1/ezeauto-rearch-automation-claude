...
def test_common_100_115_06_040():
    """
    Sub Feature Code: UI_Common_Card_Instant_EMI_Success_Txn_For_Fallback_Root_Org_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090_For_9_Months_Tenure
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 06: Instant_EMI, 040: TC040
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_06_041():
    """
    Sub Feature Code: UI_Common_Card_Instant_EMI_Success_Txn_For_Fallback_Root_Org_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090_For_12_Months_Tenure
    Sub Feature Description: Performing the instant EMI success transaction for fallback to root org via HDFC Dummy PG
    using EMV VISA Debit card with pin for 12 months tenure (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 06: Instant_EMI, 041: TC041
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
