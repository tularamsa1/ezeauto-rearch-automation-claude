...
def test_common_100_101_293():
    """
    Sub Feature Code: UI_Common_PM_UPI_Razorpay_QR_Generation_Success
    Sub Feature Description: Verification of a UPI QR Generation Success through SA via Razorpay
    TC naming code description: 100: Payment Method, 101: UPI, 293: TC293
    """
    try:
        ...
        try:
            ...
            amount = random.randint(910, 1000)
