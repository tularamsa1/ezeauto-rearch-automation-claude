...
def test_common_100_115_08_001():
    """
    Sub Feature Code: UI_Common_Card_Online_EMI_Success_Txn_For_An_Org_With_MID1_TID1_Via_HDFC_Dummy_CreditCard_For_3_Months
    Sub Feature Description:  Performing the online EMI success transaction for an org via HDFC Dummy PG
     using Credit card with MID 1 and TID 1 for 3 months tenure (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 08: ONLINE_EMI, 001: TC001
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                logger.debug("Fetching net effective price from txn history for the txn : {txn_id}, {app_net_effective_price}")
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_08_002():
    """
    Sub Feature Code: UI_Common_Card_Online_EMI_Success_Txn_For_An_Org_With_MID2_TID2_Via_HDFC_Dummy_CreditCard_For_6_Months
    Sub Feature Description:  Performing the online EMI success transaction for an org via HDFC Dummy PG
     using Credit card with MID 2 and TID 2 for 6 months tenure (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 08: ONLINE_EMI, 002: TC002
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_08_003():
    """
    Sub Feature Code: UI_Common_Card_Online_EMI_Success_Txn_For_An_Org_With_MID3_TID3_Via_HDFC_Dummy_CreditCard_For_9_Months
    Sub Feature Description:  Performing the online EMI success transaction for an org via HDFC Dummy PG
     using Credit card with MID 3 and TID 3 for 9 months tenure (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 08: ONLINE_EMI, 003: TC003
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_08_004():
    """
    Sub Feature Code: UI_Common_Card_Online_EMI_Success_Txn_For_Root_Org_With_MID1_TID1_Via_HDFC_Dummy_CreditCard_For_3_Months
    Sub Feature Description:  Performing the online EMI success transaction for root org via HDFC Dummy PG
     using Credit card with MID 1 and TID 1 for 3 months tenure (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 08: ONLINE_EMI, 004: TC004
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_08_005():
    """
    Sub Feature Code: UI_Common_Card_Online_EMI_Success_Txn_For_Root_Org_With_MID2_TID2_Via_HDFC_Dummy_CreditCard_For_6_Months
    Sub Feature Description:  Performing the online EMI success transaction for root org via HDFC Dummy PG
     using Credit card with MID 2 and TID 2 for 6 months tenure (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 08: ONLINE_EMI, 005: TC005
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
