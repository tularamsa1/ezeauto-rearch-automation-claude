...
@pytest.mark.appVal
def test_common_100_115_01_006():
    """
    Sub Feature Code: UI_Common_Card_Sale_Tip_Failed_Txn_HDFC_Dummy_EMVCTLS_RUPAY_DebitCard_Without_pin_608326
    Sub Feature Description: Performing the EMVCTLS sale tip failed transaction via HDFC Dummy PG using RUPAY Debit card
    having 16 digit PAN length without pin (bin:608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 01: Sale+Tip, 006: TC006
    """
    try:
