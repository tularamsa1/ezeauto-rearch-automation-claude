...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d103_101_013():
    """
    Sub Feature Code: NonUI_Common_UPI_Partial_Refund_Success_KOTAK_OLIVE
    Sub Feature Description: Verification of a successful UPI partial refund using api for KOTAK_OLIVE
    TC naming code description: d103: Dev Project[KOTAK_OLIVE_UPI], 101-> UPI, 013->TC013
    """
    try:
