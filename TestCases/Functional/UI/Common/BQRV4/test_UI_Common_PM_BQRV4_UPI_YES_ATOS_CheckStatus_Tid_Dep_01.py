...
def test_common_100_102_318():
    """
    Sub Feature Code: Tid Dep - UI_Common_PM_BQRV4_UPI_Checkstatus_Success_YES_ATOS
    Sub Feature Description: Tid Dep - Verification of a BQRV4_UPI Checkstatus Success via YES_ATOS
    TC naming code description: 100: Payment Method, 102: BQRV4, 318: TC318
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                logger.debug(f"Value of authCode obtained from txnlist api is : {txn_type_api}")
                date_api = response["createdTime"]
                logger.debug(f"Value of createdTime obtained from txnlist api is : {auth_code_api}")
...
@pytest.mark.portalVal
@pytest.mark.chargeSlipVal
def test_common_100_102_319():
    """
    Sub Feature Code: Tid Dep - UI_Common_PM_BQRV4_UPI_CheckStatus_After_Expiry_YES_ATOS
    Sub Feature Description: Tid Dep - Verification of a BQRV4_UPI Expired Check status transaction when auto refund disabled via YES_ATOS
    TC naming code description: 100: Payment Method, 102: BQRV4, 319: TC319
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                actual_api_values = {
                    ...
                    "device_serial": str(device_serial_api),
                    "device_serial_2": str(device_serial_api)
                }
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                ...
                actual_db_values = {
                    ...
                    "upi_pmt_status_2": upi_status_db,
        ...
        if (ConfigReader.read_config("Validations", "charge_slip_validation")) == "True":
            ...
            try:
                ...
                receipt_validator.perform_charge_slip_validations(txn_id_new,{"username": app_username,
                                                                   "password": app_password},
                                                                  expected_charge_slip_values)
            except Exception as e:
                Configuration.perform_charge_slip_val_exception(testcase_id, e)
