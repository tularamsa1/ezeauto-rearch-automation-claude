...
def test_common_100_115_07_073():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_Cashback_by_Brand_Fixed_Void_Txn_For_Root_Org_HDFC_Dummy_Axis_EMV_VISA_CreditCard_With_Pin_417666_For_3_Months_Tenure
    Sub Feature Description: Performing the brand EMI cashback by brand fixed void transaction for root org via HDFC
    Dummy PG for Axis issuer using EMV VISA Credit card with pin for 3 months tenure (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand_EMI, 073: TC073
    """
    try:
        ...
        query = f"select * from subvention_plan where brand_id='{brand_id}' and org_code='ALL' and card_type= 'CREDIT' and bank='AXIS' and eze_emi_enabled=b'0' order by created_time desc limit 1;"
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                expected_app_values = {
                    ...
                    "additional_cashback": "{:,.2f}".format(emi_cashback_fixed),
                ...
                app_additional_cashback = txn_history_page.fetch_cashback_text()
                logger.debug(f"Fetching additional cashback from txn history for the txn : {txn_id}, {app_additional_cashback}")
                ...
                actual_app_values = {
                    ...
                    "additional_cashback": app_additional_cashback.split(' ')[1],
        ...
        if (ConfigReader.read_config("Validations", "charge_slip_validation")) == "True":
            ...
            try:
                ...
                expected_charge_slip_values = {
                    ...
                    "Sr. No.": str(imei_no),
                    "unnamed_section_text": f"{customer_name_db}",
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_074():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_Cashback_by_Brand_Fixed_Void_Txn_For_Root_Org_HDFC_Dummy_Axis_EMV_VISA_CreditCard_With_Pin_417666_For_6_Months_Tenure
    Sub Feature Description: Performing the brand EMI cashback by brand fixed void transaction for root org via HDFC
    Dummy PG for Axis issuer using EMV VISA Credit card with pin for 6 months tenure (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand_EMI, 074: TC074
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_07_075():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_Cashback_by_Brand_Fixed_Void_Txn_For_Root_Org_HDFC_Dummy_Axis_EMV_VISA_CreditCard_With_Pin_417666_For_9_Months_Tenure
    Sub Feature Description: Performing the brand EMI cashback by brand fixed void transaction for root org via HDFC
    Dummy PG for Axis issuer using EMV VISA Credit card with pin for 9 months tenure (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand_EMI, 075: TC075
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
