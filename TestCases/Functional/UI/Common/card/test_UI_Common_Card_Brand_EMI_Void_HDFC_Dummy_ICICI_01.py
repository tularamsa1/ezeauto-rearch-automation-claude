...
def test_common_100_115_07_128():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Brand_Fixed_Void_Txn_For_An_Org_HDFC_Dummy_Icici_EMV_VISA_DebitCard_With_Pin_428090_For_9_Months_Tenure
    Sub Feature Description: Performing the brand EMI cashback by brand fixed void transaction an org via HDFC
