...
def test_common_100_103_119():
    """
    Sub Feature Code: UI_Common_PM_RP_2_UPI_success_callback_after_expiry_AXIS_DIRECT_AutoRefund_Disabled
    Sub Feature Description: Performing two UPI success callback via Axis Direct after expiry the when autorefund is disabled
    100: Payment Method
    103: RemotePay
    119: TC119
    """
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_120():
    """
    Sub Feature Code: UI_Common_PM_RP_2_UPI_success_callback_after_expiry_AXIS_DIRECT_AutoRefund_Enabled
    Sub Feature Description: Performing two UPI success callback via Axis Direct after expiry the when autorefund is enabled
    100: Payment Method
    103: RemotePay
    120: TC120
    """
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_121():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_Success_One_Callback_AutoRefundDisabled_AXIS_DIRECT
    Sub Feature Description: Verification of a successful upi callback via Axis Direct when auto refund is disabled.
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_122():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_failed_callback_after_expiry_AutoRefund_Enabled_AXIS_DIRECT
    Sub Feature Description: Performing a UPI failed callback via Axis Direct after expiry the when autorefund is enabled
    100: Payment Method
    103: RemotePay
    122: TC122
    """
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_123():
    """
    Sub Feature Code: UI_Common_PM_RP_2_UPI_failed_callback_after_expiry_AXIS_DIRECT_AutoRefund_Disabled
    Sub Feature Description: Performing two UPI failed callback via Axis Direct after expiry the when autorefund is disabled
    100: Payment Method
    103: RemotePay
    123: TC123
    """
