...
def test_mp_700_708_056():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_Card_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode Card when logging in as Store Head
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_mode='" + pmt_mode_search_value + "' and username IN ('"+txn_username+ "', '" + login_username + "') order by created_time asc limit 1;"
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_708_057():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_UPI_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode UPI when logging in as Store Head
    TC naming code description:
    700: Merchant Portal
    708: Store
    057: TC057
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_708_058():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_BharatQR_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode BharatQR when logging in as Store Head
    TC naming code description:
    700: Merchant Portal
    708: Store
    058: TC058
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_708_059():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_CNP_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode CNP when logging in as Store Head
    TC naming code description:
    700: Merchant Portal
    708: Store
    059: TC059
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_708_060():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_cheque_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode Cheque when logging in as Store Head
    TC naming code description:
    700: Merchant Portal
    708: Store
    060: TC060
