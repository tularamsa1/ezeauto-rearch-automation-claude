...
def test_mp_700_705_061():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_ALL_Payment_mode_as_Taluk_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for ALL payment mode when logging in as Taluk Head
    ...
    try:
        ...
        try:
            ...
            pmt_mode_search_value=["CARD", "CASH", "CHEQUE", "CNP", "WALLET", "UPI", "BHARATQR", "NBFC EMI"]
            ...
            if total_pages > 1:
                api_details = DBProcessor.get_api_details('mp_txn_report', request_body={
                    ...
                    "transactionStatus": [],
                    "selectSearchOptions": [],
                    "paymentMode": ["CARD", "CASH", "CHEQUE", "CNP", "WALLET", "UPI", "BHARATQR", "NBFC EMI"],
                    "totalPages": 0,
                    "nodeIds": [],
                    "totalRecords": 0,
                    "selectUniversalSearch": []
            ...
            trans_history_page.search_based_on_payment_mode(search_value)
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "'  AND (payment_mode='CARD' OR payment_mode='CASH' OR payment_mode='CHEQUE' OR payment_mode='CNP' OR payment_mode='WALLET' OR payment_mode='UPI' OR payment_mode='BHARATQR' OR payment_mode='NBFC EMI') and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') order by created_time asc limit 1;"
