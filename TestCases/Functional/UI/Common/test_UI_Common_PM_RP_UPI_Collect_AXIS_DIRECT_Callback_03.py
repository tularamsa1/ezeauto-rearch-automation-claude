    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "portal_validation")) == "True":
            ...
            try:
                ...
                date_and_time_portal_2 = date_time_converter.to_portal_format(new_txn_modified_time_1)
                date_and_time_portal_3 = date_time_converter.to_portal_format(new_txn_posting_date_app)
