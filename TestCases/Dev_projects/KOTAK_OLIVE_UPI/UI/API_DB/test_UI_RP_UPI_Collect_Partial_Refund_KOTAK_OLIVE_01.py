...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d103_103_025():
    """
    Sub Feature Code: UI_RP_UPI_Collect_Partial_Refund_Via_Api_KOTAK_OLIVE
    Sub Feature Description: Verification of a successful partial refund for Remote Pay UPI Collect using api for KOTAK_OLIVE
    TC naming code description: d103: Dev Project[KOTAK_OLIVE_UPI], 103-> RP_UPI_COLLECT, 022->TC022
    """
    try:
