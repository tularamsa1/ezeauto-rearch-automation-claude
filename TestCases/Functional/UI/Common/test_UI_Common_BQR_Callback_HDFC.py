...
def test_common_100_102_002():
    ...
    :Sub Feature code: UI_Common_PM_BQR_Callback_Failed_HDFC
    :TC naming code description: 100->Payment Method, 102->BQRV4 BQR, 002-> TC02
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_common_100_102_003():
    """
    :Description: Verification of a BQR Callback Expired transaction via HDFC
    :Sub Feature code: UI_Common_PM_BQR_Callback_Expired_HDFC
    :TC naming code description: 100->Payment Method, 102->BQRV4 BQR, 003-> TC03
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
