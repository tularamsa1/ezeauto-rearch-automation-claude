...
@pytest.mark.appVal
def test_common_100_102_268():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_amount_mismatch_Via_BQRV4_UPI_Success_Callback_KOTAK_ATOS_Tid_Dep
    Sub Feature Description: Performing a amount mismatch using pure bqrv4 upi success callback via KOTAK_ATOS Tid Dep
    TC naming code description: 100: Payment Method, 102: BQRV4, 268: TC268
    """
    try:
        ...
        try:
            ...
            logger.debug(f"Query to fetch transaction data from bharatqr_txn table is: {query}")
            result = DBProcessor.getValueFromDB(query)
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_102_269():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_UPG_AUTHORIZED_KOTAK_ATOS_Tid_Dep
    Sub Feature Description: Verification of a upg authorized txn using BQRV4 UPI Success Callback via Kotak_ATOS Tid Dep
    TC naming code description: 100: Payment Method, 102: BQRV4, 269: TC269
