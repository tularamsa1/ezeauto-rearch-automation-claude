...
def test_mp_700_709_001():
    """
    Sub Feature Code: UI_MP_Dashboard_Sales_as_Cashier
    Sub Feature Description: Verifying Total sales, Total Txns and hierarchy details for Upper hierarchy when logged in as Cashier
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where" \
                    ...
                    "' and '" + current_end_date_1 + "' and username = '" + txn_username + "';"
