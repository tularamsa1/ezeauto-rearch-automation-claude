...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_192():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMV_WITH_PIN_DEBIT_VISA
        Sub Feature Description: API that performs EMV with pin Sale txn using DEBIT VISA card via ATOS_TLE
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_179():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMV_WITH_PIN_DEBIT_RUPAY
        Sub Feature Description: API that performs EMV with pin Sale txn using DEBIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        179: TC179
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_206():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMV_WITH_PIN_CREDIT_VISA
        Sub Feature Description: API that performs EMV with pin Sale txn using CREDIT VISA card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        206: TC206
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_220():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Sale_EMV_WITH_PIN_CREDIT_MASTER
        Sub Feature Description: API that performs EMV with pin Sale txn using CREDIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        220: TC220
