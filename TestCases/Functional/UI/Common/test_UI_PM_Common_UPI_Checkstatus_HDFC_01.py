...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
# Initiate qr by app and perform checkStatus by api for failed using magic number
def test_common_100_101_015():  # Make sure to add the test case name as same as the sub feature code.
    """
