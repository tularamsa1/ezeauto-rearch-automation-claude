...
def test_mp_700_706_013():
    """
    Sub Feature Code: UI_MP_Payment_using_Cheque_as_City_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using Cheque when logged in as City Head
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'CHEQUE' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "'and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + taluk_username + "', '" + district_username + "');"
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + taluk_username + "', '" + district_username + "');"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_706_014():
    """
    Sub Feature Code: UI_MP_Payment_using_Normal_EMI_as_City_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using Normal_EMI when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    014: TC014
    ...
    try:
        ...
        try:
            ...
            query = "SELECT sum(amount) from txn where " \
                    "id BETWEEN '" + current_start_date_1 + "' AND '" + current_end_date_1 + "' and org_code='" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'CARD' and payment_card_type ='CREDIT' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + taluk_username + "', '" + district_username + "');"
            ...
            query = "SELECT count(*) from txn where id " \
                    "BETWEEN '" + current_start_date_1 + "' AND '" + current_end_date_1 + "' and org_code='" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'CARD' and payment_card_type ='CREDIT' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + taluk_username + "', '" + district_username + "');"
            ...
            query = "select sum(amount) from txn where o" \
                    "rg_code = '" + org_code + "' and status = 'AUTHORIZED' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and payment_mode = 'CARD' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + taluk_username + "', '" + district_username + "');"
            logger.info(f"query to fetch total overall sale : {query}")
            result = DBProcessor.getValueFromDB(query)
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_706_015():
    """
    Sub Feature Code: UI_MP_Payment_using_Brand_EMI_as_City_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using BrandEMI when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    015: TC015
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where" \
                    " org_code = '" + org_code + "' and status = 'AUTHORIZED' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and payment_mode = 'CARD' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + taluk_username + "', '" + district_username + "');"
            logger.info(f"query to fetch total overall sale : {query}")
            result = DBProcessor.getValueFromDB(query)
            overall_card_sale = result.values[0]
            logger.info(f"overall card sale from db : {overall_card_sale}")
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_706_016():
    """
    Sub Feature Code: UI_MP_Payment_as_Refund_as_City_head
    Sub Feature Description: Verifying txn details on dashboard for payment done as Refund when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    016: TC016
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_706_017():
    """
    Sub Feature Code: UI_MP_Payment_as_Void_as_City_head
    Sub Feature Description: Verifying txn details on dashboard for payment which is Voided when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    017: TC017
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'CARD' and id between '" + current_start_date_1[2:] + "' and '" + current_end_date_1[2:] + "' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + taluk_username + "', '" + district_username + "');"
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and id between '" + current_start_date_1[2:] + "' and '" + current_end_date_1[2:] + "' and username not in ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + taluk_username + "', '" + district_username + "');"
            logger.info(f"query to fetch total overall sale : {query}")
            result = DBProcessor.getValueFromDB(query)
            overall_sale = result.values[0]
            logger.info(f"overall sale from db : {overall_sale}")
