...
def test_common_100_101_077():
    """
    Sub Feature Code: UI_Common_PM_UPI_Success_Via_Pure_UPI_Success_Callback_APB
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                actual_api_values = {"pmt_status": status_api, "txn_amt": amount_api,
                                     ...
                                     "new_date": date_time_converter.from_api_to_datetime_format(new_txn_date_and_time_api)
                                     }
                logger.debug(f"actual_api_values: {actual_api_values}")
                # ---------------------------------------------------------------------------------------------
                Validator.validationAgainstAPI(expectedAPI=expected_api_values, actualAPI=actual_api_values)
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                expected_app_values = {
                    ...
                    "new_txn_pmt_msg": "PAYMENT SUCCESSFUL",
                    "new_txn_rrn": str(rrn),
                    "date": date_and_time,
                    "new_date": new_date_and_time
                }
                ...
                actual_app_values = {
                    ...
                    "pmt_msg": app_payment_msg,
                    "rrn": app_rrn,
                    "new_txn_pmt_mode": new_app_payment_mode,
                    "new_txn_pmt_status": new_app_payment_status,
                    "new_txn_amt": str(new_app_amount).split(' ')[1],
                    "new_txn_settle_status": new_app_settlement_status,
                    ...
                    "new_txn_pmt_msg": new_app_payment_msg,
