...
def test_common_100_103_05_002():
    """
    Sub Feature Code: UI_Common_Card_Normal_EMI_Success_CNP_Txn_For_An_Org_HDFC_Dummy_Federal_VISA_CreditCard_400000_For_3_Months_Tenure
    Sub Feature Description: Performing the normal EMI success CNP transaction for an org (not ezetap) via HDFC Dummy PG for
    Federal issuer using VISA Credit card for 3 months tenure (bin: 400000)
    TC naming code description: 100: Payment Method, 103: CNP, 05: NORMAL_EMI, 002: TC002
    """
    ...
    try:
        ...
        testsuite_teardown.update_bin_info(bin_number='400000', bank_code='FEDERAL', bank='FEDERAL')
        ...
        try:
            ...
            api_details = DBProcessor.get_api_details('create_payment_link_emi', request_body={
                ...
                "externalRefNumber3": device_serial, "emiType": "NORMAL"
            })
            ...
            if response['success'] == False:
                ...
                remote_pay_txn.enter_card_details_emi(card_number='4000 0000 0000 1091', expiry_month='12', expiry_year='24', cvv='123', name_on_card=customer_name)
