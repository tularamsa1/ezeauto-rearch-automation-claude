...
def test_mp_700_703_001():
    """
    Sub Feature Code: UI_MP_Dashboard_Sales_as_State_head
    Sub Feature Description: Verifying Total sales, Total Txns and hierarchy details for Upper hierarchy when logging in as State Head
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where" \
                    ...
                    "' and '" + current_end_date_1 + "' and username not in ('" + country_username + "', '" + region_username + "');"
