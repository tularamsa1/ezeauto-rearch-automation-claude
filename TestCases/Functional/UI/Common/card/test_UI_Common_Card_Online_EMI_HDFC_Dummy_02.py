...
def test_common_100_115_08_006():
    """
    Sub Feature Code: UI_Common_Card_Online_EMI_Success_Txn_For_Root_Org_With_MID3_TID3_Via_HDFC_Dummy_CreditCard_For_9_Months
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 08: ONLINE_EMI, 006: TC006
    """
    try:
        ...
        query = f"select * from terminal_info where emi_id=(select id from emi where org_code='{root_org_code}' and " \
                f"issuer_code='HDFC' and term='9 month' and card_type='CREDIT' and tid_type='CIB' and emi_type='NORMAL') and org_code='{org_code}'"
