...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_172():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMVCTLS_WITH_PIN_DEBIT_VISA
        Sub Feature Description:API that performs EMVCTLS With Pin Online Refund txn having DEBIT VISA card via ATOS_TLE
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_250():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMVCTLS_WITH_PIN_DEBIT_MASTER
        Sub Feature Description:API that performs EMVCTLS with pin Online Refund txn having DEBIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        250: TC250
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_251():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMVCTLS_WITH_PIN_DEBIT_RUPAY
        Sub Feature Description:API that performs EMVCTLS with pin Online Refund txn having DEBIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        251: TC251
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_237():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Online_Refund_EMVCTLS_WITH_PIN_CREDIT_MASTER
        Sub Feature Description:API that performs EMVCTLS with pin Online Refund txn having CREDIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        237: TC237
