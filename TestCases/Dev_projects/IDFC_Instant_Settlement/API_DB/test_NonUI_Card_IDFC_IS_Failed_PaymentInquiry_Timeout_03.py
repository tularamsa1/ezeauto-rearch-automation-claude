...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_122():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Failed_and_Inquiry_timeout_MSR_DEBIT_VISA
        Sub Feature Description: API that performs IS Failed and inquiry timeout on IS settlement for MSR DEBIT VISA card via IDFC_FDC
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_123():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Failed_and_Inquiry_timeout_MSR_DEBIT_MASTER
        Sub Feature Description: API that performs IS Failed and inquiry timeout on IS settlement for MSR MASTER_CARD VISA card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        123: TC123
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_124():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Failed_and_Inquiry_timeout_MSR_DEBIT_RUPAY
        Sub Feature Description: API that performs IS Failed and inquiry timeout on IS settlement for MSR RUPAY VISA card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        124: TC124
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_125():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Failed_and_Inquiry_timeout_MSR_CREDIT_VISA
        Sub Feature Description: API that performs IS Failed and inquiry timeout on IS settlement for MSR VISA CREDIT card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        125: TC125
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_126():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Failed_and_Inquiry_timeout_MSR_CREDIT_MASTER
        Sub Feature Description: API that performs IS Failed and inquiry timeout on IS settlement for MSR MASTER_CARD CREDIT card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        126: TC126
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_127():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Failed_and_Inquiry_timeout_MSR_CREDIT_RUPAY
        Sub Feature Description: API that performs IS Failed and inquiry timeout on IS settlement for MSR RUPAY CREDIT card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        127: TC127
