...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_124():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_Dummy_EMV_VISA_CreditCard_Without_Pin_417666
    Sub Feature Description:  Performing the EMV sale transaction via HDFC Dummy PG using VISA Credit card having
    16 digit PAN length without pin (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 124: TC124
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_125():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_Dummy_EMV_MASTER_CreditCard_Without_Pin_541333
    Sub Feature Description: Performing the EMV sale transaction via HDFC Dummy PG using MASTER Credit card having
    16 digit PAN length without pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 125: TC125
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_146():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_Dummy_EMVCTLS_RUPAY_DebitCard_Without_Pin_608326
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 146: TC146
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
