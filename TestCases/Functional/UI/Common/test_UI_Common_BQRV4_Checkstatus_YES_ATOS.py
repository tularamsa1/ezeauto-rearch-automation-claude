...
def test_common_100_102_061():
    """
    :Description: Verification of a BQRV4 Checkstatus Success via YES_ATOS
    :Sub Feature code: UI_Common_BQRV4_Checkstatus_Success_YES_ATOS
...
def test_common_100_102_070():
    ...
    :Sub Feature code: UI_Common_BQRV4_CheckStatus_Expired_YES_ATOS
...
def test_common_100_102_062():
    """
    :Description: Verification of a BQRV4 UPI Amount mismatch upon Checkstatus Success via YES_ATOS
    :Sub Feature code: UI_Common_BQRV4_UPI_Checkstatus_Amount_Mismatch_YES_ATOS
