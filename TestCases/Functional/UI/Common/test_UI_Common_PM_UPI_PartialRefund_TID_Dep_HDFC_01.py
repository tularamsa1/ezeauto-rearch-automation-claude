        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "device_serial": str(device_serial),
                    # "refund_device_serial": str(device_serial),
                    "err_msg": f"Transaction declined. Amount entered is more than maximum allowed for the transaction. Maximum Allowed: 100.00"
                }
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                expected_app_values = {
                    ...
                    "auth_code": auth_code,
                    "auth_code_2": partial_refund_auth_code_1,
                    "auth_code_3": partial_refund_auth_code_2,
                    "date": date_and_time,
                ...
                actual_app_values = {
                    ...
                    "rrn": str(app_rrn),
                    "rrn_2": str(app_rrn_partial_refund_1),
                    "rrn_3": str(app_rrn_partial_refund_2),
                    "auth_code": app_auth_code,
                    "auth_code_2": app_auth_code_partial_refund_1,
                    "auth_code_3": app_auth_code_partial_refund_2,
                    "date": app_date_and_time,
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                actual_api_values = {
                    ...
                    "auth_code_2": str(partial_refund_auth_code_api_1),
                    "auth_code_3": str(partial_refund_auth_code_api_2),
                    "date": date_time_converter.from_api_to_datetime_format(date_api_original),
        ...
        if (ConfigReader.read_config("Validations", "portal_validation")) == "True":
            ...
            try:
                ...
                actual_portal_values = {
                    ...
                    "auth_code_3" : refunded_auth_code
                }
                logger.debug(f"actual_portal_values : {actual_portal_values} for the testcase_id : {testcase_id}")
