...
def test_common_100_115_243():
    """
    Sub Feature Code: UI_Common_Card_Void_MASHREQ_EMV_VISA_DEBIT_476173
    Sub Feature Description:  Performing the EMV void transaction via MASHREQ PG using EMV VISA Debit card having 16 digit
     PAN length with pin (bin: 476173)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 243: TC243
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_244():
    """
    Sub Feature Code: UI_Common_Card_Void_MASHREQ_EMV_MASTER_DEBIT_222360
    Sub Feature Description:  Performing the EMV void transaction via MASHREQ PG using MASTER Debit card
    having 16 digit PAN length with pin (bin: 222360)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 244: TC244
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_245():
    """
    Sub Feature Code: UI_Common_Card_Void_MASHREQ_EMV_WITH_PIN_VISA_DEBIT_428090
    Sub Feature Description:  Performing the EMV void transaction via MASHREQ PG using EMV With Pin VISA Debit card
    having 16 digit PAN length with pin (bin: 428090)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 245: TC245
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_246():
    """
    Sub Feature Code: UI_Common_Card_Void_MASHREQ_CTLS_VISA_DEBIT_476173
    Sub Feature Description:  Performing the CTLS void transaction via MASHREQ PG using CTLS VISA Debit card having 16 digit
     PAN length without pin (bin: 476173)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 246: TC246
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_247():
    """
    Sub Feature Code: UI_Common_Card_Void_MASHREQ_CTLS_MASTER_DEBIT_222360
    Sub Feature Description:  Performing the CTLS void transaction via MASHREQ PG using CTLS MASTER Debit card
    having 16 digit PAN length without pin (bin: 222360)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 247: TC247
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
