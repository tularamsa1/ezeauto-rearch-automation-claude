...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_193():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Void_EMV_WITH_PIN_DEBIT_VISA
        Sub Feature Description: API that performs EMV with pin Void txn having DEBIT VISA card via ATOS_TLE
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_180():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Void_EMV_WITH_PIN_DEBIT_RUPAY
        Sub Feature Description: API that performs EMV With Pin Void txn having DEBIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        180: TC180
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_207():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Void_EMV_WITH_PIN_CREDIT_VISA
        Sub Feature Description: API that performs EMV with pin Void txn having CREDIT VISA card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        207: TC207
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_221():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Void_EMV_WITH_PIN_CREDIT_MASTER
        Sub Feature Description: API that performs EMV with pin Void txn having CREDIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        221: TC221
