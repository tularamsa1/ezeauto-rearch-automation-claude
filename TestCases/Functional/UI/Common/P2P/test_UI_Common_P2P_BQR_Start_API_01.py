...
from Utilities import Validator, ReportProcessor, ConfigReader, receipt_validator, ResourceAssigner, DBProcessor, \
...
def test_500_502_006():
    ...
    TC naming code description: 500: P2P, 502: BQR, 006: TC 006
    """
    try:
        ...
        logger.debug(f"Query result, device_serial : {device_serial}")
        ...
        logger.info(f"fetched terminal_info_id is : {db_bqr_terminal_info_id}")
        ...
        logger.debug(f"Response received for setting preconditions Autologin enabled is : {response}")
        ...
        try:
            ...
            if notifications.text == notification_mssg:
                ...
                raise Exception ("Could not find P2P connection notification")
            ...
            db_p2p_request_request_type = result['request_type'].values[0]
            db_p2p_request_payment_status = result['p2p_payment_status'].values[0]
            db_p2p_request_txn_id = result['transactionId'].values[0]
            # db_p2p_request_org_code = result['org_code'].values[0]
            # db_p2p_request_ext_ref = result['external_ref'].values[0]
            # db_p2p_request_amount = result['amount'].values[0]
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                txn_history_page.click_on_transaction_by_order_id(ext_ref_number)
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    "p2p_status": "RECEIVED",
                    "p2p_req_type": "INITIATE",
                    "p2p_txn_id": None,
                    "p2p_pmt_status": None,

                    "p2p_status_1": "COMPLETED",
                    "p2p_req_type_1": "INITIATE",
                    "p2p_txn_id_1": txn_id,
                    "p2p_pmt_status_1": "PAYMENT_INITIATED"
                ...
                db_p2p_request_request_type_1 = result['request_type'].values[0]
                db_p2p_request_txn_id_1 = result['transactionId'].values[0]
                db_p2p_request_payment_status_1 = result['p2p_payment_status'].values[0]
                # db_p2p_request_org_code_1 = result['org_code'].values[0]
                # db_p2p_request_amount_1 = result['amount'].values[0]
                # db_p2p_request_ext_ref_1 = result['external_ref'].values[0]
                ...
                actual_db_values = {
                    ...
                    "p2p_req_type": db_p2p_request_request_type,
                    "p2p_txn_id": db_p2p_request_txn_id,
                    "p2p_pmt_status": db_p2p_request_payment_status,

                    "p2p_status_1": db_p2p_request_status_1,
                    "p2p_req_type_1": db_p2p_request_request_type_1,
                    "p2p_txn_id_1": db_p2p_request_txn_id_1,
                    "p2p_pmt_status_1": db_p2p_request_payment_status_1
                }
