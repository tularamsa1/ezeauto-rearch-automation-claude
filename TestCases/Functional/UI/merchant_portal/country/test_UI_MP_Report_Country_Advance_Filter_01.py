...
def test_mp_700_701_041():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_order_number_as_country_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter order number logging in as Country Head
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_701_042():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Device_as_country_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter Device logging in as Country Head
    TC naming code description:
    700: Merchant Portal
    701: Country
    042: TC042
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and device_serial='" + device + "' order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_701_043():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_customer_mobile_number_as_country_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter Customer Mobile number when logging in as Country Head
    TC naming code description:
    700: Merchant Portal
    701: Country
    043: TC043
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and customer_mobile='" + cust_mob_no + "' order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_701_044():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_auth_code_as_country_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter auth code when logging in as Country Head
    TC naming code description:
    700: Merchant Portal
    701: Country
    044: TC044
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and auth_code='" + auth_code_api + "' order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_701_045():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_tid_as_country_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter tid when logging in as Country Head
    TC naming code description:
    700: Merchant Portal
    701: Country
    045: TC045
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and tid='" + tid_api + "' order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
