...
def test_mp_700_706_064():
    """
    Sub Feature Code: UI_MP_Profile_Info_as_City_head
    Sub Feature Description: Verifying Profile information by logging in and log out when logged in as City Head
