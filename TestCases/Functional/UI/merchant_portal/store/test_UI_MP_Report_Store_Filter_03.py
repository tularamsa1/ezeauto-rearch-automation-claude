...
def test_mp_700_708_033():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Voided_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Voided when logging in as Store Head
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and status='" + txn_status + "' and username IN ('"+txn_username+ "', '" + login_username + "') order by created_time asc limit 1;"
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_708_034():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Reversed_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Reversed when logging in as Store Head
    TC naming code description:
    700: Merchant Portal
    708: Store
    034: TC034
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_708_035():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Refund_pending_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Refund Pending when logging in as Store Head
    TC naming code description:
    700: Merchant Portal
    708: Store
    035: TC035
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_708_036():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Pre_Auth_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Pre Auth when logging in as Store Head
    TC naming code description:
    700: Merchant Portal
    708: Store
    036: TC036
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_708_037():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_REL_Pre_Auth_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status REL_Pre_Auth when logging in as Store Head
    TC naming code description:
    700: Merchant Portal
    708: Store
    037: TC037
