...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d103_103_020():
    """
    Sub Feature Code: UI_RP_UPI_Refund_Via_Api_KOTAK_OLIVE
    Sub Feature Description: Verification of a successful refund for Remote Pay UPI using api for KOTAK_OLIVE
    TC naming code description: d103: Dev Project[KOTAK_OLIVE_UPI], 103-> RP_UPI_COLLECT, 020->TC020
    """
    try:
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d103_103_021():
    """
    Sub Feature Code: UI_RP_UPI_Refund_Failed_Via_Api_KOTAK_OLIVE
    Sub Feature Description: Verification of a failed refund for Remote Pay UPI using api for KOTAK_OLIVE
    TC naming code description: d103: Dev Project[KOTAK_OLIVE_UPI], 103-> RP_UPI_COLLECT, 021->TC021
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
