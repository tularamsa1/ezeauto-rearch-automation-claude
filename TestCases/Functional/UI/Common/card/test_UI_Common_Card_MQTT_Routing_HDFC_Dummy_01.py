...
def test_common_100_115_10_001():
    ...
    try:
        ...
        logger.debug(f"Response received for setting preconditions when MQTT Routing is enabled: {response}")
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                txn_history_page.scroll_to_given_input_text("Send E-Receipt")
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                actual_api_values = {
                    ...
                    "date": date_time_converter.from_api_to_datetime_format(date_nd_time_api),
            ...
            try:
                ...
                for elements in response_in_list:
                    if elements["txnId"] == txn_id:
                        ...
                        logger.debug(f"Value of createdTime obtained from txnlist api : {date_and_time_api}")
                        device_serial_api = elements["deviceSerial"]
                        logger.debug(f"Value of deviceSerial obtained from txnlist api : {device_serial_api}")
                        username_api = elements["username"]
                        logger.debug(f"Value of username obtained from txnlist api : {username_api}")
