...
def test_mp_700_708_001():
    """
    Sub Feature Code: UI_MP_Dashboard_Sales_as_Store_head
    Sub Feature Description: Verifying Total sales, Total Txns and hierarchy details for Upper hierarchy when logging in as Store Head
