...
def test_common_100_115_015():
    """
    Sub Feature Code: UI_Common_Card_Void_HDFC_CTLS_WITH_PIN_RUPAY_DEBIT_608326
    Sub Feature Description:  Performing the EMV void transaction via HDFC PG using CTLS With Pin RUPAY Debit card
    having 16 digit PAN length with pin (bin: 608326)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 015: TC015
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_018():
    """
    Sub Feature Code: UI_Common_Card_Void_HDFC_CTLS_WITH_PIN_MASTER_CREDIT_541333
    ...
    TC naming code description:  100: Payment Method, 115: CARD_UI, 018: TC018
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
