...
def test_common_100_101_316():
    """
    Sub Feature Code: UI_Common_PM_UPI_CheckStatus_HDFC_Fractional_Amount
    Sub Feature Description: Performing UPI Successful txn with fractional amount Via CheckStatus API for HDFC pg
    TC naming code description: 100: Payment Method, 101: UPI, 316: TC316
    """
    try:
        ...
        try:
            ...
            amount = round(random.uniform(201, 1000), 2)
...
@pytest.mark.portalVal
@pytest.mark.chargeSlipVal
def test_common_100_101_318():
    """
    Sub Feature Code: UI_Common_PM_UPI_CheckStatus_KOTAK_WL_Fractional_Amount
    Sub Feature Description: Performing UPI Successful txn with fractional amount Via CheckStatus API for KOTAK_WL pg
    TC naming code description: 100: Payment Method, 101: UPI, 318: TC318
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.portalVal
@pytest.mark.chargeSlipVal
def test_common_100_101_320():
    """
    Sub Feature Code: UI_Common_PM_UPI_CheckStatus_AXIS_DIRECT_Fractional_Amount
    Sub Feature Description: Performing UPI Successful txn with fractional amount Via CheckStatus API for AXIS_DIRECT pg
    TC naming code description: 100: Payment Method, 101: UPI, 320: TC320
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
