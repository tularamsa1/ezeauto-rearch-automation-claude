    ...
    try:
        ...
        try:
            ...
            api_details = DBProcessor.get_api_details('callbackgeneratorUpiICICI', request_body={
                ...
                "BankRRN":rrn, "merchantTranId": str(txn_id), "PayerVA": customer_vpa})
            response = APIProcessor.send_request(api_details)
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "txn_amt": float(mismatch_amount), "pmt_mode": "UPI",
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    "ipr_pg_merchant_id": upi_pg_merchant_id,
                }
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d102_102_040():
    """
    Sub Feature Code: NonUI_Common_BQRV4_UPI_ICICI_Direct_UPG_Success_Amt_mismatch_Upg_Autorefund_enabled
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d102_102_041():
    """
    Sub Feature Code: NonUI_Common_BQRV4_UPI_ICICI_Direct_UPG_Failed_Upg_Autorefund_disabled
    Sub Feature Description: Generate QR through api and perform upg Failed for BQRV4 UPI amount mismatch of ICICI_Direct pg
    TC naming code description:d102->Dev Project[ICICI_DIRECT_UPI], 102-> BQRV4 UPI, 041->TC041
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_d102_102_042():
    ...
    try:
        ...
        try:
            ...
            customer_vpa = 'hello123@upi'
            logger.debug(f"Fetching txn_id from the API_OUTPUT, Txn_id : {txn_id_tampered}")

            api_details = DBProcessor.get_api_details('callbackgeneratorUpiICICI', request_body={
                "merchantId": mid, "subMerchantId": mid, "terminalId":tid, "PayerAmount": str(amount),
                "BankRRN":rrn, "merchantTranId": str(txn_id_tampered), "PayerVA": customer_vpa})
            response = APIProcessor.send_request(api_details)
            logger.debug(f"response received for callback generator api is : {response}")
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d102_102_043():
    """
    Sub Feature Code: NonUI_Common_BQRV4_UPI_ICICI_Direct_UPG_Success_Upg_Autorefund_enabled
    ...
    TC naming code description:d102->Dev Project[ICICI_DIRECT_UPI], 102-> BQRV4 UPI, 043->TC043
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d102_102_044():
    """
    Sub Feature Code: NonUI_Common_BQRV4_UPI_ICICI_Direct_UPG_Refund_Success
    Sub Feature Description: Generate QR through api and perform upg refund for BQRV4 UPI of ICICI_Direct pg
    TC naming code description:d102->Dev Project[ICICI_DIRECT_UPI], 102-> BQRV4 UPI, 044->TC044
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "txn_amt_2": float(mismatch_amount), "pmt_mode_2": "UPI",
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    "pmt_mode_2": "UPI",
                    "txn_amt_2": float(mismatch_amount),
                    "settle_status_2": "SETTLED",
                    "txn_type_2": "REFUND",
                    "acquirer_code_2": "ICICI",
                    "bank_code_2": None,
