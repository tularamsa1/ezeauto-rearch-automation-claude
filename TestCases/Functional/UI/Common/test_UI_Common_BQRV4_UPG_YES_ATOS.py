...
def test_common_100_102_066():
    """
    :Description: Verification of a BQRV4 UPI UPG txn when Auto refund is enabled via YES_ATOS
    :Sub Feature code: UI_Common_BQRV4_UPI_UPG_AUTOREFUND_ENABLED_YES_ATOS
...
def test_common_100_102_067():
    """
    :Description: Verification of a BQRV4 UPI UPG txn when Auto refund is disabled via YES_ATOS
    :Sub Feature code: UI_Common_BQRV4_UPI_UPG_AUTOREFUND_DISABLED_YES_ATOS
...
def test_common_100_102_068():
    ...
    :Sub Feature code: UI_Common_BQRV4_UPG_Refund_Via_API_YES_ATOS
