...
def test_common_100_115_239():
    """
    Sub Feature Code: UI_Common_Card_Sale_MASHREQ_EMV_MASTER_CreditCard_With_Pin_541333
    Sub Feature Description: Performing the EMV sale transaction via MASHREQ PG using MASTER Credit card having 16 digit PAN length with pin (bin: 541333)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 239: TC239
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_240():
    """
    Sub Feature Code: UI_Common_Card_Sale_MASHREQ_CTLS_VISA_CREDIT_417666
    Sub Feature Description:  Performing the EMV sale transaction via MASHREQ PG using CTLS VISA Credit card
    having 16 digit PAN length with pin (bin: 417666)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 240: TC240
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_241():
    """
    Sub Feature Code: UI_Common_Card_Sale_MASHREQ_CTLS_MASTER_CREDIT_541333
    Sub Feature Description:  Performing the EMV sale transaction via MASHREQ PG using CTLS MASTER Credit card
    having 16 digit PAN length with pin (bin: 541333)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 241: TC241
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_242():
    """
    Sub Feature Code: UI_Common_Card_Sale_MASHREQ_CTLS_WITH_PIN_MASTER_CREDIT_541333
    Sub Feature Description:  Performing the EMV sale transaction via MASHREQ PG using CTLS with pin MASTER Credit card
    having 16 digit PAN length with pin (bin: 541333)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 242: TC242
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
