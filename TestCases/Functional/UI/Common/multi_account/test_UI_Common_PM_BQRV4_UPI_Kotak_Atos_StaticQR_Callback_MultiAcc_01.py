...
def test_common_100_113_009():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_StaticQR_Callback_Success_Via_KOTAK_ATOS_MultiAcc_ActiveLabel
    ...
    TC naming code description: 100: Payment method, 113: MultiAcc_StaticQR, 009: Testcase ID
    """
    try:
        ...
        try:
            ...
            # Performing BQRV4_UPI callback for Kotak Atos Static QR
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    "resp_code": "SUCCESS",
                    "txn_type": "STATIC_QR",
                    "acc_label_id": str(upi_acc_label_id),
                }
...
@pytest.mark.portalVal
@pytest.mark.chargeSlipVal
def test_common_100_113_010():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_StaticQR_Callback_Success_Via_KOTAK_ATOS_MultiAcc_InactiveLabel
    Sub Feature Description: Multi Account - Verifying a bqrv4 upi success callback via Kotak Atos static qr
    when label is inactive
    TC naming code description: 100: Payment method, 113: MultiAcc_StaticQR, 010: Testcase ID
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
