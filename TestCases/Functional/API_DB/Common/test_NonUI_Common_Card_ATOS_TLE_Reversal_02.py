...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_194():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Reversal_EMV_WITH_PIN_DEBIT_VISA
        Sub Feature Description:API that performs EMV with pin Reversal txn having DEBIT VISA card via ATOS_TLE
    ...
    try:
        ...
        try:
            ...
            card_details = card_processor.get_card_details_from_excel("EMV_WITH_PIN_DEBIT_VISA")
            api_details = DBProcessor.get_api_details('Card_api',
                                                      request_body={"deviceSerial": merchant_creator.get_device_serial_of_merchant(org_code=org_code,acquisition="AXIS",payment_gateway="ATOS_TLE"),
                ...
                if reversal_success == True:
                    expectedAPIValues = {"success": True, "txn_amt": float(original_amount), "pmt_mode":"CARD",
                                        ...
                                        "pmt_state":"REVERSED", "settle_status": "SETTLED",
                                         "pmt_card_bin":bin_no,
                                         "pmt_card_brand":"VISA", "pmt_card_type":"DEBIT", "card_txn_type":"EMV with PIN",
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_181():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Reversal_EMV_WITH_PIN_DEBIT_RUPAY
        Sub Feature Description:API that performs EMV with pin Reversal txn having DEBIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        181: TC181
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"Execution Timer started in testcase function : {testcase_id}")
            original_amount = random.randint(10,1000)
            card_details = card_processor.get_card_details_from_excel("EMV_WITH_PIN_DEBIT_RUPAY")
            api_details = DBProcessor.get_api_details('Card_api',
                                                      request_body={"deviceSerial": merchant_creator.get_device_serial_of_merchant(org_code=org_code,acquisition="AXIS",payment_gateway="ATOS_TLE"),
                                                                    "username":app_username,
                                                                    "password":app_password,
            ...
            try:
                if reversal_success == True:
                    expectedAPIValues = {"success": True, "txn_amt": float(original_amount), "pmt_mode":"CARD",
                                        ...
                                        "pmt_state":"REVERSED", "settle_status": "SETTLED",
                                         "pmt_card_bin":bin_no,
                                         "pmt_card_brand":"RUPAY", "pmt_card_type":"DEBIT", "card_txn_type":"EMV with PIN",
                                         "txn_type":"CHARGE", "acq_code":"AXIS"}
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_208():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Reversal_EMV_WITH_PIN_CREDIT_VISA
        Sub Feature Description:API that performs EMV with pin Reversal txn having CREDIT VISA card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        208: TC208
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"Execution Timer started in testcase function : {testcase_id}")
            original_amount = random.randint(10,1000)
            card_details = card_processor.get_card_details_from_excel("EMV_WITH_PIN_CREDIT_VISA")
            api_details = DBProcessor.get_api_details('Card_api',
                                                      request_body={"deviceSerial": merchant_creator.get_device_serial_of_merchant(org_code=org_code,acquisition="AXIS",payment_gateway="ATOS_TLE"),
                                                                    "username":app_username,
                                                                    "password":app_password,
            ...
            try:
                if reversal_success == True:
                    expectedAPIValues = {"success": True, "txn_amt": float(original_amount), "pmt_mode":"CARD",
                                        ...
                                        "pmt_state":"REVERSED", "settle_status": "SETTLED",
                                         "pmt_card_bin":bin_no,
                                         "pmt_card_brand":"VISA", "pmt_card_type":"CREDIT", "card_txn_type":"EMV with PIN",
                                         "txn_type":"CHARGE", "acq_code":"AXIS"}
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_222():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Reversal_EMV_WITH_PIN_CREDIT_MASTER
        Sub Feature Description:API that performs EMV with pin Reversal txn having CREDIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        222: TC222
    ...
    try:
        ...
        try:
            ...
            logger.debug(f"Execution Timer started in testcase function : {testcase_id}")
            original_amount = random.randint(10,1000)
            card_details = card_processor.get_card_details_from_excel("EMV_WITH_PIN_CREDIT_MASTER")
            api_details = DBProcessor.get_api_details('Card_api',
                                                      request_body={"deviceSerial": merchant_creator.get_device_serial_of_merchant(org_code=org_code,acquisition="AXIS",payment_gateway="ATOS_TLE"),
                                                                    "username":app_username,
                                                                    "password":app_password,
            ...
            try:
                if reversal_success == True:
                    expectedAPIValues = {"success": True, "txn_amt": float(original_amount), "pmt_mode":"CARD",
                                        ...
                                        "pmt_state":"REVERSED", "settle_status": "SETTLED",
                                         "pmt_card_bin":bin_no,
                                         "pmt_card_brand":"MASTER_CARD", "pmt_card_type":"CREDIT", "card_txn_type":"EMV with PIN",
                                         "txn_type":"CHARGE", "acq_code":"AXIS"}
