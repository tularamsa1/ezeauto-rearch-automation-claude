...
def test_common_100_115_07_069():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_Payback_by_Brand_Fixed_Success_Txn_For_An_Org_HDFC_Dummy_AU_EMV_VISA_CreditCard_With_Pin_417666_For_3_Months_Tenure
    Sub Feature Description: Performing the brand EMI payback by Brand fixed success transaction for an org (not ezetap)
    via HDFC Dummy PG for AU issuer using EMV VISA Credit card with pin for 3 months tenure (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 069: TC069
    """
    try:
        ...
        testsuite_teardown.update_bin_info(bin_number='417666', bank_code='AU', bank='AU')
        ...
        query = f"select * from subvention_plan where brand_id='{brand_id}' and org_code='{org_code}' and card_type= 'CREDIT' and bank='AU' and eze_emi_enabled=b'0';"
