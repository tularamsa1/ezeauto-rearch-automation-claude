...
def test_common_100_115_192():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_EMV_VISA_DebitCard_Without_Pin_476173
    Sub Feature Description: Performing the EMV sale transaction via HDFC PG using VISA Debit card having 16 digit PAN length without pin (bin: 476173)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 192: TC192
    """
    try:
        ...
        if str(ConfigReader.read_config("ParallelExecution", "deviceOnly")).lower() == 'true':
            ...
            app_driver = TestSuiteSetup.initialize_app_driver(request=testcase_id, no_reset=True)
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_193():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_EMV_MASTER_DebitCard_Without_Pin_222360
    Sub Feature Description: Performing the EMV sale transaction via HDFC PG using MASTER Debit card having 16 digit PAN length without pin(bin: 222360)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 193: TC193
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_194():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_EMV_RUPAY_DebitCard_Without_Pin_608326
    Sub Feature Description: Performing the EMV sale transaction via HDFC PG using RUPAY Debit card having 16 digit PAN length without pin(bin: 608326)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 194: TC194
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_195():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_EMV_VISA_DebitCard_With_Pin_428090
    Sub Feature Description: Performing the EMV sale transaction via HDFC PG using VISA Debit card having 16 digit PAN length with pin(bin: 428090)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 195: TC195
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_196():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_EMV_RUPAY_DebitCard_With_Pin_608326
    Sub Feature Description: Performing the EMV sale transaction via HDFC PG using RUPAY Debit card having 16 digit PAN length with pin(bin: 608326)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 196: TC196
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        try:
            ...
            card_page.select_cardtype("EMV_WITH_PIN_RUPAY_DEBIT_608326")
