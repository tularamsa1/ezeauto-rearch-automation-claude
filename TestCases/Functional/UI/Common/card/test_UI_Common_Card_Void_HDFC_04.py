...
def test_common_100_115_188():
    """
    Sub Feature Code: UI_Common_Card_Void_HDFC_EMV_WITH_PIN_RUPAY_DEBIT_608326
    Sub Feature Description:  Performing the EMV void transaction via HDFC PG using With Pin RUPAY Debit card
    having 16 digit PAN length with pin (bin: 608326)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 188: TC188
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_189():
    """
    Sub Feature Code: UI_Common_Card_Void_HDFC_EMV_VISA_CREDIT_417666
    Sub Feature Description:  Performing the EMV void transaction via HDFC PG using VISA Credit card
    having 16 digit PAN length with pin (bin: 417666)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 189: TC189
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_190():
    """
    Sub Feature Code: UI_Common_Card_Void_HDFC_EMV_MASTER_CREDIT_541333
    Sub Feature Description:  Performing the EMV void transaction via HDFC PG using MASTER Credit card
    having 16 digit PAN length with pin (bin: 541333)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 190: TC190
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_191():
    """
    Sub Feature Code: UI_Common_Card_Void_HDFC_EMV_WITH_PIN_MASTER_CREDIT_541333
    Sub Feature Description:  Performing the EMV void transaction via HDFC PG using with pin MASTER Credit card
    having 16 digit PAN length with pin (bin: 541333)
    TC naming code description:  100: Payment Method, 115: CARD_UI, 191: TC191
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
