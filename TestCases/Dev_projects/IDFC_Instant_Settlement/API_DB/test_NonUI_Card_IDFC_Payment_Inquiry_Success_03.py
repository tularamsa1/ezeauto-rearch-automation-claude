...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_D100_D101_050():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_Success_Inquiry_Instant_Settlement_MSR_DEBIT_VISA
        Sub Feature Description: API that performs success inquiry on IS settlement when IS call is Timeout for MSR DEBIT VISA card via IDFC_FDC
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_D100_D101_051():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_Success_Inquiry_Instant_Settlement_MSR_DEBIT_MASTER
        Sub Feature Description: API that performs success inquiry on IS settlement when IS call is Timeout for MSR MASTER_CARD VISA card via IDFC_FDC
        TC naming code description:
        D100: Dev Projects
        D101: IDFC Instant Settlement
        051: TC051
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_D100_D101_052():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_Success_Inquiry_Instant_Settlement_MSR_DEBIT_RUPAY
        Sub Feature Description: API that performs success inquiry on IS settlement when IS call is Timeout for MSR RUPAY VISA card via IDFC_FDC
        TC naming code description:
        D100: Dev Projects
        D101: IDFC Instant Settlement
        052: TC052
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_D100_D101_053():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_Success_Inquiry_Instant_Settlement_MSR_CREDIT_VISA
        Sub Feature Description: API that performs success inquiry on IS settlement when IS call is Timeout for MSR VISA CREDIT card via IDFC_FDC
        TC naming code description:
        D100: Dev Projects
        D101: IDFC Instant Settlement
        053: TC053
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_D100_D101_054():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_Success_Inquiry_Instant_Settlement_MSR_CREDIT_MASTER
        Sub Feature Description: API that performs success inquiry on IS settlement when IS call is Timeout for MSR MASTER_CARD CREDIT card via IDFC_FDC
        TC naming code description:
        D100: Dev Projects
        D101: IDFC Instant Settlement
        054: TC054
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_D100_D101_055():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_Success_Inquiry_Instant_Settlement_MSR_CREDIT_RUPAY
        Sub Feature Description: API that performs success inquiry on IS settlement when IS call is Timeout for MSR RUPAY CREDIT card via IDFC_FDC
        TC naming code description:
        D100: Dev Projects
        D101: IDFC Instant Settlement
        055: TC055
