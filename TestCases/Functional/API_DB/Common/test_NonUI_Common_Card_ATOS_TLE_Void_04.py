...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_170():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Void_EMVCTLS_WITH_PIN_DEBIT_VISA
        Sub Feature Description: API that performs EMVCTLS with Pin Void txn having DEBIT VISA card via ATOS_TLE
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_246():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Void_EMVCTLS_WITH_PIN_DEBIT_MASTER
        Sub Feature Description: API that performs EMVCTLS with pin Void txn having DEBIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        246: TC246
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_247():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Void_EMVCTLS_WITH_PIN_DEBIT_RUPAY
        Sub Feature Description: API that performs EMVCTLS with pin Void txn having DEBIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        247: TC247
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_235():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Void_EMVCTLS_WITH_PIN_CREDIT_MASTER
        Sub Feature Description: API that performs EMVCTLS with pin Void txn having CREDIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        235: TC235
