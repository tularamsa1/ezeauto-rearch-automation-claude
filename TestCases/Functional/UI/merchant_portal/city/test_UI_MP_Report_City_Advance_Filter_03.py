...
def test_mp_700_706_051():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_VISACardBrand_as_City_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter VISACardBrand when logged in as City Head
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id " \
                    "BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_card_brand='" + card_brand_search_value + "' and username NOT IN ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + taluk_username + "', '" + district_username + "') order by created_time asc limit 1;"
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_706_052():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_MASTERCardBrand_as_City_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter MASTERCardBrand when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    052: TC052
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_706_053():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_RUPAYCardBrand_as_City_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter RUPAYCardBrand when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    053: TC053
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_706_054():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_ALL_CardBrand_as_City_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for ALL CardBrand when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    054: TC054
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_706_055():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_Cash_as_City_head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode Cash when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    055: TC055
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id " \
                    "BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_mode ='" + pmt_mode_search_value + "' and username NOT IN ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + taluk_username + "', '" + district_username + "') order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_txn_id_last = result['id'].values[0]
            logger.debug(f"txn_id from db : {db_txn_id_last}")
