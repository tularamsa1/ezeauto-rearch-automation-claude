...
def test_common_100_109_003():
    """
    Sub Feature Code: UI_Common_PM_UPI_Success_Via_Pure_UPI_Success_Callback_MultiAcc_HDFC
    Sub Feature Description: Multi Account - Performing a UPI Authorized Txn using pure UPI Success callback for HDFC
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 003: TC003
    """
    try:
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_109_004():
    """
    Sub Feature Code: UI_Common_PM_UPI_Failed_Via_Pure_UPI_Failed_Callback_MultiAcc_HDFC
    Sub Feature Description: Multi Account - Performing a UPI Failed Txn using pure UPI Failed callback for HDFC
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 004: TC004
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
