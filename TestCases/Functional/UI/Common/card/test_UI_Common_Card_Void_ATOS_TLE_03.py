...
def test_common_100_115_175():
    """
    Sub Feature Code: UI_Common_Card_Void_ATOS_TLE_EMV_VISA_DebitCard_With_Pin_428090
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 175: TC175
    """
    try:
...
def test_common_100_115_176():
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 176: TC176
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_177():
    """
    Sub Feature Code: UI_Common_Card_Void_ATOS_TLE_EMV_VISA_CreditCard_With_Pin_417666
    Sub Feature Description:  Performing the EMV Void transaction via ATOS_TLE PG using Visa Credit card having
     16 digit PAN length with pin (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 177: TC177
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_178():
    """
    Sub Feature Code: UI_Common_Card_Void_ATOS_TLE_EMV_MASTER_DebitCard_Without_Pin_222360
    Sub Feature Description:  Performing the EMV Void transaction via ATOS_TLE PG using MASTER Debit card having
     16 digit PAN length without pin (bin: 222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 178: TC178
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_179():
    """
    Sub Feature Code: UI_Common_Card_Void_ATOS_TLE_EMV_MASTER_CreditCard_Without_Pin_541333
    Sub Feature Description:  Performing the EMV Void transaction via ATOS_TLE PG using MASTER Credit card having
     16 digit PAN length without pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 179: TC179
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
