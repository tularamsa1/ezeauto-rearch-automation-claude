...
def test_mp_700_705_002():
    """
    Sub Feature Code: UI_MP_Calender_txn_for_This_Week_as_Taluk_head
    Sub Feature Description: Verifying sales over with previous comparision for This Week calender dates when logging in as Taluk Head
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where id between '" + previous_week_sale_start_date + "' AND '" + \
                    previous_week_sale_end_date + "' and org_code='" + org_code + "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') and status = 'AUTHORIZED';"
            ...
            query = "select sum(amount) from txn where id between '" + this_week_start_date + "' AND '"\
                    + this_week_end_date + "' and org_code='" + org_code + "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') and status = 'AUTHORIZED';"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_705_003():
    """
    Sub Feature Code: UI_MP_Calender_txn_for_This_Month_as_Taluk_head
    Sub Feature Description: Verifying sales over with previous comparision for This Month calender dates when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    003: TC003
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where id between '" + previous_month_sale_start_date + "' AND '" + \
                    previous_month_sale_end_date + "' and org_code='" + org_code + "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') and status = 'AUTHORIZED';"
            ...
            query = "select sum(amount) from txn where id between '" + this_month_start_date + "' AND '" \
                    + this_month_end_date + "' and org_code='" + org_code + "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') and status = 'AUTHORIZED';"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_705_004():
    """
    Sub Feature Code: UI_MP_Calender_txn_for_Last_30_days_as_Taluk_head
    Sub Feature Description: Verifying sales over with previous comparision for last 30 days calender dates when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    004: TC004
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where id between '" + previous_last_30_days_sale_start_date + "' AND '" + \
                    previous_last_30_days_sale_end_date + "' and org_code='" + org_code + "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') and status = 'AUTHORIZED';"
            ...
            query = "select sum(amount) from txn where id between '" + last_30_days_start_date + "' AND '" \
                    + last_30_days_end_date_1 + "' and org_code='" + org_code + "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') and status = 'AUTHORIZED';"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_705_005():
    """
    Sub Feature Code: UI_MP_Calender_txn_for_Last_90_days_as_Taluk_head
    Sub Feature Description: Verifying sales over with previous comparision converting to weeks  for last 90 days calender dates  when logging in as Taluk Head
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where (id between '" + previous_last_90_days_sale_start_date + "' AND '" + \
                    last_90_days_start_date + "') and org_code='" + org_code + "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') and status = 'AUTHORIZED';"
            ...
            query = "select sum(amount) from txn where (id between '" + last_90_days_start_date + "' AND '" \
                    + last_90_days_end_date_1 + "') and org_code='" + org_code + "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') and status = 'AUTHORIZED';"
