...
DB_SERVICE_FEE_JSON_PATH = os.path.join(DATAPROVIDER_DIR,'service_fee.json')
...
ALL_USER_ROLES = ["ROLE_CLADMIN","ROLE_CLAGENT","ROLE_CLAGENT_REFUND","ROLE_CLPROMO","ROLE_ORG_MANAGER","ROLE_CLAGENTPORTAL","ROLE_TAG_ADMIN","ROLE_CLAGENTVOID","ROLE_CLREFUND"]
CASHIER_USER_ROLES = ["ROLE_CLAGENT", "ROLE_CLAGENTPORTAL"]
