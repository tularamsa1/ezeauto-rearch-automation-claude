...
def test_mp_700_708_020():
    """
    Sub Feature Code: UI_MP_Report_for_Daily_txn_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Daily quick Filter when logging in as Store Head
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and username IN ('"+txn_username+ "', '" + login_username + "') order by created_time asc limit 1;"
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_708_021():
    """
    Sub Feature Code: UI_MP_Report_for_Monthly_txn_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using Monthly quick Filter when logging in as Store Head
    TC naming code description:
    700: Merchant Portal
    708: Store
    021: TC021
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_708_022():
    """
    Sub Feature Code: UI_MP_Report_for_Weekly_txn_as_Store_head
    Sub Feature Description: Verifying txn details on Report Page using weekly quick Filter when logging in as Store Head
    TC naming code description:
    700: Merchant Portal
    708: Store
    022: TC022
