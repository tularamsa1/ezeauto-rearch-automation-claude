...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_199():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Reversal_EMV_WITH_PIN_DEBIT_VISA
        Sub Feature Description:API that performs EMV with pin Reversal txn having DEBIT VISA card via HDFC
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_185():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Reversal_EMV_WITH_PIN_DEBIT_RUPAY
        Sub Feature Description:API that performs EMV with pin Reversal txn having DEBIT RUPAY card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        185: TC185
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_213():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Reversal_EMV_WITH_PIN_CREDIT_VISA
        Sub Feature Description:API that performs EMV Reversal txn having CREDIT VISA card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        213: TC213
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_227():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Reversal_EMV_WITH_PIN_CREDIT_MASTER
        Sub Feature Description:API that performs EMV with pin Reversal txn having CREDIT MASTER card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        227: TC227
