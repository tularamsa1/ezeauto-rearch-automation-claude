...
def test_mp_700_705_028():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Authorised_as_Taluk_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Authorised when logging in as Taluk Head
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_705_029():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Failed_as_Taluk_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Failed when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    029: TC029
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_705_030():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Pending_as_Taluk_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Pending when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    030: TC030
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_705_031():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Authorised_refunded_as_Taluk_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Authorised_refunded when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    031: TC031
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_705_032():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_refunded_as_Taluk_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status refunded when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    032: TC032
