...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_121():
    """
        Sub Feature Code: NonUI_Common_FDC_Card_Online_Refund_EMV_DEBIT_VISA
        Sub Feature Description:API that performs EMV Online Refund txn having DEBIT VISA card via FDC
