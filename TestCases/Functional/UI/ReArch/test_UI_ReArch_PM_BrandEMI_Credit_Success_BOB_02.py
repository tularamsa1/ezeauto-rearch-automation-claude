...
def test_common_rearch_0053():
    ...
    Sub Feature Description:
        ...
        verify breakup (Item Price ₹8,000, Instant Discount -₹500,
        Order Total ₹7,500, Interest +₹150.51, Total ₹7,650.51),
        enter random 6-digit IMEI, proceed through card type selection
        (Visa Credit EMV), verify success, then validate via App, API,
        and Charge Slip.
    ...
    NL Source Steps:
      ...
      Test Steps:
        ...
        13. verify Item Price=₹8,000, Instant Discount=-₹500, Order Total=₹7,500,
            Interest=+₹150.51, Total Amount=₹7,650.51
    ...
    try:
        ...
        try:
            ...
            # Step 11: Click 3-month tenure (BOB, amount=8000)
            emi_page.click_bob_3m_plan_8000()
            logger.debug("BOB 3-month EMI plan selected (8000)")
        ...
        if ConfigReader.read_config("Validations", "app_validation") == "True":
            ...
            try:
                ...
                expected_breakup_values = {
                    ...
                    "order_total": "\u20b97,500",
                    "interest_charged": "+\u20b9150.51",
                    "total_amount": "\u20b97,650.51",
                }
                ...
                app_txn_status = txn_detail_page.fetch_status("7,500.00")
                app_date_time  = txn_detail_page.fetch_date_time()
                app_amount     = txn_detail_page.fetch_amount("7,500.00")
                logger.info(
        ...
        if ConfigReader.read_config("Validations", "api_validation") == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "txn_amt":       7500.0,  # TODO: verify if txn_amt is 8000 or 7500 (after instant discount)
