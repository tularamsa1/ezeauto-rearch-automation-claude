...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d103_103_022():
    """
    Sub Feature Code: UI_RP_UPI_Partial_Refund_Via_Api_KOTAK_OLIVE
    Sub Feature Description: Verification of a successful partial refund for Remote Pay UPI using api for KOTAK_OLIVE
