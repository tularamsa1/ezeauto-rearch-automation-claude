...
def test_common_100_115_07_190():
    """
        Sub Feature Code: UI_Common_Card_Brand_EMI_Cashback_by_Band_Percentage_Success_Txn_For_An_Org_HDFC_Dummy_EMV_VISA_CreditCard_Without_Pin_417666_For_3_Months_Tenure
        Sub Feature Description: Performing the brand EMI cashback by brand percentage success transaction for an org via HDFC Dummy PG using EMV VISA Credit card with pin for 3 months tenure (bin: 417666)
        TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand EMI, 190: TC190
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "charge_slip_validation")) == "True":
            ...
            try:
                ...
                expected_charge_slip_values = {
                    ...
                    "CARD": f"XXXX-XXXX-XXXX-0029 EMV",
                    "CARD TYPE": "VISA",
                    ...
                    "unnamed_section_text": "L3TEST/CARD0002 I agree to pay as per the card issuer agreement.",
                }
