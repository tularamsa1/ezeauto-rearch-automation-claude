...
def test_common_200_202_006():
    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                    expectedAPIValues = {"success": False, "username": Ezewallet_processor.agent_user,
...
def test_common_200_202_010():
    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                if cash_payment_success == True:
                    expectedAPIValues = {"success": True, "username": Ezewallet_processor.agent_user, "txn_amt": (original_amount_cashpay+0.25), "pmt_status":"AUTHORIZED",
