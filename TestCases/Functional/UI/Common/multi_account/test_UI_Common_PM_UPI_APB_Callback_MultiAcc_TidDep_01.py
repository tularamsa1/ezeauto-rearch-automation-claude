...
def test_common_100_109_019():
    """
    Sub Feature Code: UI_Common_PM_UPI_Success_Via_Pure_UPI_Success_Callback_MultiAcc_TidDep_APB
    Sub Feature Description: Multi Account Tid Dep - Performing a UPI Authorized Txn using pure UPI Success callback for
    APB PG
...
def test_common_100_109_020():
    """
    Sub Feature Code: UI_Common_PM_UPI_Failed_Via_Pure_UPI_Failed_Callback_MultiAcc_TidDep_APB
