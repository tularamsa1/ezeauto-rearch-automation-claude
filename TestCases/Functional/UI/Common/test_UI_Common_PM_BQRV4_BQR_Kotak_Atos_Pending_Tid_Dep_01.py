...
def test_common_100_102_271():
    """
    Sub Feature Code: Tid Dep - UI_Common_PM_BQRV4_BQR_Pending_Via_KOTAK_ATOS
    Sub Feature Description: Tid Dep - Verification of BQRV4 BQR pending txn via KOTAK_ATOS
