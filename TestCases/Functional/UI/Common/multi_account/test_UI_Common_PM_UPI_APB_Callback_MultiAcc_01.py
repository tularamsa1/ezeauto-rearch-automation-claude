...
def test_common_100_109_010():
    """
    Sub Feature Code: UI_Common_PM_UPI_Success_Via_Pure_UPI_Success_Callback_MultiAcc_APB
    Sub Feature Description: Multi Account - Performing a Authorized Txn using pure UPI Success callback for APB
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 010: TC010
    """
    try:
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_109_011():
    """
    Sub Feature Code: UI_Common_PM_UPI_Failed_Via_Pure_UPI_Failed_Callback_MultiAcc_APB
    Sub Feature Description: Multi Account - Performing a Failed Txn using pure UPI Failed callback for APB
    TC naming code description: 100: Payment Method, 109: MultiAcc_UPI, 011: TC011
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
