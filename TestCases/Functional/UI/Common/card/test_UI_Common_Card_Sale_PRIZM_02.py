...
def test_common_100_115_068():
    """
    Sub Feature Code: UI_Common_Card_Sale_PRIZM_EMVCTLS_RUPAY_DebitCard_Without_Pin_608326
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 068: TC068
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_069():
    """
    Sub Feature Code: UI_Common_Card_Sale_PRIZM_EMVCTLS_MASTER_CreditCard_With_Pin_541333
    Sub Feature Description: Performing the EMVCTLS sale transaction via PRIZM PG using MASTER Credit card having
    16 digit PAN length with pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 069: TC069
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_070():
    """
    Sub Feature Code: UI_Common_Card_Sale_PRIZM_EMVCTLS_VISA_CreditCard_Without_Pin_417666
    Sub Feature Description: Performing the EMVCTLS sale transaction via PRIZM PG using VISA Credit card having
    16 digit PAN length without pin (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 070: TC070
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_071():
    """
    Sub Feature Code: UI_Common_Card_Sale_PRIZM_EMVCTLS_MASTER_CreditCard_Without_Pin_541333
    Sub Feature Description: Performing the EMVCTLS sale transaction via PRIZM PG using MASTER Credit card having
    16 digit PAN length without pin  (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 071: TC071
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_164():
    """
    Sub Feature Code: UI_Common_Card_Sale_PRIZM_EMV_MASTER_CreditCard_Without_Pin_541333
    Sub Feature Description: Performing the EMV sale transaction via PRIZM PG using MASTER Credit card having
    16 digit PAN length without pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 164: TC164
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
