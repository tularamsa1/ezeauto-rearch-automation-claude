...
def test_common_100_102_268():
    """
    Sub Feature Code: Tid Dep - UI_Common_PM_BQRV4_UPI_Amount_Mismatch_Via_BQRV4_UPI_Success_Callback_KOTAK_ATOS
    Sub Feature Description: Tid Dep - Performing a amount mismatch using pure bqrv4 upi success callback via KOTAK_ATOS
...
def test_common_100_102_269():
    """
    Sub Feature Code: Tid Dep – UI_Common_PM_BQRV4_UPI_UPG_AUTHORIZED_KOTAK_ATOS
    Sub Feature Description: Tid Dep – Verification of a upg authorized txn using BQRV4 UPI Success Callback via Kotak_ATOS
