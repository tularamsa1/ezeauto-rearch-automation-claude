    ...
    try:
        ...
        if ConfigReader.read_config("Validations", "app_validation") == "True":
            ...
            try:
                ...
                app_txn_status = txn_detail_page.fetch_status("7,500")  # TODO: verify if 7,500 or 8,000
                app_date_time  = txn_detail_page.fetch_date_time()
                app_amount     = txn_detail_page.fetch_amount("7,500")  # TODO: verify if 7,500 or 8,000
                logger.info(
