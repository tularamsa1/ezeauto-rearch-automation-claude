...
def test_common_100_102_237():
    ...
    TC naming code description: 100: Payment Method, 102: BQR, 237: TC237
    """
    try:
...
def test_common_100_102_238():
    ...
    TC naming code description: 100: Payment Method, 102: BQR, 238: TC238
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_common_100_102_244():
    ...
    TC naming code description: 100: Payment Method, 102: BQR, 244: TC244
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_common_100_102_250():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_BQR_2_Success_Callback_After_QR_Expiry_KOTAK_ATOS
    ...
    TC naming code description: 100: Payment Method, 102: BQR, 250: TC250
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
