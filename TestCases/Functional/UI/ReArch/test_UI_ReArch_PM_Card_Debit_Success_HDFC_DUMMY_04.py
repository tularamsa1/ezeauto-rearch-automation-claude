...
def test_common_rearch_0010():
    ...
    Sub Feature Description:
        ...
        proceed through the Order Details overlay, scroll and select MasterCard
        Debit (EMV) on the DUMMY card type selection screen, verify Payment
    ...
    NL Source Steps:
      ...
      Test Steps:
        ...
        6.  scroll and select MasterCard Debit (EMV)
      ...
      API Validation:
        ...
        pmt_card_brand=MASTERCARD, pmt_card_type=DEBIT, card_txn_type=EMV
    ...
    try:
        ...
        try:
            ...
            # Step 6: Card type selection → scroll and select MasterCard Debit (EMV)
            card_type_page = ReArchCardTypePage(app_driver)
            card_type_page.wait_for_card_type_screen()
            card_type_page.click_mastercard_debit_emv()
            logger.debug("Scrolled to and selected MasterCard Debit (EMV)")
