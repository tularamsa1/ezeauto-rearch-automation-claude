...
def test_mp_700_705_020():
    """
    Sub Feature Code: UI_MP_Report_for_Daily_txn_as_Taluk_head
    Sub Feature Description: Verifying txn details on Report Page using Daily quick Filter when logging in as Taluk Head
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') order by created_time asc limit 1;"
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_705_021():
    """
    Sub Feature Code: UI_MP_Report_for_Monthly_txn_as_Taluk_head
    Sub Feature Description: Verifying txn details on Report Page using Monthly quick Filter when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    021: TC021
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_705_022():
    """
    Sub Feature Code: UI_MP_Report_for_Weekly_txn_as_Taluk_head
    Sub Feature Description: Verifying txn details on Report Page using weekly quick Filter when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    022: TC022
