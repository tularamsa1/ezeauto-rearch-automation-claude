...
def test_common_100_115_06_032():
    """
    Sub Feature Code: UI_Common_Card_Instant_EMI_Void_Txn_For_Fallback_Root_Org_HDFC_Dummy_EMV_VISA_CreditCard_With_Pin_417666_For_9_Months_Tenure
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 06: Instant_EMI, 032: TC032
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_06_033():
    """
    Sub Feature Code: UI_Common_Card_Instant_EMI_Void_Txn_For_Fallback_Root_Org_HDFC_Dummy_EMV_VISA_CreditCard_With_Pin_417666_For_12_Months_Tenure
    Sub Feature Description: Performing the instant EMI void transaction for fallback to root org via HDFC Dummy PG
    using EMV VISA Credit card with pin for 12 months tenure (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 06: Instant_EMI, 033: TC033
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_06_042():
    """
    Sub Feature Code: UI_Common_Card_Instant_EMI_Void_Txn_For_Fallback_Root_Org_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenure
    Sub Feature Description: Performing the instant EMI void transaction for fallback to root org via HDFC Dummy PG
    using EMV VISA Debit card with pin for 3 months tenure (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 06: Instant_EMI, 042: TC042
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_06_043():
    """
    Sub Feature Code: UI_Common_Card_Instant_EMI_Void_Txn_For_Fallback_Root_Org_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090_For_6_Months_Tenure
    Sub Feature Description: Performing the instant EMI void transaction for fallback to root org via HDFC Dummy PG
    using EMV VISA Debit card with pin for 6 months tenure (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 06: Instant_EMI, 043: TC043
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_06_044():
    """
    Sub Feature Code: UI_Common_Card_Instant_EMI_Void_Txn_For_Fallback_Root_Org_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090_For_9_Months_Tenure
    Sub Feature Description: Performing the instant EMI void transaction for fallback to root org via HDFC Dummy PG
    using EMV VISA Debit card with pin for 9 months tenure (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 06: Instant_EMI, 044: TC044
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
