...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_032():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_FAILED_InstantSettlement_MSR_DEBIT_VISA
        Sub Feature Description: API that performs IS Failed MSR IDFC instant settlement txn using DEBIT VISA card via IDFC_FDC
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_033():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_FAILED_InstantSettlement_MSR_DEBIT_MASTER
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_034():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_FAILED_InstantSettlement_MSR_DEBIT_RUPAY
        Sub Feature Description: API that performs IS Failed MSR IDFC instant settlement txn using DEBIT RUPAY card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        034: TC034
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_035():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_FAILED_InstantSettlement_MSR_CREDIT_VISA
        Sub Feature Description: API that performs IS Failed MSR IDFC instant settlement txn using CREDIT VISA card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        035: TC035
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_036():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_FAILED_InstantSettlement_MSR_CREDIT_MASTER
        Sub Feature Description: API that performs IS Failed MSR IDFC instant settlement txn using CREDIT MASTER card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        036: TC036
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_037():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_FAILED_InstantSettlement_MSR_CREDIT_RUPAY
        Sub Feature Description: API that performs IS Failed MSR IDFC instant settlement txn using CREDIT RUPAY card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        037: TC037
