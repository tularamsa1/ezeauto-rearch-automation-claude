...
def test_mp_700_707_006():
    """
    Sub Feature Code: UI_MP_Calender_txn_for_specific_location_using_dropdown_values_as_HUB_head
    Sub Feature Description: Verifying txn details on dashboard  for specific location using dropdown values when logging in as HUB Head
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_707_007():
    """
    Sub Feature Code: UI_MP_Calender_txn_for_specific_location_using_search_option_as_HUB_head
    Sub Feature Description: Verifying txn details on dashboard  for specific location using search option when logging in as HUB Head
    TC naming code description:
    700: Merchant Portal
    707: HUB
    007: TC007
