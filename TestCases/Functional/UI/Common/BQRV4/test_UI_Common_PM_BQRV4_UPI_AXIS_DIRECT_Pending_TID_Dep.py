...
def test_common_100_102_350():
    """
    Sub Feature Code: Tid Dep - UI_Common_PM_BQRV4_UPI_Pending_Via_AXIS_DIRECT
    Sub Feature Description: TID Dep - Verification of BQRV4 UPI pending txn via AXIS_DIRECT
    TC naming code description: 100: Payment Method, 102: BQRV4, 350: TC350
    """
    try:
        ...
        logger.debug(f"Fetching tid from the bharatqr_merchant_config table : {tid}")
