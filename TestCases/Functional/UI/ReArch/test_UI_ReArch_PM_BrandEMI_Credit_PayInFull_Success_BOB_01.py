...
def test_common_rearch_0054():
    """
    Sub Feature Code: UI_ReArch_PM_BrandEMI_Credit_PayInFull_Success_BOB
    Sub Feature Description:
        ...
        proceed to EMI via BOB Bank Credit Card, scroll down and select
        Pay in Full (₹7,500 with ₹500 Instant Discount), verify breakup
        (Total Amount ₹7,500, Instant Discount -₹500), enter random
        6-digit IMEI, proceed through card type selection (Visa Credit EMV),
        verify success, then validate via App, API, and Charge Slip.
    ...
    NL Source Steps:
      ...
      Test Steps:
        ...
        11. click on btn_bob_bank_credit_card
        12. scroll down and click on Pay in Full
        13. click on view breakup
        14. verify Total Amount = ₹7,500, Instant Discount = -₹500
    ...
    try:
        ...
        try:
            ...
            amount = "7500"  # charged amount after ₹500 instant discount on ₹8,000 product
            amount_formatted = "\u20b97,500"  # TODO: verify if app shows 7,500 or 8,000 on first run
            ...
            # Step 9: Click Proceed on Order Details
            ...
            # Step 11: Click BOB Bank Credit Card
            emi_page.click_bob_bank_credit_card()
            logger.debug("BOB Bank Credit Card selected")

            # Step 12: Scroll down and click Pay in Full
            emi_page.click_pay_in_full_7500()
            logger.debug("Pay in Full selected (₹7,500 with ₹500 discount)")
            ...
            actual_instant_discount = emi_page.fetch_instant_discount()
            logger.info(f"Breakup — Total Amount: {actual_total_amount}, "
                        f"Instant Discount: {actual_instant_discount}")
            ...
            query = (
                ...
                f"AND payment_mode='CARD' "  # TODO: verify if Pay in Full uses CARD payment_mode
        ...
        if ConfigReader.read_config("Validations", "app_validation") == "True":
            ...
            try:
                # Breakup verification (Pay in Full with Instant Discount)
                expected_breakup_values = {
                    "total_amount": "\u20b97,500",
                    "instant_discount": "-\u20b9500",
                }
                actual_breakup_values = {
                    "total_amount": actual_total_amount,
                    "instant_discount": actual_instant_discount,
                }
                ...
                app_txn_status = txn_detail_page.fetch_status("7,500.00")  # TODO: verify if 7,500.00 or 8,000.00
                app_date_time  = txn_detail_page.fetch_date_time()
                app_amount     = txn_detail_page.fetch_amount("7,500.00")  # TODO: verify if 7,500.00 or 8,000.00
                logger.info(
        ...
        if ConfigReader.read_config("Validations", "api_validation") == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "txn_amt":       float(amount),  # TODO: verify if 7500.0 or 8000.0
                    "pmt_mode":      "CARD",         # TODO: verify payment_mode for Pay in Full
                    "txn_type":      "CHARGE",
                    "acquirer_code": "HDFC",          # TODO: verify acquirer_code for BOB Pay in Full
                    "org_code":      org_code,
                    "rrn":           rrn,
                    "date":          date,
                    "pmt_card_brand": "VISA",
