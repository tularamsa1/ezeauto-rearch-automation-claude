    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                logger.info(
                    f"Fetching txn customer name from txn history for the txn : {new_txn_id_2}, {app_customer_name}")
                app_payer_name = txn_history_page.fetch_payer_name_text()
                logger.info(
                    f"Fetching txn payer name from txn history for the txn : {new_txn_id_1}, {app_payer_name}")
...
def test_common_100_101_027():
    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                expected_app_values = {"Payment Status Original": "EXPIRED",
                                       "Payment Status 1": "REFUND_PENDING",
                                       "Payment Status 2": "REFUND_PENDING",
                                       "Payment mode Original": "UPI",
                                       "Payment mode 1": "UPI",
                                       "Payment mode 2": "UPI",
                                       "Payment Txn ID Original": original_txn_id,
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                expected_api_values = {"Payment Status Original": "EXPIRED",
                                       ...
                                       "Payment State 1": "REFUND_PENDING",
                                       "Payment State 2": "REFUND_PENDING",
                                       "Payment Amt Original": str(amount),
                                       "Payment Amt 1": str(amount),
                                       "Payment Amt 2": str(amount),
                                       "rrn original": str(original_rrn),
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {"Payment Status Original": "EXPIRED",
                                      ...
                                      "UPI_Txn_Status 1": "REFUND_PENDING",
                                      "UPI_Txn_Status 2": "REFUND_PENDING",
                                      "Payment Amt Original": str(amount),
                                      "Payment Amt 1": str(amount),
                                      "Payment Amt 2": str(amount),
                                      "rrn 1": str(callback_1_rrn),
