...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_198():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Void_EMV_WITH_PIN_DEBIT_VISA
        Sub Feature Description: API that performs EMV with pin Void txn having DEBIT VISA card via HDFC
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_264():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Void_EMV_WITH_PIN_DEBIT_RUPAY
        Sub Feature Description: API that performs EMV with pin Void txn having DEBIT RUPAY card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        264: TC264
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_212():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Void_EMV_WITH_PIN_CREDIT_VISA
        Sub Feature Description: API that performs EMV with pin Void txn having CREDIT VISA card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        212: TC212
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_226():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Void_EMV_WITH_PIN_CREDIT_MASTER
        Sub Feature Description: API that performs EMV with pin Void txn having CREDIT MASTER card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        226: TC226
