...
def test_common_100_101_178():
    ...
    Sub Feature Description: TID Dep - Verification of  two callback for success QR when auto refund enabled via Axis acq and Axis PG where upi config is Axis_Direct
    TC naming code description: 100: Payment Method, 101: UPI, 178: TC178
    """
    try:
...
def test_common_100_101_179():
    ...
    TC naming code description: 100: Payment Method, 101: UPI, 179: TC179
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_common_100_101_180():
    ...
    TC naming code description: 100: Payment Method, 101: UPI, 180: TC180
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_common_100_101_181():
    ...
    TC naming code description: 100: Payment Method, 101: UPI, 181: TC181
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
