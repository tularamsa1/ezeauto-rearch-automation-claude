...
def test_500_501_020():
    ...
    try:
        ...
        try:
            ...
            status_queue_realcode = resp_status_upi['realCode']
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                actual_api_values = {
                                     ...
                                     "start_success_1": start_success_upi,
...
def test_500_501_021():
    ...
    try:
        ...
        logger.debug(f"API details  : {api_details}")
        response = APIProcessor.send_request(api_details)
        logger.debug(f"Response received for updating org settings is : {response}")
        ...
        try:
            ...
            start_upi_realcode = resp_start_upi['realCode']
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                actual_app_values = {
                    "pmt_mode": payment_mode_bqr,
                    "pmt_status": payment_status_bqr.split(':')[1],
                    "txn_amt": app_amount_bqr.split(' ')[1],
                    "txn_id": app_txn_id_bqr,
                    "settle_status": app_settlement_status_bqr,
                    "pmt_msg": app_payment_msg_bqr,
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                expected_api_values = {
                    ...
                    "status_req_id_2": request_id_bqr,
                }
                logger.debug(f"expected_api_values: {expected_api_values}")
                ...
                actual_api_values = {"pmt_status": status_api_bqr,
                                     ...
                                     "start_success_1": start_upi_success,
                                     "start_mssg_1": start_upi_mssg,
                                     "start_mssg_code_1": start_upi_mssgcode,
                                     "start_error_code_1": start_upi_error_code,
                                     "start_error_message_1": start_upi_error_mssg,
                                     "start_real_code_1": start_upi_realcode,
                                    # ----------------------------------------------------
                                     "status_success_2": status_after_pmt_success_bqr,
                                     "status_mssg_code_2": status_after_pmt_mssgcode_bqr,
                                     "status_real_code_2": status_after_pmt_realcode_bqr,
                                     "status_mssg_2": status_after_pmt_mssg_bqr,
                                     "status_username_2": status_after_pmt_username_bqr,
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                ...
                actual_db_values = {
                    ...
                    # "p2p_txn_id_1_upi": db_p2p_request_txn_id_upi
                }
                logger.debug(f"actual_db_values : {actual_db_values}")
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                actual_app_values = {
                    ...
                    "pmt_mode_1": payment_mode_upi,
                    "pmt_status_1": payment_status_upi.split(':')[1],
                    "txn_amt_1": app_amount_upi.split(' ')[1],
                    "txn_id_1": app_txn_id_upi,
                    "settle_status_1": app_settlement_status_upi,
                    "pmt_msg_1": app_payment_msg_upi,
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                expected_api_values = {
                    ...
                    "status_req_id_3": request_id_upi,
                }
                logger.debug(f"expected_api_values: {expected_api_values}")
                ...
                actual_api_values = {"pmt_status": status_api_bqr,
                                     ...
                                     "pmt_status_1": status_api_upi,
                                     "txn_amt_1": amount_api_upi,
                                     "pmt_mode_1": payment_mode_api_upi,
                                     "pmt_state_1": state_api_upi,
                                     "settle_status_1": settlement_status_api_upi,
                                     "acquirer_code_1": acquirer_code_api_upi,
                                     "issuer_code_1": issuer_code_api_upi,
                                     "mid_1": mid_api_upi,
                                     "txn_type_1": txn_type_api_upi,
                                     "tid_1": tid_api_upi,
                                     "org_code_1": org_code_api_upi,
                                     "date_1": date_time_converter.from_api_to_datetime_format(date_api_upi),
                                     # --------------------------------------------------
                                     "start_success": start_success_bqr,
                                     "status_success": status_received_success_bqr,
                                     "status_mssg": status_received_mssg_bqr,
                                    ...
                                    # ----------------------------------------------------
                                     ...
                                     "status_success_3": status_after_pmt_success_upi,
                                     "status_mssg_code_3": status_after_pmt_mssgcode_upi,
                                     "status_real_code_3": status_after_pmt_realcode_upi,
                                     "status_mssg_3": status_after_pmt_mssg_upi,
                                     "status_username_3": status_after_pmt_username_upi,
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                ...
                actual_db_values = {
                    ...
                    "txn_amt_1": amount_db_upi,
                    "pmt_status_1": payment_status_db_upi,
                    "pmt_state_1": payment_state_db_upi,
                    "pmt_mode_1": payment_mode_db_upi,
                    "acquirer_code_1": acquirer_code_db_upi,
                    "bank_code_1": bank_code_db_upi,
                    "payment_gateway_1": payment_gateway_db_upi,
                    "mid_1": mid_db_upi,
                    "tid_1": tid_db_upi,
                    "settle_status_1": settlement_status_db_upi,
                    "txn_type_1": txn_type_db_upi,
...
def test_500_501_024():
    ...
    Sub Feature Description: Cancel first notification among two queued notifications (second notification for UPI) using cancel API from billing system
