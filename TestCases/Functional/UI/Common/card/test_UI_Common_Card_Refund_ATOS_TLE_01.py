...
def test_common_100_115_090():
    """
    Sub Feature Code: UI_Common_Card_Refund_ATOS_TLE_EMVCTLS_VISA_DebitCard_Without_Pin_476173
    Sub Feature Description: Performing the EMVCTLS Refund transaction via ATOS TLE PG using VISA Debit card having
     16 digit PAN length without pin (bin: 476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 090: TC090
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_091():
    """
    Sub Feature Code: UI_Common_Card_Refund_ATOS_TLE_EMVCTLS_MASTER_DebitCard_Without_Pin_222360
    Sub Feature Description: Performing the EMVCTLS Refund transaction via ATOS TLE PG using MASTER Debit card having
     16 digit PAN length without pin (bin: 222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 091: TC091
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_092():
    """
    Sub Feature Code: UI_Common_Card_Refund_ATOS_TLE_EMVCTLS_RUPAY_DebitCard_Without_Pin_608326
    Sub Feature Description: Performing the EMVCTLS Refund transaction via ATOS TLE PG using RUPAY Debit card having
     16 digit PAN length without pin (bin: 608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 092: TC092
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_093():
    """
    Sub Feature Code: UI_Common_Card_Refund_ATOS_TLE_EMVCTLS_VISA_DebitCard_With_Pin_476173
    Sub Feature Description: Performing the EMVCTLS Refund transaction via ATOS TLE PG using VISA Debit card having
     16 digit PAN length with pin (bin: 476173)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 093: TC093
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_094():
    """
    Sub Feature Code: UI_Common_Card_Refund_ATOS_TLE_EMVCTLS_MASTER_DebitCard_With_Pin_222360
    Sub Feature Description: Performing the EMVCTLS Refund transaction via ATOS TLE PG using MASTER Debit card having
     16 digit PAN length with pin (bin: 222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 094: TC094
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
