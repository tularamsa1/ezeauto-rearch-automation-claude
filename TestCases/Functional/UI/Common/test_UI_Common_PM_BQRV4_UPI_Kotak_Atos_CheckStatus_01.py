...
def test_common_100_102_231():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_Success_Via_API_CheckStatus_KOTAK_ATOS
    Sub Feature Description: Verification of a successful upi txn via BQRV4 via KOTAK_ATOS using check status api
    TC naming code description: 100: Payment Method, 102: BQRV4, 231: TC231
    """
    try:
...
def test_common_100_102_232():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_UPI_Failed_Via_API_CheckStatus_KOTAK_ATOS
    Sub Feature Description: Verification of a failed upi txn via BQRV4 KOTAK_ATOS using check status api
    TC naming code description: 100: Payment Method, 102: BQRV4, 232: TC232
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
