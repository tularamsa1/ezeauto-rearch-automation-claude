...
def test_common_100_115_05_066():
    """
    Sub Feature Code: UI_Common_Card_Normal_EMI_Refund_Via_API_For_An_Org_HDFC_Dummy_Onecard_EMV_VISA_CreditCard_With_Pin_417666_For_3_Months_Tenure
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 066: TC066
    """
    try:
        ...
        try:
            ...
            query = f"select * from emi where org_code='{org_code}' and status = 'ACTIVE' and " \
                    f"issuer_code='ONECARD' and card_type='CREDIT' AND term = '{emi_plan_in_months} month' and " \
