...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_195():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Offline_Refund_EMV_WITH_PIN_DEBIT_VISA
        Sub Feature Description:API that performs EMV with pin offline Refund txn having DEBIT VISA card via ATOS_TLE
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_183():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Offline_Refund_EMV_WITH_PIN_DEBIT_RUPAY
        Sub Feature Description:API that performs EMV with pin offline Refund txn having DEBIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        183: TC183
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_209():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Offline_Refund_EMV_WITH_PIN_CREDIT_VISA
        Sub Feature Description:API that performs EMV with pin offline Refund txn having CREDIT VISA card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        209: TC209
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_223():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Offline_Refund_EMV_WITH_PIN_CREDIT_MASTER
        Sub Feature Description:API that performs EMV with pin offline Refund txn having CREDIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        223: TC223
