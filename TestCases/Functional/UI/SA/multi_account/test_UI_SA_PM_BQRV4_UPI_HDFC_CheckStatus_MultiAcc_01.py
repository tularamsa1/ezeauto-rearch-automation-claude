...
def test_sa_100_110_009():
    ...
    TC naming code description: 100: Payment Method 110: MultiAcc_BQR, 009: TC009
    """
    try:
...
def test_sa_100_110_013():
    ...
    Sub Feature Description: Multi Account - Performing a successful BQRV4_UPI txn via HDFC using SA check status via second account (ex:acc2 label)
    TC naming code description: 100: Payment Method, 110: MultiAcc_BQR, 013: TC013
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
