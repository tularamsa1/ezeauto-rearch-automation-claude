...
def test_common_100_102_359():
    ...
    try:
        ...
        try:
            ...
            api_details = DBProcessor.get_api_details('stopPayment',request_body={"username": app_username, "password": app_password,
    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                ...
                logger.debug(f"state:{bqr_state_db}, amount:{bqr_amount_db}, txn type:{bqr_txn_type_db}, bank code:{bqr_bank_code_db}, merchant config:{bqr_merchant_config_id_db}, txn primary ID:{bqr_txn_primary_id_db}, org code:{bqr_org_code_db}")
