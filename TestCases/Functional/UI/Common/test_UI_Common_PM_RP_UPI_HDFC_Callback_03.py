...
def test_common_100_103_067():
    """
    Sub Feature Code: UI_Common_PM_RP_2_UPI_success_callback_after_expiry_HDFC_AutoRefund_Disabled
    Sub Feature Description: Verification of a two UPI success callback via HDFC after expiry the when autorefund is disabled
    100: Payment Method
    103: RemotePay
    067: TC067
    """
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_068():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_Success_Callback_AutoRefundDisabled_HDFC
...
def test_common_100_103_069():
    ...
    Sub Feature Description: Verification of a two UPI success callback via HDFC after expiry the when autorefund is enabled
    100: Payment Method
    103: RemotePay
    069: TC069
    """
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_071():
    """
    Sub Feature Code: UI_Common_PM_RP_2_UPI_failed_callback_after_expiry_HDFC_AutoRefund_Disabled
    Sub Feature Description: Performing two UPI failed callback via HDFC after expiry the when autorefund is disabled
    100: Payment Method
    103: RemotePay
    071: TC071
    """
