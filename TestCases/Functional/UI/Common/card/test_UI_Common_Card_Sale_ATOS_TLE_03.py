...
def test_common_100_115_148():
    """
    Sub Feature Code: UI_Common_Card_Sale_ATOS_TLE_EMV_MASTER_DebitCard_Without_Pin_222360
    Sub Feature Description: Performing the EMV sale transaction via ATOS_TLE PG using MASTER Debit card having
    16 digit PAN length without pin (bin:222360)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 148: TC148
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_149():
    """
    Sub Feature Code: UI_Common_Card_Sale_ATOS_TLE_EMV_RUPAY_DebitCard_Without_Pin_608326
    Sub Feature Description: Performing the EMV sale transaction via ATOS_TLE PG using RUPAY Debit card having
    16 digit PAN length without pin (bin:608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 149: TC149
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_150():
    """
    Sub Feature Code: UI_Common_Card_Sale_ATOS_TLE_EMV_VISA_DebitCard_With_Pin_428090
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 150: TC150
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_151():
    """
    Sub Feature Code: UI_Common_Card_Sale_ATOS_TLE_EMV_RUPAY_DebitCard_With_Pin_608326
    Sub Feature Description: Performing the EMV sale transaction via ATOS_TLE PG using RUPAY Debit card having
    16 digit PAN length with pin (bin:608326)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 151: TC151
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_152():
    """
    Sub Feature Code: UI_Common_Card_Sale_ATOS_TLE_EMV_VISA_CreditCard_Without_Pin_417666
    Sub Feature Description: Performing the EMV sale transaction via ATOS_TLE PG using VISA Credit card having
    16 digit PAN length without pin (bin:417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 152: TC152
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
