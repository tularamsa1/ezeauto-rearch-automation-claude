...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_171():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Offline_Refund_EMVCTLS_WITH_PIN_DEBIT_VISA
        Sub Feature Description:API that performs EMVCTLS with PIN Offline Refund txn having DEBIT VISA card via ATOS_TLE
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_248():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Offline_Refund_EMVCTLS_WITH_PIN_DEBIT_MASTER
        Sub Feature Description:API that performs EMVCTLS with pin Offline Refund txn having DEBIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        248: TC248
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_249():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Offline_Refund_EMVCTLS_WITH_PIN_DEBIT_RUPAY
        Sub Feature Description:API that performs EMVCTLS with pin Offline Refund txn having DEBIT RUPAY card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        249: TC249
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_236():
    """
        Sub Feature Code: NonUI_Common_ATOS_TLE_Card_Offline_Refund_EMVCTLS_WITH_PIN_CREDIT_MASTER
        Sub Feature Description:API that performs EMVCTLS with pin Offline Refund txn having CREDIT MASTER card via ATOS_TLE
        TC naming code description:
        100: Payment Method
        104: CARD
        236: TC236
