...
def test_common_100_102_246():
    """
    Sub Feature Code: Tid_Dep - UI_Common_PM_BQRV4_UPI_Success_Via_CheckStatus_API_ICICI_FDC
    Sub Feature Description: Tid Dep - Verification of a successful bqrv4 upi txn via ICICI_FDC using check status api
