...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_706_034():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Reversed_as_City_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Reversed when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    034: TC034
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_706_035():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Refund_pending_as_City_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Refund Pending when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    035: TC035
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_706_036():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Pre_Auth_as_City_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Pre Auth when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    036: TC036
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_706_037():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_REL_Pre_Auth_as_City_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status REL_Pre_Auth when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    037: TC037
