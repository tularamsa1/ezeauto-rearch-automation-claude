...
def test_mp_700_706_006():
    """
    Sub Feature Code: UI_MP_Calender_txn_for_specific_location_using_dropdown_values_as_City_head
    Sub Feature Description: Verifying txn details on dashboard  for specific location using dropdown values when logged in as City Head
    ...
    try:
        ...
        try:
            ...
            location_hierarchy = ["Mumbai1", "Hub1", str(node_name)]
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_706_007():
    """
    Sub Feature Code: UI_MP_Calender_txn_for_specific_location_using_search_option_as_City_head
    Sub Feature Description: Verifying txn details on dashboard  for specific location using search option when logged in as City Head
    TC naming code description:
    700: Merchant Portal
    706: City
    007: TC007
