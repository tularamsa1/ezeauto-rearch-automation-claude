...
def test_common_100_103_535():
    """
    Sub Feature Code:UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_Debit_Credit_Fixed_&Netbanking_AXIS_Schemes_Amt_Fixed_with_Netbanking_Details
    Sub Feature Description:Verify Service Fee when debit credit netbanking enabled and JSON is debit and credit with FIXED and AXIS netbanking scheme and amount in FIXED range with netbanking details
    TC naming code description: 100: Payment Method, 103: RemotePay, 535: TC_535
    """
    ...
    try:
        ...
        scheme = "ANY"
        payment_by = "NB"
        json_id = "service_fee_json_TC_100_103_535"
        payment_mode = "CNP"
        acc_label = ""
        ...
        try:
            ...
            if not response['success']:
                ...
                remote_pay_txn.remote_pay_select_netbanking_bank_select("Axis Bank")
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_536():
    """
    Sub Feature Code:UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_Debit_Credit_PERCENT_&Netbanking_AXIS_Schemes_Amt_Percent_with_Netbanking_Details
    Sub Feature Description:Verify Service Fee when debit credit netbanking enabled and JSON is debit and credit with PERCENT and  AXIS netbanking scheme and amount in PERCENT range with netbanking details
    TC naming code description: 100: Payment Method, 103: RemotePay, 536: TC_536
    """
    expected_message = "Your payment is successfully completed! You may close the browser now."
    try:
        testcase_id = sys._getframe().f_code.co_name
        ...
        scheme = "ANY"
        payment_by = "NB"
        json_id = "service_fee_json_TC_100_103_536"
        payment_mode = "CNP"
        acc_label = ""
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_537():
    """
    Sub Feature Code:UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_Debit_Credit_Fixed_Percent_&Netbanking_AXIS_Schemes_Amt_Fixed_Percent_with_Netbanking_Details
    Sub Feature Description:Verify Service Fee when debit credit netbanking enabled and JSON is debit and credit with FIXED_PERCENT and AXIS netbanking scheme and amount in FIXED PERCENT range with netbanking details
    TC naming code description: 100: Payment Method, 103: RemotePay, 537: TC_537
    """
    expected_message = "Your payment is successfully completed! You may close the browser now."
    try:
        testcase_id = sys._getframe().f_code.co_name
        ...
        scheme = "ANY"
        payment_by = "NB"
        json_id = "service_fee_json_TC_100_103_537"
        payment_mode = "CNP"
        acc_label = ""
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_538():
    """
    Sub Feature Code:UI_Common_PM_CNP_Razorpay_Service_Fee_Debit_Credit_Netbanking_Enabled_JSON_Debit_Credit_Fixed_&Netbanking_YES_Schemes_Amt_Fixed_with_Netbanking_Details
    Sub Feature Description:Verify Service Fee when debit credit netbanking enabled and JSON is debit and credit with FIXED and YES netbanking scheme and amount in FIXED range with netbanking details
    TC naming code description: 100: Payment Method, 103: RemotePay, 538: TC_538
    """
    expected_message = "Your payment is successfully completed! You may close the browser now."
    try:
        testcase_id = sys._getframe().f_code.co_name
        ...
        scheme = "ANY"
        payment_by = "NB"
        json_id = "service_fee_json_TC_100_103_538"
        payment_mode = "CNP"
        acc_label = ""
        derivation_type = "FIXED"
        bank = "YES"
        ...
        try:
            ...
            if not response['success']:
                ...
                remote_pay_txn.remote_pay_netbanking()
                remote_pay_txn.remote_pay_click_and_expand_netbanking()
                remote_pay_txn.remote_pay_select_netbanking_bank_select("Yes Bank")
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_539():
    """
    Sub Feature Code:Verify Service Fee when debit credit netbanking enabled and JSON is debit and credit with PERCENT and  YES netbanking scheme and amount in PERCENT range with netbanking details
    Sub Feature Description:Verify Service Fee when debit credit netbanking enabled and JSON is debit and credit with PERCENT and  YES netbanking scheme and amount in PERCENT range with netbanking details
    TC naming code description: 100: Payment Method, 103: RemotePay, 539: TC_539
    """
    expected_message = "Your payment is successfully completed! You may close the browser now."
    try:
        testcase_id = sys._getframe().f_code.co_name
        ...
        scheme = "ANY"
        payment_by = "NB"
        json_id = "service_fee_json_TC_100_103_539"
        payment_mode = "CNP"
        acc_label = ""
        derivation_type = "PERCENT"
        bank = "YES"
