...
def test_common_rearch_0020():
    """
    Sub Feature Code: UI_ReArch_PM_Cash_Success_HDFC
    Sub Feature Description:
        Launch ReArch app (handle login only if Select Environment screen
        appears), enter a random amount between 500 and 600, tap the overlay
        button (⋯), proceed through Order Details, scroll down and select
        Cash from the payment methods overlay, confirm payment, click Accept
        More Payments, then navigate to transaction history and perform app,
        API and charge slip validation.
