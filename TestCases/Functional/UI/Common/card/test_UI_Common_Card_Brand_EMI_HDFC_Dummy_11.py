...
@pytest.mark.dbVal
def test_common_100_115_07_122():
    """
    Sub Feature Code: UI_Common_Card_Brand_EMI_Check_Eligibility_For_An_Org_HDFC_Dummy_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenure
    Sub Feature Description: Performing the brand EMI check eligibility for an org (not ezetap) via HDFC Dummy PG using
    EMV VISA Debit card with pin for 3 months tenure (bin: 428090)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand_EMI, 122: TC122
    """
    try:
