...
def test_common_100_116_014():
    """
    Sub Feature Code: UI_Common_Card_Void_Sale_HDFC_HDFC_Opt_Out_MC_Chip_KWD_CreditCard_With_Online_Pin_222297
    Sub Feature Description: Performing the opt out MC Chip KWD void sale transaction via HDFC HDFC PG using Credit card with online pin  (bin:222297)
    TC naming code description: 100: Payment Method, 116: CARD_DCC, 014: TC014
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                logger.debug(f"expected_ap`p_values: {expected_app_values}")
