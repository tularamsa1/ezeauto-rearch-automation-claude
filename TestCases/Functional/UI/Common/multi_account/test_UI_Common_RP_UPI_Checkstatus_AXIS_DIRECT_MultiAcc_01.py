...
def test_common_100_111_017():
    """
    Sub Feature Code: UI_Common_PM_RP_RP_UPI_Success_Via_CheckStatus_AXIS_DIRECT_MultiAcc
    Sub Feature Description: MultiAccount - Verification of a Remote Pay successful upi txn via Axis Direct using check status
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_111_018():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_Failed_Via_CheckStatus_AXIS_DIRECT_MutliAcc
    Sub Feature Description: MutliAccount - Verification of a Remote Pay failed UPI txn via HDFC using check status
    TC naming code description:
    100: Payment Method
    111: MutliAcc_RemotePay
    018: TC_018
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_111_027():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_Success_Via_CheckStatus_with_2nd_label_MultiAcc_AXIS_DIRECT
    Sub Feature Description: Multi Account - Performing a successful RP_UPI txn via AXIS_DIRECT using check status second account (ex:acc2 label)
    TC naming code description:
    100: Payment Method
    111: MultiAcc_RemotePay
    027: TC_027
