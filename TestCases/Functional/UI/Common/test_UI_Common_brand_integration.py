...
def test_common_100_115_05_0001():
    """
    Sub Feature Code:
    Sub Feature Description: Verify by entering amount less than mIn value of a particular product
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand_EMI, 128: TC128
    """
    try:
        ...
        logger.debug(f"Response received when emi, emi for client, offering_emi cashback, brandEmiSettings enabled in preconditions settings : {response}")
        ...
        try:
            ...
            emi_cashback_fixed = result['emi_payback_fixed'].values[0]
            logger.debug(f"Fetching emi cashback fixed amount from txn_emi table : {emi_cashback_fixed}")
            emi_cashback_amount = result['emi_payback_amount'].values[0]
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_05_0002():
    """
    Sub Feature Code:
    Sub Feature Description: Verify by entering amount greater than max value of a particular product
    TC naming code description: 100: Payment Method, 115: CARD_UI, 07: Brand_EMI, 128: TC128
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_05_0003():
    """
    Sub Feature Code:
    Sub Feature Description: Do a brand EMI Transaction before adding data to config _data table
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_05_0004():
    """
    Sub Feature Code:
    Sub Feature Description: Add brand details under config_data-- set posting status ONLINE
    TC naming code description:
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_05_0005():
    """
    Sub Feature Code:
    Sub Feature Description: Remove the sku code from the orgsettings and try to do one transaction
    TC naming code description:
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
