...
def test_common_100_115_153():
    """
    Sub Feature Code: UI_Common_Card_Sale_ATOS_TLE_EMV_MASTER_CreditCard_Without_Pin_541333
    Sub Feature Description: Performing the EMV sale transaction via ATOS_TLE PG using MASTER Credit card having
    16 digit PAN length without pin (bin:541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 153: TC153
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_154():
    """
    Sub Feature Code: UI_Common_Card_Sale_ATOS_TLE_EMV_VISA_CreditCard_With_Pin_417666
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 154: TC154
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_155():
    """
    Sub Feature Code: UI_Common_Card_Sale_ATOS_TLE_EMV_MASTER_CreditCard_With_Pin_541333
    Sub Feature Description: Performing the EMV sale transaction via ATOS_TLE PG using MASTER Credit card having
    16 digit PAN length with pin (bin:541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 155: TC155
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
