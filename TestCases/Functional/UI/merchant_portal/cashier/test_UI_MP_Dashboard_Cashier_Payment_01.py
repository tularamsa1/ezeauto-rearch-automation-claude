...
def test_mp_700_709_008():
    """
    Sub Feature Code: UI_MP_Payment_using_Card_as_Cashier
    Sub Feature Description: Verifying txn details on dashboard for payment done using card when logged in as Cashier
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'CARD'" \
                                                "and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username = '" + txn_username + "';"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_709_009():
    """
    Sub Feature Code: UI_MP_Payment_using_Cash_as_Cashier
    Sub Feature Description: Verifying txn details on dashboard for payment done using Cash when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    009: TC009
        ...
        try:
            ...
            query = "select sum(amount) from txn where" \
                    " org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'CASH' and " \
                                                 "id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username = '" + txn_username + "';"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_709_010():
    """
    Sub Feature Code: UI_MP_Payment_using_UPI_as_Cashier
    Sub Feature Description: Verifying txn details on dashboard for payment done using UPI when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    010: TC010
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'UPI' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username = '" + txn_username + "';"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_709_011():
    """
    Sub Feature Code: UI_MP_Payment_using_BQR_as_Cashier
    Sub Feature Description: Verifying txn details on dashboard for payment done using BQR when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    011: TC011
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'BHARATQR' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username = '" + txn_username + "';"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_709_012():
    """
    Sub Feature Code: UI_MP_Payment_using_CNP_as_Cashier
    Sub Feature Description: Verifying txn details on dashboard for payment done using CNP when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    012: TC012
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and status = 'AUTHORIZED' and payment_mode = 'CNP' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "' and username = '" + txn_username + "';"
