...
def test_common_100_102_037():
    ...
    try:
        ...
        try:
            ...
            error_message =home_page_portal.perform_refund_of_txn_and_fetch_alert_msg(refund_amount)
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {"pmt_status": "AUTHORIZED","txn_amt": float(amount),"pmt_mode": "BHARATQR",
                                       ...
                                       "date": date,
                                       "error message": "ERROR: Partial Refund is not supported for YES transactions."}
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_102_038():
    """
    Sub Feature Code: UI_Common_PM_BQRV4_BQR_Partial_Refund_API_YES_ATOS
    Sub Feature Description: Verification of a BQR Partial Refund transaction through API via YES_ATOS
    TC naming code description: 100: Payment Method, 102: BQR, 038: TC038
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
