...
from PageFactory.merchant_portal.portal_trans_history_page import get_transaction_details_for_portal, get_dsn_number
...
def test_common_100_106_001():
    """
    Sub Feature Code: UI_Common_PM_Cash_Order_Number_01
        ...
        if (ConfigReader.read_config("Validations", "portal_validation")) == "True":
            ...
            try:
                ...
                if (ConfigReader.read_config("ParallelExecution", "deviceOnly")) == "True":
                    portal_dsn = get_dsn_number(app_username,app_password,order_id)
...
def test_common_100_106_002():
    """
    Sub Feature Code: UI_Common_PM_Cash_No_Order_Number_01
...
def test_common_100_106_003():
    """
    Sub Feature Code:  UI_CommonPM_Cash_Add_Auth_01
