...
def test_common_100_103_342():
    """
     Sub Feature Code: UI_Common_PM_RP_Success_Link_Generation_Without_Browser_Flow_Via_Axis_Direct
     Sub Feature Description: Success Remote Pay txn without sending "paymentFlow" as param via axis direct
     TC naming code description: 100: Payment Method, 103: RemotePay, 342: TC342
    """
    try:
