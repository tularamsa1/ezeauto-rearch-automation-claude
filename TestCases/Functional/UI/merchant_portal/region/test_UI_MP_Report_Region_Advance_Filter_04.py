...
def test_mp_700_702_056():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_Card_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode Card when logging in as Regional Head
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_702_057():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_UPI_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode UPI when logging in as Regional Head
    TC naming code description:
    700: Merchant Portal
    702: Region
    057: TC057
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_702_058():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_BharatQR_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode BharatQR when logging in as Regional Head
    TC naming code description:
    700: Merchant Portal
    702: Region
    058: TC058
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_702_059():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_CNP_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode CNP when logging in as Regional Head
    TC naming code description:
    700: Merchant Portal
    702: Region
    059: TC059
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_702_060():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_cheque_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode Cheque when logging in as Regional Head
    TC naming code description:
    700: Merchant Portal
    702: Region
    060: TC060
