...
def test_mp_700_702_041():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_order_number_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter order number when logging in as Regional Head
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and external_ref='" + order_number + "' and username NOT IN ('"+country_username+"') order by created_time asc limit 1;"
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_702_042():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Device_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter Device when logging in as Regional Head
    TC naming code description:
    700: Merchant Portal
    702: Region
    042: TC042
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and device_serial='" + device + "' and username NOT IN ('"+country_username+"') order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_702_043():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_customer_mobile_number_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter customer mobile number when logging in as Regional Head
    TC naming code description:
    700: Merchant Portal
    702: Region
    043: TC043
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and customer_mobile='" + cust_mob_no + "' and username NOT IN ('"+country_username+"') order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_702_044():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Auth_code_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter Auth_code when logging in as Regional Head
    TC naming code description:
    700: Merchant Portal
    702: Region
    044: TC044
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and auth_code='" + auth_code_api + "' and username NOT IN ('"+country_username+"') order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_702_045():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Tid_as_Regional_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter Tid when logging in as Regional Head
    TC naming code description:
    700: Merchant Portal
    702: Region
    045: TC045
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and tid='" + tid_api + "' and username NOT IN ('"+country_username+"') order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
