...
def test_common_100_116_005():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_HDFC_Opt_Out_MC_Chip_KWD_CreditCard_With_Online_Pin_222297
    Sub Feature Description: Performing the opt out MC Chip KWD sale transaction via HDFC HDFC PG using Credit card
    with online pin  (bin:222297)
    TC naming code description: 100: Payment Method, 116: CARD_DCC, 005: TC005
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_116_006():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_HDFC_Opt_Out_VISA_ctls_GBP_CreditCard_With_Online_Pin_417666
    Sub Feature Description: Performing the opt out VISA ctls GBP sale transaction via HDFC PLANET PG using Credit card
    with online pin  (bin:417666)
    TC naming code description: 100: Payment Method, 116: CARD_DCC, 006: TC006
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_116_007():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_HDFC_Opt_Out_VISA_ctls_JPY_CreditCard_With_Online_Pin_405170
    Sub Feature Description: Performing the opt out VISA ctls JPY sale transaction via HDFC PLANET PG using Credit
    card with online pin  (bin:405170)
    TC naming code description: 100: Payment Method, 116: CARD_DCC, 007: TC007
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_116_008():
    """
    Sub Feature Code: UI_Common_Card_Sale_HDFC_HDFC_Opt_Out_MC_ctls_USD_CreditCard_With_Online_Pin_556763
    Sub Feature Description: Performing the opt Out MC ctls USD sale transaction via HDFC PLANET PG using Credit card
    with online pin  (bin:556763)
    TC naming code description: 100: Payment Method, 116: CARD_DCC, 008: TC008
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
