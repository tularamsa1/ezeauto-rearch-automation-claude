...
def test_common_100_103_07_002():
    """
    Sub Feature Code: UI_Common_Card_BRAND_EMI_Success_CNP_Txn_For_An_Org_HDFC_Dummy_Federal_VISA_CreditCard_400000_For_3_Months_Tenure
    Sub Feature Description: Performing the brand EMI success CNP transaction for an org (not ezetap) via HDFC Dummy PG for
    Federal issuer using VISA Credit card with pin for 3 months tenure (bin: 400000)
    TC naming code description: 100: Payment Method, 103: CNP, 07: BRAND_EMI, 002: TC002
    """
