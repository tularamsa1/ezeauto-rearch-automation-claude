...
@pytest.mark.appVal
def test_common_100_103_096():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_Collect_UPG_AUTHORIZED_via_AXIS_DIRECT_when_UPGRefund_&_UPGAutoRefund_Disabled
    Sub Feature Description: Performing a upg authorized txn using upi collect success callback when upg refund and upg autorefund disabled
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_097():
    """
    Sub Feature Code: UI_Common_PM_UPI_UPG_FAILED_via_AXIS_DIRECT_when_UPGRefund_&_UPGAutoRefund_Disabled
    Sub Feature Description: Performing a upg failed txn using pure upi failed callback when upg refund and upg autorefund disabled
    TC naming code description:
    100: Payment Method
    101: UPI
    064: TC064
...
@pytest.mark.portalVal
@pytest.mark.appVal
def test_common_100_103_098():
    """
    Sub Feature Code: UI_Common_PM_UPI_UPG_REFUND_PENDING_via_AXIS_DIRECT_when_UPGRefund_&_UPGAutoRefund_Enabled
    Sub Feature Description: Performing a upg refund pending txn using pure upi success callback when upg refund and upg autorefund enabled
    TC naming code description:
    100: Payment Method
    103: RemotePay
    098: TC098
    ...
    try:
        ...
        try:
            ...
            print(q_result)
            txn_id = q_result['txn_id'].iloc[0]
            logger.info(f"Txn id is: {txn_id}")
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                #         logger.info(f"status_api is {status_api}")
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                expected_app_values = {
                    ...
                    "date": date_and_time,
                    "refund_pmt_mode": "UPI",
                    "refund_pmt_status": "UPG_REFUNDED",
                    "refund_settle_status": "SETTLED",
                    "refund_txn_id": refund_txn_id,
                    "refund_txn_amt": str(amount),
                    "refund_order_id": refund_external_ref,
                    "refund_payment_msg": "PAYMENT SUCCESSFUL",
                ...
                logger.info(f"Fetching status from txn history for the txn : {refund_txn_id}, {app_payment_status_refund}")
                ...
                logger.info(f"Fetching payment mode from txn history for the txn : {refund_txn_id}, {app_payment_mode_refund}")
                ...
                logger.info(f"Fetching txn status msg from txn history for the txn : {refund_txn_id}, {app_payment_msg_refund}")
                app_order_id_refund = txn_history_page.fetch_order_id_text()
                logger.info(f"Fetching txn order_id from txn history for the txn : {refund_txn_id}, {app_order_id_refund}")
                ...
                actual_app_values = {
                    ...
                    "payment_msg": app_payment_msg,
                    "date": app_date_and_time,
                    "refund_pmt_mode": app_payment_mode_refund,
                    "refund_pmt_status": app_payment_status_refund.split(':')[1],
                    "refund_settle_status": app_settlement_status_refund,
                    "refund_txn_id": app_txn_id_refund,
                    "refund_txn_amt": str(app_amount_refund).split(' ')[1],
                    "refund_order_id": app_order_id_refund,
                    "refund_payment_msg": app_payment_msg_refund,
                    "refund_date": app_date_and_time_refund,
                }
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "date": date,
                    "refund_pmt_status": "UPG_REFUNDED",
                    "refund_txn_amt": amount, "refund_pmt_mode": "UPI",
                    "refund_pmt_state": "UPG_REFUNDED",
                    "refund_settle_status": "SETTLED",
                    "refund_acquirer_code": "AXIS",
                    # "refund_issuer_code": "AXIS",
                    "refund_txn_type": refund_txn_type, "refund_mid": mid, "refund_tid": tid,
                    "refund_org_code": org_code_txn,
                ...
                actual_api_values = {
                    ...
                    "org_code": orgCode_api,
                    "date": date_time_converter.from_api_to_datetime_format(date_api),
                    "refund_pmt_status": refund_status_api, "refund_txn_amt": refund_amount_api,
                    "refund_pmt_mode": refund_payment_mode_api,
                    "refund_pmt_state": refund_state_api,
                    "refund_settle_status": refund_settlement_status_api,
                    "refund_acquirer_code": refund_acquirer_code_api,
                    # "refund_issuer_code": refund_issuer_code_api,
                    "refund_txn_type": refund_txn_type_api, "refund_mid": refund_mid_api, "refund_tid": refund_tid_api,
                    "refund_org_code": refund_orgCode_api,
                    "refund_date": date_time_converter.from_api_to_datetime_format(refund_date_api)
                }
                logger.debug(f"actual_api_values: {actual_api_values}")
                Validator.validationAgainstAPI(expectedAPI=expected_api_values, actualAPI=actual_api_values)
            except Exception as e:
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    "refund_pmt_state": "UPG_REFUNDED",
                    "refund_pmt_mode": "UPI",
                    "refund_txn_amt": amount,
                    "refund_upi_txn_status": "UPG_REFUNDED",
                    "refund_settle_status": "SETTLED",
                    "refund_acquirer_code": "AXIS",
                    # "refund_bank_code": "AXIS",
                    "refund_payment_gateway": "AXIS",
                    "refund_upi_txn_type": "REFUND",
                    "refund_upi_bank_code": "AXIS_DIRECT",
                ...
                actual_db_values = {
                    ...
                    "ipr_pg_merchant_id": ipr_pg_merchant_id,
                    "rrn": str(rrn_db),
                    "refund_pmt_status": refund_status_db,
                    "refund_pmt_state": refund_state_db,
                    "refund_pmt_mode": refund_payment_mode_db,
                    "refund_txn_amt": refund_amount_db,
                    "refund_upi_txn_status": refund_upi_status_db,
                    "refund_settle_status": refund_settlement_status_db,
                    "refund_acquirer_code": refund_acquirer_code_db,
                    # "refund_bank_code": refund_bank_code_db,
                    "refund_payment_gateway": refund_payment_gateway_db,
...
def test_common_100_103_100():
    """
    Sub Feature Code: UI_Common_PM_UPI_amount_mismatch_Via_Pure_UPI_Success_Callback_AXISDIRECT
    Sub Feature Description: Performing a amount mismatch using pure upi success callback via AXIS_DIRECT
    TC naming code description:
    100: Payment Method
    101: UPI
    067: TC067
    ...
    try:
        ...
        try:
            ...
            logger.debug(
                f"replacing the Txn_id with {payment_intent_id}, amount with {amount}.00, vpa with {vpa} and rrn with {rrn} in the curl_data")
            api_details = DBProcessor.get_api_details('axis_direct_upi_success_curl',
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                expected_db_values = {
                    ...
                    "ipr_pg_merchant_id": pg_merchant_id,
                    "rrn": str(rrn),
                    "ipr_error_message": "The given amount - "+str(payment_intent_id)+" doesnt match with the "
                                         "transaction amount."
                }
