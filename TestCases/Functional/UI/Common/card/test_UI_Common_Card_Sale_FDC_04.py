...
def test_common_100_115_217():
    """
    Sub Feature Code: UI_Common_Card_Sale_FDC_EMV_MASTER_CreditCard_Without_Pin_541333
    Sub Feature Description: Performing the EMV sale transaction via FDC PG using MASTER Credit card having
    16 digit PAN length without pin (bin:541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 217: TC217
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_218():
    """
    Sub Feature Code: UI_Common_Card_Sale_FDC_EMV_VISA_CreditCard_With_Pin_417666
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 218: TC218
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_219():
    """
    Sub Feature Code: UI_Common_Card_Sale_FDC_EMV_MASTER_CreditCard_With_Pin_541333
    Sub Feature Description: Performing the EMV sale transaction via FDC PG using MASTER Credit card having
    16 digit PAN length with pin (bin:541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 219: TC219
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
