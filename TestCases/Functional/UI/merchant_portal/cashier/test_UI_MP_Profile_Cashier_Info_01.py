...
def test_mp_700_709_064():
    """
    Sub Feature Code: UI_MP_Profile_Info
    Sub Feature Description: Verifying Profile information by logging in and log out when logged in as Cashier
