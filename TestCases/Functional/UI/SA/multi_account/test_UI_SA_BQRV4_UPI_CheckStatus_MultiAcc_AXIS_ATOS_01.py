...
def test_sa_100_110_035():
    """
    :Description: Multi Account - Verification of a successful bqrv4 upi txn via AXIS ATOS using checkstatus
    :Sub Feature code: UI_SA_BQRV4_UPI_Success_Checkstatus_MultiAcc_AXIS_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 UPI, 035-> TC035
    """
    try:
...
def test_sa_100_110_036():
    """
    :Description: Multi Account - Verification of a failed bqrv4 upi txn via AXIS ATOS using checkstatus
    :Sub Feature code: UI_SA_BQRV4_UPI_Failed_Checkstatus_MultiAcc_AXIS_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 UPI, 036-> TC036
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_sa_100_110_040():
    """
    :Description: Multi Account - Verification of a successful bqrv4 upi txn via AXIS ATOS using checkstatus with 2nd account label
    :Sub Feature code: UI_SA_BQRV4_UPI_Success_Checkstatus_with_2nd_label_MultiAcc_AXIS_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 UPI, 040-> TC040
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
