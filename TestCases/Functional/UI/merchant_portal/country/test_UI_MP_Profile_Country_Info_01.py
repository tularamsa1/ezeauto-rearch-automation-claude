...
def test_mp_700_701_064():
    """
    Sub Feature Code: UI_MP_Profile_Info_as_country_head
    Sub Feature Description: Verifying Profile information by logging in and log out  as Country Head
