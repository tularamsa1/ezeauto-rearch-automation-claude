...
def test_mpos_600_601_014():
    ...
    try:
        ...
        try:
            ...
            khaata = Khaata(app_driver)
            khaata.click_my_khaata()
            logger.info(f"Khaata is being clicked from home page")
...
def test_mpos_600_601_027():
    ...
    try:
        ...
        try:
            ...
            khaata.wait_from_recent_entry_in_the_khaata_holder_screen()
        ...
        if (ConfigReader.read_config("Validations", "app_validation")) == "True":
            ...
            try:
                ...
                logger.debug(f"Fetched khaata holder mobile number: {customer_mobile_number}")
                customer_name = khaata.fetch_holder_name_from_reminder()
                logger.debug(f"Fetched khaata customer number: {customer_name}")
                try:
