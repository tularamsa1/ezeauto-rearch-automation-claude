...
def test_common_400_403_011():
    ...
    try:
        ...
        try:
            ...
            # generating random without numbers
            ...
            new_password_generated = result_lower_letters + result_upper_letters + result_special_char
...
def test_common_400_403_012():
    ...
    try:
        ...
        try:
            ...
            # generating random less than 7 characters
            lower_letters = string.ascii_lowercase
            logger.debug(f"Fetching lower_letters value : {lower_letters}")
            result_lower_letters = ''.join(random.choice(lower_letters) for i in range(4))
            logger.debug(f"Fetching result_lower_letters value : {result_lower_letters}")
            new_password_generated = result_lower_letters
            logger.debug(f"new_password_generated is : {new_password_generated}")
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            expected_error_message = "Password too short"
...
def test_common_400_403_013():
    ...
    try:
        ...
        try:
            ...
            # Add new password as same as old password
            new_password_generated = app_password
            logger.debug(f"Fetching new_password_generated value : {new_password_generated}")
...
def test_common_400_403_014():
    ...
    try:
        ...
        try:
            ...
            api_details = DBProcessor.get_api_details('PasswordChange', request_body={
                "username": app_username,
                "password": app_password  #Hit API without newpassword
            })
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            expected_error_message = "Processing failed. Please try again."
            try:
                expected_api_values = {
                    "success": False,
                    "errorMessage": expected_error_message
...
def test_common_400_403_015():
    ...
    try:
        ...
        try:
            ...
            # generating random alphabets and digits
            lower_letters = string.ascii_lowercase
            logger.debug(f"Fetching lower_letters value : {lower_letters}")
            upper_letters = string.ascii_uppercase
            logger.debug(f"Fetching upper_letters value : {upper_letters}")
            ...
            # for newPassword variable add the new_password_generated
            api_details = DBProcessor.get_api_details('PasswordChange', request_body={
                "username": random.randint(0, 10 ** 10),  #Hit API with invalid username
                "password":app_password,
                "newPassword": new_password_generated
            })
