...
def test_mp_700_709_056():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_Card_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode Card when logged in as Cashier
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_mode='" + pmt_mode_search_value + "' and username ='" + login_username + "' order by created_time asc limit 1;"
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_709_057():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_UPI_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode UPI when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    057: TC057
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_709_058():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_BharatQR_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode BharatQR when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    058: TC058
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_709_059():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_CNP_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode CNP when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    059: TC059
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_709_060():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_Payment_mode_cheque_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter for payment mode Cheque when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    060: TC060
