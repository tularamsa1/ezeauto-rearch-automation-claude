...
@pytest.mark.dbVal
@pytest.mark.appVal
def test_common_100_101_207():
    """
    Sub Feature Code: TID_Dep_UI_Common_PM_2_Pure_UPI_success_callback_after_qr_expiry_AXIS_DIRECT_AutoRefund_Enabled
    Sub Feature Description: TID Dep - Verification of  two callback for success QR after QR expiry when auto refund enabled via Axis acq and Axis PG where upi config is Axis_Direct
    TC naming code description: 100: Payment Method, 101: UPI, 207: TC207
    """
    try:
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                ...
                actual_db_values = {
                    ...
                    "device_serial_2": txn_device_serial_db_2,
                    ...
                    "device_serial_3": txn_device_serial_db_3,
                }
...
def test_common_100_101_204():
    """
    Sub Feature Code: TID_Dep_UI_Common_PM_2_Pure_UPI_success_callback_before_qr_expiry_AXIS_DIRECT_AutoRefund_Enabled
    Sub Feature Description: TID Dep - Performing two  upi success callback via AXIS_DIRECT before expiry the qr when autorefund is enabled
    TC naming code description: 100: Payment Method, 101: UPI, 204: TC204
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        try:
            ...
            txn_device_serial_db = result['device_serial'].values[0]
            logger.debug(
                f"Fetching status_db, payment_mode_db, amount_db, state_db, payment_gateway_db, acquirer_code_db, bank_code_db, settlement_status_db, mid_db, tid_db, txn_order_id_db from database for "
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                response_2 = [x for x in resp["txns"] if x["txnId"] == txn_id_2][0]
                logger.debug(f"Response after filtering data of current txn is : {response_2}")
                txn_status_api_2 = response_2["status"]
                txn_amount_api_2 = int(response_2["amount"])
                txn_payment_mode_api_2 = response_2["paymentMode"]
                txn_state_api_2 = response_2["states"][0]
                txn_settlement_status_api_2 = response_2["settlementStatus"]
                txn_issuer_code_api_2 = response_2["issuerCode"]
                txn_acquirer_code_api_2 = response_2["acquirerCode"]
                txn_orgCode_api_2 = response_2["orgCode"]
                txn_mid_api_2 = response_2["mid"]
                txn_tid_api_2 = response_2["tid"]
                txn_type_api_2 = response_2["txnType"]
                txn_date_api_2 = response_2["createdTime"]
                txn_rrn_api_2 = response_2["rrNumber"]
                txn_order_id_api_2 = response_2["orderNumber"]
                txn_device_serial_api_2 = response_2["deviceSerial"]
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                ...
                actual_db_values = {
                    ...
                    "device_serial": txn_device_serial_db,
                    ...
                    "device_serial_2": new_txn_device_serial_db
                }
                logger.debug(f"actual_db_values : {actual_db_values}")
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_101_203():
    """
    Sub Feature Code: TID_Dep_UI_Common_PM_2_Pure_UPI_success_callback_after_qr_expiry_AXIS_DIRECT_AutoRefund_Disabled
    Sub Feature Description: TID Dep - Verification of two success callback after expiry when auto refund disabled via Axis acq and Axis PG where upi config is Axis_Direct
    TC naming code description: 100: Payment Method, 101: UPI, 203: TC203
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_101_205():
    """
    Sub Feature Code: TID_Dep_UI_Common_PM_2_Pure_UPI_success_callback_before_qr_expiry_AXIS_DIRECT_AutoRefund_Disabled
    Sub Feature Description: TID Dep - Performing two  upi success callback via AXIS_DIRECT before expiry the qr when autorefund is disabled
    TC naming code description: 100: Payment Method, 101: UPI, 205: TC205
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
        ...
        if (ConfigReader.read_config("Validations", "api_validation")) == "True":
            ...
            try:
                ...
                expected_api_values = {
                    ...
                    "pmt_status_2": "AUTHORIZED",
                    "txn_amt_2": amount, "pmt_mode_2": "UPI",
                    "pmt_state_2": "SETTLED", "rrn_2": str(callback_2_rrn),
                    "settle_status_2": "SETTLED",
                    "acquirer_code_2": "AXIS",
                    "issuer_code_2": "AXIS",
                    "txn_type_2": txn_type_2, "mid_2": mid, "tid_2": tid,
