...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_116():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Failed_and_Inquiry_timeout_EMVCTLS_DEBIT_VISA
        Sub Feature Description: API that performs IS Failed and inquiry timeout on IS settlement for CTLS DEBIT VISA card via IDFC_FDC
    ...
    try:
        ...
        card_processor.update_idfc_inquiryApi_read_timeout('1')
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_117():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Failed_and_Inquiry_timeout_EMVCTLS_DEBIT_MASTER
        Sub Feature Description: API that performs IS Failed and inquiry timeout on IS settlement for CTLS MASTER_CARD VISA card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        117: TC117
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            ...
            try:
                ...
                expectedDBValues = {"txn_amt": float(original_amount), "pmt_mode": "CARD",
                                    ...
                                    "is_org_code": org_code, "is_acq_code": "IDFC", "is_resp_code": "200",
                                    "is_resp_desc":"FAILED","is_error_code":"PAY005",
                                    "is_error_desc":f"Error in validating Credit Account:CBSERROR:INVALID CHECK DIGIT FOR ACCOUNT ID :{mer_account_no}", "is_inquiry_resp_code": "NULL",
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_118():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Failed_and_Inquiry_timeout_EMVCTLS_DEBIT_RUPAY
        Sub Feature Description: API that performs IS Failed and inquiry timeout on IS settlement for CTLS RUPAY VISA card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        118: TC118
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_119():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Failed_and_Inquiry_timeout_EMVCTLS_CREDIT_VISA
        Sub Feature Description: API that performs IS Failed and inquiry timeout on IS settlement for CTLS VISA CREDIT card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        119: TC119
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_120():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Failed_and_Inquiry_timeout_EMVCTLS_CREDIT_MASTER
        Sub Feature Description: API that performs IS Failed and inquiry timeout on IS settlement for CTLS MASTER_CARD CREDIT card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        120: TC120
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_d100_d101_121():
    """
        Sub Feature Code: NonUI_Common_IDFC_Card_IS_Failed_and_Inquiry_timeout_EMVCTLS_CREDIT_RUPAY
        Sub Feature Description: API that performs IS Failed and inquiry timeout on IS settlement for CTLS RUPAY CREDIT card via IDFC_FDC
        TC naming code description:
        d100: Dev Projects
        d101: IDFC Instant Settlement
        121: TC121
