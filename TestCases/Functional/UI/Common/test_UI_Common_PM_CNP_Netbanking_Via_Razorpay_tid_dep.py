...
@pytest.mark.uiVal
def test_common_100_103_280():
    """
    Sub Feature Code: UI_Common_PM_CNP_Net_Banking_Success_RAZORPAY_Tid_dep
    Sub Feature Description: Tid Dep - Verification of a successful Net Banking txn
    TC naming code description:100: Payment Method,103: NetBanking,280: TC280
    """
...
@pytest.mark.appVal
@pytest.mark.uiVal
def test_common_100_103_281():
    """
    Sub Feature Code: UI_Common_PM_CNP_Net_Banking_Failed_Razorpay_Tid_dep
    Sub Feature Description: Tid Dep - Verification of failed Net Banking txn for Razorpay pg
    TC naming code description:100: Payment Method, 1013: NetBanking, 281: TC281
    """
    ...
    try:
        ...
        try:
            ...
            logger.info(f"Your expected failed message is:  {expected_failed_message}")
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_103_282():
    """
    Sub Feature Code: UI_Common_PM_CNP_NetBanking_Timeout_RAZORPAY_Tid_dep
    Sub Feature Description: Tid_dep - Verification netbanking txn after timeout for RAZORPAY pg
    TC naming code description:100: Payment Method, 103: NetBanking, 282: TC282
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
