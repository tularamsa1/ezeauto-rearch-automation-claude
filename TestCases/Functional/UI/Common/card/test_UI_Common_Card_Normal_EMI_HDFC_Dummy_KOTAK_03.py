...
def test_common_100_115_05_105():
    """
    Sub Feature Code: UI_Common_Card_Normal_EMI_Unblock_Failed_Txn_For_An_Org_HDFC_Dummy_KOTAK_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenure
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 105: TC105
    """
    try:
        ...
        try:
            ...
            query = f"select * from emi where org_code='{org_code}' and status = 'ACTIVE' and " \
                    f"issuer_code='KOTAK' and card_type='DEBIT' and term = '{emi_plan_in_months} month' and emi_type='NORMAL'" \
...
def test_common_100_115_05_096():
    """
    Sub Feature Code: UI_Common_Card_Normal_EMI_Block_Failed_Txn_For_An_Org_HDFC_Dummy_KOTAK_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenure
    Sub Feature Description: Performing the normal EMI Block failed transaction for an org (not ezetap) via HDFC Dummy
    PG for KOTAK issuer using EMV VISA Debit card with pin for 3 months tenure (bin: 428090)
...
@pytest.mark.usefixtures("log_on_success", "method_setup")
@pytest.mark.dbVal
def test_common_100_115_05_078():
    """
    Sub Feature Code: UI_Common_Card_Normal_EMI_Failed_Failed_Txn_For_An_Org_HDFC_Dummy_KOTAK_EMV_VISA_DebitCard_With_Pin_428090_For_3_Months_Tenure
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 05: NORMAL_EMI, 078: TC078
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
