...
def test_sa_100_110_047():
    """
    :Description: Multi Account - Verification of a Success SA Checkstatus bqrv4 Upi txn via Kotak ATOS
    :Sub Feature code: UI_SA_BQRV4_UPI_Success_Checkstatus_MultiAcc_Kotak_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 UPI, 047-> TC047
    """
    try:
...
def test_sa_100_110_048():
    """
    :Description: Multi Account - Verification of a Failed SA Checkstatus bqrv4 Upi txn via Kotak ATOS
    :Sub Feature code: UI_SA_BQRV4_UPI_Failed_Checkstatus_MultiAcc_Kotak_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 UPI, 048-> TC048
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
def test_sa_100_110_049():
    """
    :Description: Multi Account - Verification of a Success SA Checkstatus bqrv4 Upi txn with 2nd account label via Kotak ATOS
    :Sub Feature code: UI_SA_BQRV4_UPI_Success_Checkstatus_with_2nd_label_MultiAcc_Kotak_ATOS
    :TC naming code description: 100->Payment Method, 110->Multi Acc BQRv4 UPI, 047-> TC047
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
