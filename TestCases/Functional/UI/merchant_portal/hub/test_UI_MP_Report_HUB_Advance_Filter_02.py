...
def test_mp_700_707_046():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_rr_number_as_HUB_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter rr number when logging in as HUB Head
    ...
    try:
        ...
        try:
            ...
            rr_number_api = confirm_response['rrNumber']
            logger.debug(f"auth_code from api : {rr_number_api}")
            ...
            rr_number_search_value = [{"label": "rr_number", "value": f"{rr_number_api}"}]
            ...
            api_details = DBProcessor.get_api_details('mp_txn_report', request_body={
                ...
                "nodeIds": [],
                "totalRecords": 0,
                "selectUniversalSearch": rr_number_search_value
            })
            ...
            trans_history_page.select_option("RRnumber", str(rr_number_api))
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and rr_number='" + rr_number_api + "' and username NOT IN ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + district_username + "', '" + taluk_username + "', '" + city_username + "') order by created_time asc limit 1;"
            ...
            db_hierarchy = "|".join(db_hierarchy_original.split("|")[6:])
            ...
            db_hierarchy_last = "|".join(db_hierarchy_original_last.split("|")[6:])
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_707_047():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_username_as_HUB_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter username when logging in as HUB Head
    TC naming code description:
    700: Merchant Portal
    707: HUB
    047: TC047
    ...
    try:
        ...
        try:
            ...
            trans_history_page.click_on_transactions()
            trans_history_page.click_on_advance_filter()
            trans_history_page.select_option("Username", str(txn_username))
            trans_history_page.click_on_search_btn()
            txn_details = trans_history_page.get_transaction_details_first_last_page()
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and username='" + txn_username + "' and username NOT IN ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + district_username + "', '" + taluk_username + "', '" + city_username + "') order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_707_048():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_DebitCardType_as_HUB_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter DebitCardType when logging in as HUB Head
    TC naming code description:
    700: Merchant Portal
    707: HUB
    048: TC048
    ...
    try:
        ...
        try:
            ...
            trans_history_page.click_on_transactions()
            trans_history_page.click_on_advance_filter()
            trans_history_page.search_based_on_card_type("DEBIT")
            trans_history_page.click_on_search_btn()
            txn_details = trans_history_page.get_transaction_details_first_last_page()
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_card_type='DEBIT' and username NOT IN ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + district_username + "', '" + taluk_username + "', '" + city_username + "') order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_707_049():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_CreditCardType_as_HUB_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter CreditCardType when logging in as HUB Head
    TC naming code description:
    700: Merchant Portal
    707: HUB
    049: TC049
    ...
    try:
        ...
        try:
            ...
            trans_history_page.click_on_transactions()
            trans_history_page.click_on_advance_filter()
            trans_history_page.search_based_on_card_type("CREDIT")
            trans_history_page.click_on_search_btn()
            txn_details = trans_history_page.get_transaction_details_first_last_page()
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_card_type='CREDIT' and username NOT IN ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + district_username + "', '" + taluk_username + "', '" + city_username + "') order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_707_050():
    """
    Sub Feature Code: UI_MP_Report_based_on_Advance_filter_ALL_CardType_as_HUB_Head
    Sub Feature Description: Verifying txn details on Report Page using Advance Filter ALL CardType when logging in as HUB Head
    TC naming code description:
    700: Merchant Portal
    707: HUB
    050: TC050
    ...
    try:
        ...
        try:
            ...
            if card_payment_success == True:
                ...
                confirm_response = APIProcessor.send_request(api_details)
                logger.info(f"confirm response from api for EMV Debit VISA txn: {confirm_response}")
            ...
            if card_payment_success == True:
                ...
                confirm_response = APIProcessor.send_request(api_details)
                logger.info(f"confirm response from api for EMV Credit VISA txn: : {confirm_response}")
            ...
            api_details = DBProcessor.get_api_details('mp_txn_report', request_body={
                ...
                "pageNumber": 0,
                "usersList": [],
                "cardType": ["DEBIT","CREDIT","UNKNOWN","PREPAID","FPAYDEFAULT"],
                "cardBrand": [],
                "transactionStatus": [],
                "selectSearchOptions": [],
                "paymentMode": [],
            ...
            trans_history_page.click_on_transactions()
            trans_history_page.click_on_advance_filter()
            trans_history_page.search_based_on_card_type("Select All")
            trans_history_page.click_on_search_btn()
            txn_details = trans_history_page.get_transaction_details_first_last_page()
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and payment_card_type in ('DEBIT','CREDIT','UNKNOWN','PREPAID','FPAYDEFAULT') and username NOT IN ('" + country_username + "', '" + region_username + "', '" + state_username + "', '" + district_username + "', '" + taluk_username + "', '" + city_username + "') order by created_time asc limit 1;"
            logger.debug(f"Query to fetch last transaction from database is: {query}")
            result = DBProcessor.getValueFromDB(query)
            db_rrn_last = result['rr_number'].values[0]
            logger.debug(f"rrn number from db : {db_rrn_last}")
