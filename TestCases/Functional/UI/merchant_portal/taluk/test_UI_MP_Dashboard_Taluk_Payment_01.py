...
def test_mp_700_705_008():
    """
    Sub Feature Code: UI_MP_Payment_using_Card_as_Taluk_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using card when logging in as Taluk Head
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') and status = 'AUTHORIZED' and payment_mode = 'CARD' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "';"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_705_009():
    """
    Sub Feature Code: UI_MP_Payment_using_Cash_as_Taluk_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using Cash when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    009: TC009
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where" \
                    " org_code = '" + org_code + "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') and status = 'AUTHORIZED' and payment_mode = 'CASH' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "';"
            ...
            query = "select sum(amount) from txn where org_code = '" + org_code + \
                    "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') and status = 'AUTHORIZED'" \
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_705_010():
    """
    Sub Feature Code: UI_MP_Payment_using_UPI_as_Taluk_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using UPI when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    010: TC010
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') and status = 'AUTHORIZED' and payment_mode = 'UPI' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "';"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_705_011():
    """
    Sub Feature Code: UI_MP_Payment_using_BQR_as_Taluk_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using BQR when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    011: TC011
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') and status = 'AUTHORIZED' and payment_mode = 'BHARATQR' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "';"
...
@pytest.mark.apiVal
@pytest.mark.portalVal
def test_mp_700_705_012():
    """
    Sub Feature Code: UI_MP_Payment_using_CNP_as_Taluk_head
    Sub Feature Description: Verifying txn details on dashboard for payment done using CNP when logging in as Taluk Head
    TC naming code description:
    700: Merchant Portal
    705: Taluk
    012: TC012
    ...
    try:
        ...
        try:
            ...
            query = "select sum(amount) from txn where " \
                    "org_code = '" + org_code + "' and username NOT IN ('"+country_username+"', '" + region_username + "', '" + state_username + "', '" + district_username + "') and status = 'AUTHORIZED' and payment_mode = 'CNP' and id between '" + current_start_date_1 + "' and '" + current_end_date_1 + "';"
