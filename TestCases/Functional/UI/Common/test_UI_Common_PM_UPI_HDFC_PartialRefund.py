...
def test_common_100_101_012():
    """
    Sub Feature Code: UI_Common_PM_UPI_Partial_Refund_Via_API_HDFC
    Sub Feature Description: Verification of  a pure UPI txn when Partial refund is performed via api for HDFC
    TC naming code description: 100: Payment Method, 101: UPI, 012: TC012
    """
        ...
        if (ConfigReader.read_config("Validations", "charge_slip_validation")) == "True":
            ...
            try:
                ...
                expected_charge_slip_values_1 = {
                    ...
                    'RRN': str(refund_rrn), 'BASE AMOUNT:': "Rs." + str(refund_amount) + ".00",
                    'date': txn_date, 'time': txn_time, 'AUTH CODE': refund_auth_code
                }
...
def test_common_100_101_013():
    ...
    try:
        ...
        if (ConfigReader.read_config("Validations", "portal_validation")) == "True":
            logger.info(f"Started Portal validation for the test case : {testcase_id}")
            try:
                expected_portal_values = {"txn_status_2": "Refunded", "pmt_mode_2": "UPI",
                                          "txn_amt_2": str(refund_amount), "txn_status": "Settled",
                ...
                actual_portal_values = {"txn_status_2": portal_status, "pmt_mode_2": portal_txn_type,
                                        "txn_amt_2": str(portal_amt.split('.')[1]),
                                        "txn_status": portal_status_original,
...
def test_common_100_101_120():
    ...
    Sub Feature Description: Verification of two times partial refund for upi txn via api for HDFC
    TC naming code description: 100: Payment Method, 101: UPI, 120: TC120
    """
...
def test_common_100_101_121():
    """
    Sub Feature Code: UI_Common_PM_UPI_Partial_Refund_In_Decimal_Via_API_HDFC
    Sub Feature Description: Verification of  a pure UPI txn when Partial refund is performed via api for HDFC
