...
def test_mp_700_704_033():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Voided_as_District_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Voided when logging in as District Head
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and status='" + txn_status + "' and username NOT IN ('" + country_username + "', '" + region_username + "', '" + state_username + "') order by created_time asc limit 1;"
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_704_034():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Reversed_as_District_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Reversed when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    034: TC034
    ...
    try:
        ...
        state_cred = ResourceAssigner.get_org_users_login_Credentials('STATE', txn_org_code)
        logger.debug(f"Fetched region_cred credentials from the ezeauto db : {state_cred}")
        state_username = state_cred['Username']
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_704_035():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Refund_pending_as_District_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Refund Pending when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    035: TC035
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_704_036():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Pre_Auth_as_District_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Pre Auth when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    036: TC036
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_704_037():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_REL_Pre_Auth_as_District_head
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status REL_Pre_Auth when logging in as District Head
    TC naming code description:
    700: Merchant Portal
    704: District
    037: TC037
