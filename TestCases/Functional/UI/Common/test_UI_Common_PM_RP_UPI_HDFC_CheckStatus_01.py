...
def test_common_100_103_003():
    """
    Sub Feature Code: UI_Common_PM_RP_UPI_Success_Via_CheckStatus_HDFC
    Sub Feature Description: Verification of a Remote Pay successful upi txn via HDFC using check status
        ...
        if (ConfigReader.read_config("Validations", "db_validation")) == "True":
            try:
                ...
                expectedDBValues = {"pmt_status": "FAILED",
                                    ...
                                    "pmt_mode": "UPI",
                                    "txn_amt": amount,
                                    'txn_type': 'REMOTE_PAY_UPI_INTENT'}
...
def test_common_100_103_047():
    ...
    try:
        ...
        query = "update remotepay_setting set setting_value= '4' where setting_name='cnpTxnTimeoutDuration' and org_code='" + org_code + "';"
...
def test_common_100_103_048():
    """
    Sub Feature Code: UI_Common_PM_RP_RP_UPI_CheckStatus_After_timeout_HDFC
    Sub Feature Description: Verification of a Remote Pay upi txn after timeout for HDFC using check status
    TC naming code description:
    100: Payment Method
    103: RemotePay
    048: TC048
