...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_174():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Void_EMVCTLS_WITH_PIN_DEBIT_VISA
        Sub Feature Description: API that performs EMVCTLS with pin Void txn having DEBIT VISA card via HDFC
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_254():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Void_EMVCTLS_WITH_PIN_DEBIT_MASTER
        Sub Feature Description: API that performs EMVCTLS with pin Void txn having DEBIT MASTER card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        254: TC254
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_255():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Void_EMVCTLS_WITH_PIN_DEBIT_RUPAY
        Sub Feature Description: API that performs EMVCTLS with pin Void txn having DEBIT RUPAY card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        255: TC255
...
@pytest.mark.apiVal
@pytest.mark.dbVal
def test_common_100_104_239():
    """
        Sub Feature Code: NonUI_Common_HDFC_Card_Void_EMVCTLS_WITH_PIN_CREDIT_MASTER
        Sub Feature Description: API that performs EMVCTLS with pin Void txn having CREDIT MASTER card via HDFC
        TC naming code description:
        100: Payment Method
        104: CARD
        239: TC239
