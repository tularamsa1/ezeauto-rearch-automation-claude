...
def test_common_100_102_082():
    """
    :Description: Verification of a BQRV4 Partial Refund via AXIS_ATOS
    :Sub Feature code: UI_Common_BQRV4_Partial_Refund_AXIS_ATOS_082
    :TC naming code description: 100->Payment Method, 102->BQR, 082-> TC82
    """
    try:
