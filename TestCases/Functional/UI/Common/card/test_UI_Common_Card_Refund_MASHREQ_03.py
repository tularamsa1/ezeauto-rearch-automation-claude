...
def test_common_100_115_267():
    """
    Sub Feature Code: UI_Common_Card_Refund_MASHREQ_EMV_MASTER_CreditCard_With_Pin_541333
    Sub Feature Description:  Performing the EVM Refund transaction via MASHREQ PG using MASTER Credit card having
     16 digit PAN length with pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 267: TC267
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_268():
    """
    Sub Feature Code: UI_Common_Card_Refund_MASHREQ_EMVCTLS_VISA_CreditCard_Without_Pin_417666
    Sub Feature Description: Performing the EMVCTLS Refund transaction via MASHREQ PG using VISA Credit card having
     16 digit PAN length without pin (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 268: TC268
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_269():
    """
    Sub Feature Code: UI_Common_Card_Refund_MASHREQ_EMVCTLS_MASTER_CreditCard_Without_Pin_541333
    Sub Feature Description: Performing the EMVCTLS Refund transaction via MASHREQ PG using MASTER Credit card having
     16 digit PAN length without pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 269: TC269
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_270():
    """
    Sub Feature Code: UI_Common_Card_Refund_MASHREQ_EMVCTLS_MASTER_CreditCard_With_Pin_541333
    Sub Feature Description: Performing the EMVCTLS Refund transaction via MASHREQ PG using MASTER Credit card having
     16 digit PAN length with pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 270: TC270
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
