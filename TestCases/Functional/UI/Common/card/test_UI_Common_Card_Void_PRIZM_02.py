...
def test_common_100_115_077():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMVCTLS_RUPAY_DebitCard_Without_Pin_608326
    ...
    TC naming code description: 100: Payment Method, 115: CARD_UI, 077: TC077
    """
    try:
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_078():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMVCTLS_MASTER_CreditCard_With_Pin_541333
    Sub Feature Description:  Performing the EMVCTLS Void transaction via PRIZM PG using MASTER Credit card having
    16 digit PAN length with pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 078: TC078
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_079():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMVCTLS_VISA_CreditCard_Without_Pin_417666
    Sub Feature Description:  Performing the EMVCTLS Void transaction via PRIZM PG using VISA Credit card having
    16 digit PAN length without pin (bin: 417666)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 079: TC079
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_080():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMVCTLS_MASTER_CreditCard_Without_Pin_541333
    Sub Feature Description:  Performing the EMVCTLS Void transaction via PRIZM PG using MASTER Credit card having
    16 digit PAN length without pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 080: TC080
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
...
@pytest.mark.appVal
@pytest.mark.chargeSlipVal
def test_common_100_115_210():
    """
    Sub Feature Code: UI_Common_Card_Void_PRIZM_EMV_MASTER_CreditCard_Without_Pin_541333
    Sub Feature Description:  Performing the EMV Void transaction via PRIZM PG using MASTER Credit card having 16 digit
    PAN length without pin (bin: 541333)
    TC naming code description: 100: Payment Method, 115: CARD_UI, 210: TC210
    """
    try:
        testcase_id = sys._getframe().f_code.co_name
        GlobalVariables.time_calc.setup.resume()
