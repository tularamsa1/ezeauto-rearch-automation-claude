...
def test_mp_700_709_038():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_CNF_Pre_Auth_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status CNF_Pre_Auth when logged in as Cashier
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where" \
                    " id BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and org_code='" + org_code + "' and status='" + txn_status + "' and username = '" + txn_username + "' order by created_time asc limit 1;"
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_709_039():
    """
    Sub Feature Code: UI_MP_Report_based_on_Txn_status_Expired_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page using Filter Txn Status Expired when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    039: TC039
...
@pytest.mark.dbVal
@pytest.mark.portalVal
def test_mp_700_709_040():
    """
    Sub Feature Code: UI_MP_Report_based_on_ALL_Txn_status_as_Cashier
    Sub Feature Description: Verifying txn details on Report Page selecting ALL txn status filter when logged in as Cashier
    TC naming code description:
    700: Merchant Portal
    709: Cashier
    040: TC040
    ...
    try:
        ...
        try:
            ...
            query = "SELECT * from txn where id " \
                "BETWEEN '" + start_date_time_utc + "' AND '" + end_date_time_utc + "' and username = '" + txn_username + "' and org_code='" + org_code + "'  AND " \
