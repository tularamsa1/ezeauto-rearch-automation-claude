...
@pytest.mark.portal
@pytest.mark.appVal
def test_common_100_101_220():
    """
    Sub Feature Code: Tid_Dep_UI_Common_PM_UPI_QR_Generation_Success_Razorpay
    Sub Feature Description: Tid Dep - Generating a successful QR for Razorpay
    TC naming code description: 100: Payment Method, 101: UPI, 220: TC220
    """
    try:
